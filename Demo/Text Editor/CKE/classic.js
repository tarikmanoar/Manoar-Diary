...
! function (t) {
    t.en = Object.assign(t.en || {}, {
        ...
        t: "Insert table",
        u: "Header column",
        v: "Insert column left",
        w: "Insert column right",
        x: "Delete column",
        y: "Column",
        z: "Header row",
        aa: "Insert row below",
        ...
        ag: "Merge cell down",
        ah: "Merge cell left",
        ai: "Split cell vertically",
        aj: "Split cell horizontally",
        ak: "Merge cells",
        al: "Italic",
        am: "Insert media",
        an: "The URL must not be empty.",
        ao: "This media URL is not supported.",
        ap: "media widget",
        aq: "Upload failed",
        ...
        bp: "Show more items",
        bq: "Dropdown toolbar",
        br: "Paste the media URL in the input.",
        bs: "Tip: Paste the URL into the content to embed faster.",
        bt: "Media URL",
    ...
    return function (t) {
        ...
        function Ps(t, e, n) {
            ...
            if (![o, i].every(t => r.contains(t))) {
                ...
                Es(o, r) ? a -= r.top - e.top + n : Ms(i, r) && (a += e.bottom - r.bottom + n), Is(e, r) ? s -= r.left - e.left + n : Ns(e, r) && (s += e.right - r.right + n), t.scrollTo(s, a)
            }
        }
        ...
        function Ss(t, e) {
            const n = Os(t);
            let i, o;
            for (; t != n.document.body;) o = e(), (i = new xs(t).excludeScrollbarsAndBorders()).contains(o) || (Es(o, i) ? t.scrollTop -= i.top - o.top : Ms(o, i) && (t.scrollTop += o.bottom - i.bottom), Is(o, i) ? t.scrollLeft -= i.left - o.left : Ns(o, i) && (t.scrollLeft += o.right - i.right)), t = t.parentNode
        }
        ...
        class Nc {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Sc(this), this.selection = new sa(this), this.roots = new oo({
                    idProperty: "rootName"
        ...
        function Hc(t, e) {
            if ("text" == e.type) return "word" === t.unit ? function (t, e) {
                ...
                if (n) {
                    ...
                    for (; Mc(i, o) || "character" == e && Ec(i, o);) t.next(), o = t.position.offset - n.startOffset
                }
                return t.position
        ...
        function dl(t) {
            ...
            ll.has(r) || (ll.set(r, new Map), r.registerPostFixer(t => ul(r, t))), ll.get(r).set(n, {
                text: i,
                isDirectHost: o
            }), e.change(t => ul(r, t))
        }
        ...
        function ul(t, e) {
            const n = ll.get(t);
            let i = !1;
            for (const [t, o] of n) fl(e, t, o) && (i = !0);
            return i
        }
        ...
        class wl {
            ...
            revert(t) {
                ...
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) Nl(n) ? yield n: Ol(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            static extend(t, e) {
                ...
                ! function t(e, n) {
                    n.attributes && (e.attributes || (e.attributes = {}), El(e.attributes, n.attributes));
                    n.eventListeners && (e.eventListeners || (e.eventListeners = {}), El(e.eventListeners, n.eventListeners));
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = B(n[0]) && n[0].ns ? n[0].ns : null, yl(n)) {
                        const a = o ? n[0].value : n;
                        s && Dl(e) && a.unshift(i), this._bindToObservable({
                            schema: a,
                            updater: Al(r, e, o),
                            data: t
                        })
                    } else "style" == e && "string" != typeof n[0] ? this._renderStyleAttribute(n[0], t) : (s && i && Dl(e) && n.unshift(i), Il(n = n.map(t => t && t.value || t).reduce((t, e) => t.concat(e), []).reduce(Ml, "")) || r.setAttributeNS(o, e, n))
            }
            _renderStyleAttribute(t, e) {
                const n = e.node;
                for (const i in t) {
                    const o = t[i];
                    yl(o) ? this._bindToObservable({
                        schema: [o],
                        updater: Tl(n, i),
                        data: e
                    }) : n.style[i] = o
            ...
            _renderElementChildren(t) {
                ...
                for (const r of this.children)
                    ...
                    } else if (Nl(r)) i || (r.isRendered || r.render(), n.appendChild(r.element));
        ...
        function xl(t, e, {
            ...
            Il(i = 1 == t.length && t[0] instanceof vl ? i[0] : i.reduce(Ml, "")) ? e.remove() : e.set(i)
        }
        ...
        function Pl(t) {
            if ("string" == typeof t ? t = function (t) {
                ...
                const e = [];
                if (t.children)
                    if (Rl(t.children)) e.push(t.children);
                    else
                        for (const n of t.children) Ol(n) || Nl(n) || Ko(n) ? e.push(n) : e.push(new wl(n));
                t.children = e
            }
            return t
        }
        ...
        class jl extends Ll {
            ...
            _renderBodyCollection() {
                const t = this.locale,
                    e = this._bodyCollectionContainer = new wl({
                        tag: "div",
                        attributes: {
        ...
        class zl extends jl {
            ...
            _createVoiceLabel(t) {
                const e = this.t,
                    n = new Vl;
                return n.text = e("bi"), n.extendTemplate({
                    attributes: {
        ...
        class Fl extends Bl {
            ...
            render() {
                ...
                t.change(n => {
                    ...
                    n.setAttribute("aria-label", e("bu", [this.name]), i)
                })
            }
        }
                ...
                this.set("isActive", !1), this.set("isSticky", !1), this.set("limiterElement", null), this.set("limiterBottomOffset", 50), this.set("viewportTopOffset", 0), this.set("_marginLeft", null), this.set("_isStickyToTheLimiter", !1), this.set("_hasViewportTopOffset", !1), this.content = this.createCollection(), this._contentPanelPlaceholder = new wl({
                    ...
                    attributes: {
                        ...
                        style: {
                            ...
                            height: e.to("isSticky", t => t ? Hl(this._panelRect.height) : null)
                        }
                    }
                    ...
                    attributes: {
                        ...
                        style: {
                            width: e.to("isSticky", t => t ? Hl(this._contentPanelPlaceholder.getBoundingClientRect().width) : null),
                            top: e.to("_hasViewportTopOffset", t => t ? Hl(this.viewportTopOffset) : null),
                            bottom: e.to("_isStickyToTheLimiter", t => t ? Hl(this.limiterBottomOffset) : null),
        ...
        class td extends Ll {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("panelPosition", "auto"), this.focusTracker = new al, this.keystrokes = new Zc, this.setTemplate({
                    tag: "div",
                    attributes: {
        ...
        class rd extends id {
            ...
            _createArrowView() {
                const t = new ed;
                return t.content = od, t.extendTemplate({
                    attributes: {
        ...
        class sd extends Ll {
            constructor() {
                super(), this.items = this.createCollection(), this.focusTracker = new al, this.keystrokes = new Zc, this._focusCycler = new Wl({
        ...
        function hd(t, e = rd) {
            const n = new e(t),
                i = new Kl(t),
                o = new td(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof rd ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"),
                function (t) {
                    (function (t) {
                        t.on("render", () => {
                            dd({
        ...
        function ud(t, e) {
            const n = t.locale,
                i = t.listView = new sd(n);
            i.items.bindTo(e).using(({
                type: t,
                model: e
            }) => {
                if ("separator" === t) return new cd(n);
                if ("button" === t || "switchbutton" === t) {
                    const i = new ad(n);
                    let o;
                    return (o = "button" === t ? new id(n) : new ld(n)).bind(...Object.keys(e)).to(e), o.delegate("execute").to(i), i.children.add(o), i
                }
            }), t.panelView.children.add(i), i.items.delegate("execute").to(t)
        }
        var fd = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="9.5" cy="4.5" r="1.5"/><circle cx="9.5" cy="10.5" r="1.5"/><circle cx="9.5" cy="16.5" r="1.5"/></svg>\n';
        n(40);
        class gd extends Ll {
            constructor(t, e) {
                super(t);
                const n = this.bindTemplate,
                    i = this.t;
                this.options = e || {}, this.set("ariaLabel", i("bo")), this.items = this.createCollection(), this.focusTracker = new al, this.keystrokes = new Zc, this.set("class"), this.itemsView = new md(t), this.children = this.createCollection(), this.children.add(this.itemsView), this.focusables = this.createCollection(), this._focusCycler = new Wl({
                ...
                }), this._behavior = this.options.shouldGroupWhenFull ? new bd(this) : new pd(this)
            }
            render() {
                super.render();
                for (const t of this.items) this.focusTracker.add(t.element);
            ...
            _createGroupedItemsDropdown() {
                ...
                return n.class = "ck-toolbar__grouped-dropdown", n.panelPosition = "ltr" === t.uiLanguageDirection ? "sw" : "se",
                    function (t, e) {
                        ...
                        o.set("ariaLabel", i("bq")), t.extendTemplate({
                            attributes: {
        ...
        class wd extends zl {
            constructor(t, e) {
                super(t), this.stickyPanel = new ql(t), this.toolbar = new gd(t, {
                    shouldGroupWhenFull: !0
                }), this.editable = new Fl(t, e)
            }
            render() {
        ...
        class kd extends tl {
            constructor(t, e) {
                super(e), Wn(t) && (this.sourceElement = t), this.data.processor = new ol, this.model.document.createRoot(), this.ui = new ml(this, new wd(this.locale, this.editing.view)),
                    function (t) {
        ...
        class yd extends Xr {
            ...
            onDomEvent(t) {
                const e = {
                    dataTransfer: new vd(t.clipboardData ? t.clipboardData : t.dataTransfer)
                };
        ...
        class Ad extends _d {
            ...
            init() {
                ...
                this._htmlDataProcessor = new ol, n.addObserver(yd), this.listenTo(i, "clipboardInput", e => {
                    t.isReadOnly && e.stop()
                }, {
                    priority: "highest"
                    ...
                    i.content.isEmpty || (i.dataTransfer.setData("text/html", this._htmlDataProcessor.toData(i.content)), i.dataTransfer.setData("text/plain", function t(e) {
                        ...
                        if (e.is("text") || e.is("textProxy")) n = e.data;
                            ...
                            for (const o of e.getChildren()) {
                                const e = t(o);
                                i && (i.is("containerElement") || o.is("containerElement")) && (xd.includes(i.name) || xd.includes(o.name) ? n += "\n" : n += "\n\n"), n += e, i = o
                            }
                        }
                        return n
        ...
        class Td {
            ...
            forceDisabled(t) {
                this._disableStack.add(t), 1 == this._disableStack.size && (this.on("set:isEnabled", Cd, {
                    priority: "highest"
                }), this.isEnabled = !1)
            }
            clearForceDisabled(t) {
                this._disableStack.delete(t), 0 == this._disableStack.size && (this.off("set:isEnabled", Cd), this.refresh())
            }
            execute() {}
            destroy() {
                this.stopListening()
            ...
            execute() {
                ...
                t.change(n => {
                    ! function (t, e, n, i) {
                        ...
                        if (o) {
                            const t = Pd(e.model.schema, n.getAttributes());
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), i && (o ? Md(e, n.focus) : e.setSelection(a, 0))
                        }
        ...
        class Id extends _d {
            ...
            init() {
                const t = this.editor,
                    e = t.editing.view,
                    n = e.document;
                e.addObserver(Ed), t.commands.add("enter", new Sd(t)), this.listenTo(n, "enter", (n, i) => {
                ...
                t.change(n => {
                    ! function (t, e, n) {
                        const i = n.isCollapsed,
                            ...
                            a = r == s;
                        if (i) {
                            const i = Pd(t.schema, n.getAttributes());
                            Od(e, o.end), e.removeSelectionAttribute(n.getAttributeKeys()), e.setSelectionAttribute(i)
                        } else {
                            const i = !(o.start.isAtStart && o.end.isAtEnd);
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), a ? Od(e, n.focus) : i && e.setSelection(s, 0)
                        }
        ...
        function Rd(t, e) {
            return !t.is("rootElement") && (e.isLimit(t) || Rd(t.parent, e))
        }
        class Dd extends _d {
            static get pluginName() {
                return "ShiftEnter"
            ...
            init() {
                ...
                }), i.addObserver(Ed), t.commands.add("shiftEnter", new Nd(t)), this.listenTo(o, "enter", (e, n) => {
        ...
        class jd extends Td {
            constructor(t, e) {
                super(t), this._buffer = new Ld(t.model, e), this._batches = new WeakSet
            }
            get buffer() {
                return this._buffer
            }
        ...
        const zd = [wo("arrowUp"), wo("arrowRight"), wo("arrowDown"), wo("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
        for (let t = 112; t <= 135; t++) zd.push(t);
        ...
        function Bd(t) {
            ...
            }($o(t.oldChildren, t.newChildren, Fd), t.newChildren);
        ...
        class Ud {
            ...
            handle(t, e) {
                if (function (t) {
                        ...
                        for (const e of t)
                            if ("children" === e.type && !Bd(e)) return !0;
                        return !1
        ...
        class Wd extends _d {
            ...
            init() {
                const t = this.editor,
                    e = new jd(t, t.config.get("typing.undoStep") || 20);
                t.commands.add("input", e), Vd(t),
                    function (t) {
        ...
        class Gd extends _d {
            ...
            init() {
                const t = this.editor,
                    e = t.editing.view,
                    n = e.document;
                if (e.addObserver($d), t.commands.add("forwardDelete", new Yd(t, "forward")), t.commands.add("delete", new Yd(t, "backward")), this.listenTo(n, "delete", (n, i) => {
                        const o = {
                            unit: i.unit,
                            sequence: i.sequence
                        };
        ...
        class Kd extends Za {
            ...
            clone() {
                return new Kd(this.baseVersion)
            }
            getReversed() {
                return new Kd(this.baseVersion + 1)
            }
            _execute() {}
            static get className() {
                return "NoOperation"
        ...
        function Zd(t, e, n) {
            let i = Jd.get(t);
            i || (i = new Map, Jd.set(t, i)), i.set(e, n)
        }
        ...
        function eh(t, e, n) {
            t = t.slice(), e = e.slice();
            const i = new nh(n.document, n.useRelations, n.forceWeakRemove);
            ...
            for (; a < t.length;) {
                ...
                const s = e[o],
                    c = th(n, s, i.getContext(n, s, !0)),
                    l = th(s, n, i.getContext(s, n, !1));
            ...
            return ih(t, s.nextBaseVersionB), ih(e, s.nextBaseVersionA), {
                operationsA: t,
                operationsB: e,
                originalOperations: o
            }
        ...
        function oh(t, e) {
            for (let n = 0; n < e; n++) t.push(new Kd(0))
        }
        ...
        Zd(cc, cc, (t, e, n) => {
            if (t.key === e.key) {
                ...
                return o && n.aIsStrong && i.push(new cc(o, e.key, e.newValue, t.newValue, 0)), 0 == i.length ? [new Kd(0)] : i
            }
            return [t]
        }), Zd(cc, hc, (t, e) => {
            ...
            return [t]
        }), Zd(mc, hc, (t, e) => (t.sourcePosition.hasSameParentAs(e.position) && (t.howMany += e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByInsertOperation(e), t.targetPosition = t.targetPosition._getTransformedByInsertOperation(e), [t])), Zd(mc, mc, (t, e, n) => {
            ...
            let r, s = n.aIsStrong,
                a = !n.aIsStrong;
            if ("insertBefore" == n.abRelation || "insertAfter" == n.baRelation ? a = !0 : "insertAfter" != n.abRelation && "insertBefore" != n.baRelation || (a = !1), r = t.targetPosition.isEqual(e.targetPosition) && a ? t.targetPosition._getTransformedByDeletion(e.sourcePosition, e.howMany) : t.targetPosition._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), sh(t, e) && sh(e, t)) return [e.getReversed()];
            if (i.containsPosition(e.targetPosition) && i.containsRange(o, !0)) return i.start = i.start._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), i.end = i.end._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), ah([i], r);
            if (o.containsPosition(t.targetPosition) && o.containsRange(i, !0)) return i.start = i.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), i.end = i.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), ah([i], r);
            const c = li(t.sourcePosition.getParentPath(), e.sourcePosition.getParentPath());
            if ("prefix" == c || "extension" == c) return i.start = i.start._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), i.end = i.end._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), ah([i], r);
            ...
            return null !== h && s && (h.start = h.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), h.end = h.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), 0 === l.length ? l.push(h) : 1 == l.length ? o.start.isBefore(i.start) || o.start.isEqual(i.start) ? l.unshift(h) : l.push(h) : l.splice(1, 0, h)), 0 === l.length ? [new Kd(t.baseVersion)] : ah(l, r)
        }), Zd(dc, pc, (t, e, n) => {
            ...
            if (o.start.hasSameParentAs(e.splitPosition) && o.containsPosition(e.splitPosition)) {
                ...
                return t = t._getTransformedBySplitOperation(e), ah([new $s(o.start, e.splitPosition), t], i)
            }
            ...
            if (e.deletionPosition.hasSameParentAs(t.sourcePosition) && i.containsPosition(e.sourcePosition))
                if ("remove" != t.type || n.forceWeakRemove) {
                    if (1 == t.howMany) return n.bWasUndone ? (t.sourcePosition = e.graveyardPosition.clone(), t.targetPosition = t.targetPosition._getTransformedByMergeOperation(e), [t]) : [new Kd(0)]
            ...
            if (t.root === e.root && t.key === e.key) {
                if (!n.aIsStrong || t.newValue === e.newValue) return [new Kd(0)];
                t.oldValue = e.newValue
            }
            return [t]
        }), Zd(pc, hc, (t, e) => (t.splitPosition.hasSameParentAs(e.position) && t.splitPosition.offset < e.position.offset && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByInsertOperation(e), t.insertionPosition = pc.getInsertionPosition(t.splitPosition), [t])), Zd(pc, mc, (t, e, n) => {
            ...
            if (t.splitPosition.isEqual(e.splitPosition)) {
                if (!t.graveyardPosition && !e.graveyardPosition) return [new Kd(0)];
                if (t.graveyardPosition && e.graveyardPosition && t.graveyardPosition.isEqual(e.graveyardPosition)) return [new Kd(0)];
        ...
        class ch extends Td {
            ...
            _restoreSelection(t, e, n) {
                const i = this.editor.model,
                    ...
                    r = [];
                for (const e of t) {
                    const t = lh(e, n).find(t => t.start.root != o.graveyard);
                    t && r.push(t)
                }
                r.length && i.change(t => {
                    t.setSelection(r, {
        ...
        class uh extends _d {
            ...
            init() {
                const t = this.editor;
                this._undoCommand = new dh(t), this._redoCommand = new hh(t), t.commands.add("undo", this._undoCommand), t.commands.add("redo", this._redoCommand), this.listenTo(t.model, "applyOperation", (t, e) => {
                    const n = e[0];
        ...
        var fh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5.042 9.367l2.189 1.837a.75.75 0 0 1-.965 1.149l-3.788-3.18a.747.747 0 0 1-.21-.284.75.75 0 0 1 .17-.945L6.23 4.762a.75.75 0 1 1 .964 1.15L4.863 7.866h8.917A.75.75 0 0 1 14 7.9a4 4 0 1 1-1.477 7.718l.344-1.489a2.5 2.5 0 1 0 1.094-4.73l.008-.032H5.042z"/></svg>',
            gh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M14.958 9.367l-2.189 1.837a.75.75 0 0 0 .965 1.149l3.788-3.18a.747.747 0 0 0 .21-.284.75.75 0 0 0-.17-.945L13.77 4.762a.75.75 0 1 0-.964 1.15l2.331 1.955H6.22A.75.75 0 0 0 6 7.9a4 4 0 1 0 1.477 7.718l-.344-1.489A2.5 2.5 0 1 1 6.039 9.4l-.008-.032h8.927z"/></svg>';
        class mh extends _d {
            init() {
                const t = this.editor,
                    e = t.locale,
                    n = t.t,
                    i = "ltr" == e.uiLanguageDirection ? fh : gh,
                    o = "ltr" == e.uiLanguageDirection ? gh : fh;
        ...
        class kh extends _d {
            ...
            createLoader(t) {
                ...
                const e = new _h(Promise.resolve(t), this.createUploadAdapter);
        ...
        class _h {
            constructor(t, e) {
                this.id = Jn(), this._filePromiseWrapper = this._createFilePromiseWrapper(t), this._adapter = e(this), this._reader = new wh, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e) => e ? t / e * 100 : 0), this.set("uploadResponse", null)
            }
            get file() {
        ...
        ci(_h, Fi);
        const vh = "ckCsrfToken",
            yh = 40,
            xh = "abcdefghijklmnopqrstuvwxyz0123456789";
        ...
        function Ah() {
            ...
            return t && t.length == yh || (t = function (t) {
                let e = "";
                const n = new Uint8Array(t);
                window.crypto.getRandomValues(n);
                for (let t = 0; t < n.length; t++) {
                    const i = xh.charAt(n[t] % xh.length);
        ...
        class Th extends _d {
            ...
            init() {
                ...
                t && (this.editor.plugins.get(kh).createUploadAdapter = (e => new Ch(e, t, this.editor.t)))
            }
        }
        class Ch {
            constructor(t, e, n) {
            ...
            _sendRequest(t) {
                ...
                e.append("upload", t), e.append("ckCsrfToken", Ah()), this.xhr.send(e)
            }
        }
        class Ph {
            static get pluginName() {
            ...
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? i = e : r = e, "string" == typeof n ? o = n : s = n, r = r || (t => {
                    ...
                    const l = o.focus,
                        ...
                        f = r(h),
                        g = Mh(u.start, f.format, i),
                        m = Mh(u.start, f.remove, i);
        ...
        class Oh extends _d {
            ...
            init() {
                ...
                t.model.schema.extend("$text", {
                    allowAttributes: Nh
                }), t.model.schema.setAttributeProperties(Nh, {
                    isFormatting: !0,
                    copyOnEnter: !0
                ...
                }), t.commands.add(Nh, new Ih(t, Nh)), t.keystrokes.set("CTRL+B", Nh)
            }
        }
        var Rh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.187 17H5.773c-.637 0-1.092-.138-1.364-.415-.273-.277-.409-.718-.409-1.323V4.738c0-.617.14-1.062.419-1.332.279-.27.73-.406 1.354-.406h4.68c.69 0 1.288.041 1.793.124.506.083.96.242 1.36.478.341.197.644.447.906.75a3.262 3.262 0 0 1 .808 2.162c0 1.401-.722 2.426-2.167 3.075C15.05 10.175 16 11.315 16 13.01a3.756 3.756 0 0 1-2.296 3.504 6.1 6.1 0 0 1-1.517.377c-.571.073-1.238.11-2 .11zm-.217-6.217H7v4.087h3.069c1.977 0 2.965-.69 2.965-2.072 0-.707-.256-1.22-.768-1.537-.512-.319-1.277-.478-2.296-.478zM7 5.13v3.619h2.606c.729 0 1.292-.067 1.69-.2a1.6 1.6 0 0 0 .91-.765c.165-.267.247-.566.247-.897 0-.707-.26-1.176-.778-1.409-.519-.232-1.31-.348-2.375-.348H7z"/></svg>';
        const Dh = "bold";
        class Lh extends _d {
            init() {
                const t = this.editor,
                    e = t.t;
                t.ui.componentFactory.add(Dh, n => {
                    const i = t.commands.get(Dh),
                        o = new id(n);
                    return o.set({
                        label: e("d"),
                        icon: Rh,
                        ...
                        tooltip: !0,
                        isToggleable: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(Dh)), o
                })
            }
        }
        const jh = "italic";
        class Vh extends _d {
            ...
            init() {
                ...
                }), t.commands.add(jh, new Ih(t, jh)), t.keystrokes.set("CTRL+I", jh)
            }
        }
        var zh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.586 14.633l.021.004c-.036.335.095.655.393.962.082.083.173.15.274.201h1.474a.6.6 0 1 1 0 1.2H5.304a.6.6 0 0 1 0-1.2h1.15c.474-.07.809-.182 1.005-.334.157-.122.291-.32.404-.597l2.416-9.55a1.053 1.053 0 0 0-.281-.823 1.12 1.12 0 0 0-.442-.296H8.15a.6.6 0 0 1 0-1.2h6.443a.6.6 0 1 1 0 1.2h-1.195c-.376.056-.65.155-.823.296-.215.175-.423.439-.623.79l-2.366 9.347z"/></svg>';
        const Bh = "italic";
        class Fh extends _d {
            init() {
                const t = this.editor,
                    e = t.t;
                t.ui.componentFactory.add(Bh, n => {
                    const i = t.commands.get(Bh),
                        o = new id(n);
                    return o.set({
                        label: e("al"),
                        icon: zh,
                        ...
                        tooltip: !0,
                        isToggleable: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(Bh)), o
                })
            }
        }
        ...
        class Hh extends Td {
            ...
            execute(t = {}) {
                ...
                e.change(t => {
                    if (r) {
                        const e = o.filter(t => qh(t) || Yh(n, t));
                        this._applyQuote(t, e)
                    } else this._removeQuote(t, o.filter(qh))
                })
            }
            _getValue() {
                const t = Uh(this.editor.model.document.selection.getSelectedBlocks());
                return !(!t || !qh(t))
            }
            _checkEnabled() {
                ...
                const t = this.editor.model.document.selection,
                    ...
                    n = Uh(t.getSelectedBlocks());
                return !!n && Yh(e, n)
            }
            _removeQuote(t, e) {
                Wh(t, e).reverse().forEach(e => {
        ...
        class $h extends _d {
            ...
            init() {
                const t = this.editor,
                    e = t.model.schema;
                t.commands.add("blockQuote", new Hh(t)), e.register("blockQuote", {
                    allowWhere: "$block",
                    allowContentOf: "$root"
                }), e.addChildCheck((t, e) => {
        ...
        var Gh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 10.423a6.5 6.5 0 0 1 6.056-6.408l.038.67C6.448 5.423 5.354 7.663 5.22 10H9c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574zm8 0a6.5 6.5 0 0 1 6.056-6.408l.038.67c-2.646.739-3.74 2.979-3.873 5.315H17c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574z"/></svg>';
        n(44);
        class Qh extends _d {
            init() {
                const t = this.editor,
        ...
        var Kh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.627 16.5zm5.873-.196zm0-7.001V8h-13v8.5h4.341c.191.54.457 1.044.785 1.5H2a1.5 1.5 0 0 1-1.5-1.5v-13A1.5 1.5 0 0 1 2 2h4.5a1.5 1.5 0 0 1 1.06.44L9.122 4H16a1.5 1.5 0 0 1 1.5 1.5v1A1.5 1.5 0 0 1 19 8v2.531a6.027 6.027 0 0 0-1.5-1.228zM16 6.5v-1H8.5l-2-2H2v13h1V8a1.5 1.5 0 0 1 1.5-1.5H16z"/><path d="M14.5 19.5a5 5 0 1 1 0-10 5 5 0 0 1 0 10zM15 14v-2h-1v2h-2v1h2v2h1v-2h2v-1h-2z"/></svg>';
        class Jh extends _d {
            static get pluginName() {
                return "CKFinderUI"
            }
        ...
        class tu {
            ...
            add(t, e) {
                ...
                const o = n[0];
                i === o || eu(i, o) || this.fire("change:top", {
                    oldDescriptor: i,
                    newDescriptor: o,
                    writer: e
                })
        ...
        function eu(t, e) {
            return t && e && t.priority == e.priority && iu(t.classes) == iu(e.classes)
        }

        function nu(t, e) {
            return t.priority > e.priority || !(t.priority < e.priority) && iu(t.classes) > iu(e.classes)
        }
        ...
        ci(tu, ei);
        var ou = '<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M4 0v1H1v3H0V.5A.5.5 0 0 1 .5 0H4zm8 0h3.5a.5.5 0 0 1 .5.5V4h-1V1h-3V0zM4 16H.5a.5.5 0 0 1-.5-.5V12h1v3h3v1zm8 0v-1h3v-3h1v3.5a.5.5 0 0 1-.5.5H12z"/><path fill-opacity=".256" d="M1 1h14v14H1z"/><g class="ck-icon__selected-indicator"><path d="M7 0h2v1H7V0zM0 7h1v2H0V7zm15 0h1v2h-1V7zm-8 8h2v1H7v-1z"/><path fill-opacity=".254" d="M1 1h14v14H1z"/></g></svg>';
        const ru = "ck-widget",
            su = "ck-widget_selected";
        ...
        function cu(t, e, n = {}) {
            return go.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(ru, t), e.setCustomProperty("widget", !0, t), t.getFillerOffset = uu, n.label && function (t, e, n) {
                    ...
                    const n = e.createUIElement("div", {
                        ...
                        const e = this.toDomElement(t),
                            n = new ed;
                        return n.set("content", ou), n.render(), e.appendChild(n.element), e
                    });
        ...
        function fu(t) {
            ...
            return e && function (t) {
                return !!t.getCustomProperty("image") && au(t)
            }(e) ? e : null
        }
        ...
        class bu extends Td {
            refresh() {
                this.isEnabled = pu(this.editor.model)
            }
            execute(t) {
                const e = this.editor.model;
                e.change(n => {
                    const i = Array.isArray(t.source) ? t.source : [t.source];
                    for (const t of i) mu(n, e, {
                        src: t
                    })
                })
            }
        ...
        class wu extends _d {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = t.t,
                    i = t.conversion;
                t.editing.view.addObserver(Zh), e.register("image", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    ...
                    view: (t, e) => (function (t, e, n) {
                        return e.setCustomProperty("image", !0, t), cu(t, e, {
                            label: function () {
                ...
                }), i.for("downcast").add(Xh("src")).add(Xh("alt")).add(function () {
                    return e => {
        ...
        function _u(t, e, n) {
            return n.createRange(vu(t, e, !0, n), vu(t, e, !1, n))
        }
                ...
                n.change(e => {
                    if (i.isCollapsed) {
                        ...
                        if (i.hasAttribute("linkHref")) {
                            const a = _u(s, i.getAttribute("linkHref"), n);
        ...
        class xu extends Td {
            ...
            execute() {
                ...
                e.change(t => {
                    const o = n.isCollapsed ? [_u(n.getFirstPosition(), n.getAttribute("linkHref"), e)] : n.getRanges();
                    for (const e of o)
        ...
        var Tu = function (t, e, n) {
                var i = t.length;
                return n = void 0 === n ? i : n, !e && n >= i ? t : Au(t, e, n)
            },
            Cu = RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");
        var Pu = function (t) {
            return Cu.test(t)
        };
        var Su = function (t) {
            ...
            Ru = "[\\ud800-\\udbff][\\udc00-\\udfff]",
            Du = "(?:" + Eu + "|" + Iu + ")" + "?",
            Lu = "[\\ufe0e\\ufe0f]?" + Du + ("(?:\\u200d(?:" + [Nu, Ou, Ru].join("|") + ")[\\ufe0e\\ufe0f]?" + Du + ")*"),
            ju = "(?:" + [Nu + Eu + "?", Eu, Ou, Ru, Mu].join("|") + ")",
            Vu = RegExp(Iu + "(?=" + Iu + ")|" + ju + Lu, "g");
        var zu = function (t) {
            return t.match(Vu) || []
        };
        var Bu = function (t) {
            return Pu(t) ? zu(t) : Su(t)
        };
        var Fu = function (t, e) {
            ...
            Uu = 1 / 0,
            Hu = o ? o.prototype : void 0,
            qu = Hu ? Hu.toString : void 0;
        var Wu = function t(e) {
            if ("string" == typeof e) return e;
            if (Wt(e)) return Fu(e, t) + "";
            if (is(e)) return qu ? qu.call(e) : "";
            var n = e + "";
            return "0" == n && 1 / e == -Uu ? "-0" : n
        };
        var Yu = function (t) {
            return null == t ? "" : Wu(t)
        };
        var $u = function (t) {
            return function (e) {
                e = Yu(e);
                var n = Pu(e) ? Bu(e) : void 0,
                    i = n ? n[0] : e.charAt(0),
                    o = n ? Tu(n, 1).join("") : e.slice(1);
                return i[t]() + o
            }
        }("toUpperCase");
        const Gu = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
            Qu = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
        ...
        class tf {
            constructor(t, e, n) {
                this.model = t, this.attribute = n, this._modelSelection = t.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, e.listenTo(this._modelSelection, "change:range", (t, e) => {
                    this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!e.directChange && ef(this._modelSelection.getFirstPosition(), n) || this._restoreGravity())
                })
            }
            handleForwardMovement(t, e) {
                const n = this.attribute;
                if (!(this._isGravityOverridden || t.isAtStart && this._hasSelectionAttribute)) return rf(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._removeSelectionAttribute(), !0) : nf(t, n) ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : of (t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : void 0
            }
            handleBackwardMovement(t, e) {
                const n = this.attribute;
                return this._isGravityOverridden ? rf(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._restoreGravity(), this._removeSelectionAttribute(), !0) : (this._preventCaretMovement(e), this._restoreGravity(), t.isAtStart && this._removeSelectionAttribute(), !0) : rf(t, n) && !this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtEnd && of (t, n) ? this._hasSelectionAttribute ? void(sf(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity())) : (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtStart ? this._hasSelectionAttribute ? (this._removeSelectionAttribute(), this._preventCaretMovement(e), !0) : void 0 : void(sf(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
            }
        ...
        function sf(t, e) {
            return ef(t.getShiftedBy(-1), e)
        }
        n(46);
        const af = "ck-link_selected",
            cf = "automatic",
            lf = "manual",
            df = /^(https?:)?\/\//;
        class hf extends _d {
            ...
            init() {
                ...
                }), t.commands.add("link", new yu(t)), t.commands.add("unlink", new xu(t));
                ...
                this._enableAutomaticDecorators(n.filter(t => t.mode === cf)), this._enableManualDecorators(n.filter(t => t.mode === lf)),
                    function ({
                        view: t,
                        model: e,
                        emitter: n,
            ...
            _enableManualDecorators(t) {
                ...
                t.forEach(t => {
                    ...
                    }), n.add(new Xu(t)), e.conversion.for("downcast").attributeToElement({
                        model: t.id,
                        view: (e, i) => {
                            if (e) {
            ...
            _setupLinkHighlight() {
                ...
                e.document.registerPostFixer(e => {
                    ...
                    let o = !1;
                    if (i.hasAttribute("linkHref")) {
                        const r = _u(i.getFirstPosition(), i.getAttribute("linkHref"), t.model),
                            s = t.editing.mapper.toViewRange(r);
                        for (const t of s.getItems()) t.is("a") && !t.hasClass(af) && (e.addClass(af, t), n.add(t), o = !0)
                    }
                    return o
                }), t.conversion.for("editingDowncast").add(t => {
                    function i() {
                        e.change(t => {
                            for (const e of n.values()) t.removeClass(af, e), n.delete(e)
                        })
                    }
                    t.on("insert", i, {
                        priority: "highest"
        ...
        class mf extends _d {
            ...
            init() {
                const t = this.editor;
                t.commands.add("ckfinder", new ff(t))
            }
        }
        const pf = /^data:(\S*?);base64,/;
        class bf {
            constructor(t, e, n) {
        ...
        class vf extends _d {
            ...
            init() {
                ...
                if (this.tokenUrl) return this.token = new vf.Token(this.tokenUrl), this.token.init();
                this.token = null
            }
        }
        vf.Token = _f;
        class yf extends _d {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = e.token,
                    i = e.uploadUrl;
                n && (this._uploadGateway = new yf._UploadGateway(n, i), t.plugins.get(kh).createUploadAdapter = (t => new xf(this._uploadGateway, t)))
            }
        }
        class xf {
            constructor(t, e) {
        ...
        yf._UploadGateway = class {
            ...
            upload(t) {
                return new bf(t, this._token, this._apiAddress)
            }
        };
        class Af extends Xr {
            constructor(t) {
        ...
        class Cf extends _d {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    for (const t of o.getRanges())
                        for (const e of t) {
                            const t = e.item;
                            au(t) && !Pf(t, s) && (i.addClass(su, t), this._previouslySelected.add(t), s = t, t == r && i.setSelection(o.getRanges(), {
                                fake: !0,
                                label: lu(r)
                            }))
                        }
                    ...
                    priority: "low"
                }), t.addObserver(Af), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
            ...
            _onMousedown(t, e) {
                ...
                if (!au(r) && !(r = r.findAncestor(au))) return;
            ...
            _clearPreviouslySelectedWidgets(t) {
                for (const e of this._previouslySelected) t.removeClass(su, e);
        ...
        class Sf extends Td {
            refresh() {
                ...
                this.isEnabled = gu(t), gu(t) && t.hasAttribute("alt") ? this.value = t.getAttribute("alt") : this.value = !1
            }
            execute(t) {
                const e = this.editor.model,
                    n = e.document.selection.getSelectedElement();
        ...
        class Mf extends _d {
            ...
            init() {
                this.editor.commands.add("imageTextAlternative", new Sf(this.editor))
            }
        }
        n(50);
        class Ef extends Ll {
        ...
        var Of = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.972 16.615a.997.997 0 0 1-.744-.292l-4.596-4.596a1 1 0 1 1 1.414-1.414l3.926 3.926 9.937-9.937a1 1 0 0 1 1.414 1.415L7.717 16.323a.997.997 0 0 1-.745.292z"/></svg>',
            Rf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.591 10.177l4.243 4.242a1 1 0 0 1-1.415 1.415l-4.242-4.243-4.243 4.243a1 1 0 0 1-1.414-1.415l4.243-4.242L4.52 5.934A1 1 0 0 1 5.934 4.52l4.243 4.243 4.242-4.243a1 1 0 1 1 1.415 1.414l-4.243 4.243z"/></svg>';
        n(54);
        class Df extends Ll {
            constructor(t) {
                super(t);
                const e = this.locale.t;
                this.focusTracker = new al, this.keystrokes = new Zc, this.labeledInput = this._createLabeledInputView(), this.saveButtonView = this._createButton(e("bf"), Of, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(e("bg"), Rf, "ck-button-cancel", "cancel"), this._focusables = new pl, this._focusCycler = new Wl({
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), Nf({
                    view: this
        ...
        function zf(t) {
            return Wn(t) ? t : _s(t) ? t.commonAncestorContainer : "function" == typeof t ? zf(t()) : null
        }

        function Bf(t, e) {
            return t.top - e.height - Vf.arrowVerticalOffset
        }

        function Ff(t) {
            return t.bottom + Vf.arrowVerticalOffset
        }
        Vf.arrowHorizontalOffset = 25, Vf.arrowVerticalOffset = 10, Vf._getOptimalPosition = Jl, Vf.defaultPositions = {
            northArrowSouth: (t, e) => ({
                top: Bf(t, e),
            ...
            northArrowSouthEast: (t, e) => ({
                top: Bf(t, e),
                left: t.left + t.width / 2 - e.width + Vf.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northArrowSouthWest: (t, e) => ({
                top: Bf(t, e),
                left: t.left + t.width / 2 - Vf.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            ...
            northWestArrowSouthWest: (t, e) => ({
                top: Bf(t, e),
                left: t.left - Vf.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouthEast: (t, e) => ({
                top: Bf(t, e),
                left: t.left - e.width + Vf.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            ...
            northEastArrowSouthEast: (t, e) => ({
                top: Bf(t, e),
                left: t.right - e.width + Vf.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouthWest: (t, e) => ({
                top: Bf(t, e),
                left: t.right - Vf.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            southArrowNorth: (t, e) => ({
                top: Ff(t),
        ...
        var Uf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.463 5.187a.888.888 0 1 1 1.254 1.255L9.16 10l3.557 3.557a.888.888 0 1 1-1.254 1.255L7.26 10.61a.888.888 0 0 1 .16-1.382l4.043-4.042z" /></svg>\n',
        ...
        class Wf extends _d {
            ...
            _createRotatorView() {
                const t = new Yf(this.editor.locale),
            ...
            _createFakePanelsView() {
                const t = new $f(this.editor.locale, this.view);
        ...
        class Yf extends Ll {
            constructor(t) {
                ...
                const e = t.t,
                    n = this.bindTemplate;
                this.set("isNavigationVisible", !0), this.focusTracker = new al, this.buttonPrevView = this._createButtonView(e("bm"), Uf), this.buttonNextView = this._createButtonView(e("bn"), Hf), this.content = this.createCollection(), this.setTemplate({
                    tag: "div",
                    attributes: {
        ...
        class Kf extends _d {
            ...
            _createForm() {
                ...
                this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new Df(t.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
                    ...
                    fu(e.selection) ? this._isVisible && function (t) {
                        const e = t.plugins.get("ContextualBalloon");
                        if (fu(t.editing.view.document.selection)) {
                            const n = Qf(t);
                            e.updatePosition(n)
                        }
                    }(t) : this._hideForm(!0)
        ...
        class Xf extends Ll {
            constructor(t) {
                super(t), this.buttonView = new id(t), this._fileInputView = new tg(t), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
                    tag: "span",
                    attributes: {
        ...
        var eg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.91 10.54c.26-.23.64-.21.88.03l3.36 3.14 2.23-2.06a.64.64 0 0 1 .87 0l2.52 2.97V4.5H3.2v10.12l3.71-4.08zm10.27-7.51c.6 0 1.09.47 1.09 1.05v11.84c0 .59-.49 1.06-1.09 1.06H2.79c-.6 0-1.09-.47-1.09-1.06V4.08c0-.58.49-1.05 1.1-1.05h14.38zm-5.22 5.56a1.96 1.96 0 1 1 3.4-1.96 1.96 1.96 0 0 1-3.4 1.96z"/></svg>';
        ...
        var rg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 250"><rect rx="4"/></svg>';
        n(64), n(66), n(68);
        class sg extends _d {
            constructor(t) {
                super(t), this.placeholder = "data:image/svg+xml;utf8," + encodeURIComponent(rg)
            }
            init() {
            ...
            uploadStatusChange(t, e, n) {
                ...
                if (!n.consumable.consume(e.item, t.name)) return;
                const s = i.plugins.get(kh),
                    a = r ? e.attributeNewValue : null,
                    c = this.placeholder,
                    l = i.editing.mapper.toViewElement(o),
                    d = n.writer;
                if ("reading" == a) return ag(l, d), void cg(c, l, d);
                if ("uploading" == a) {
                    const t = s.loaders.get(r);
                    return ag(l, d), void(t ? (lg(l, d), function (t, e, n, i) {
                        const o = function (t) {
        ...
        function cg(t, e, n) {
            ...
            i.getAttribute("src") !== t && n.setAttribute("src", t, i), dg(e, "placeholder") || n.insert(n.createPositionAfter(i), function (t) {
                const e = t.createUIElement("div", {
        ...
        function lg(t, e) {
            t.hasClass("ck-image-upload-placeholder") && e.removeClass("ck-image-upload-placeholder", t), hg(t, e, "placeholder")
        }
        ...
        class mg extends _d {
            ...
            init() {
                const t = this.editor,
                    ...
                    i = t.conversion,
                    o = t.plugins.get(kh),
                    r = ng(t.config.get("image.upload.types"));
                n.extend("image", {
                    allowAttributes: ["uploadId", "uploadStatus"]
                }), t.commands.add("imageUpload", new fg(t)), i.for("upcast").attributeToAttribute({
                    view: {
                        name: "img",
                        key: "uploadId"
                    },
                ...
                }), this.listenTo(t.plugins.get(Ad), "inputTransformation", (e, n) => {
        ...
        class wg extends Td {
            refresh() {
                const t = this.editor.model,
                    e = Uh(t.document.selection.getSelectedBlocks());
                this.value = !!e && e.is("paragraph"), this.isEnabled = !!e && kg(e, t.schema)
            }
            execute(t = {}) {
                const e = this.editor.model,
                    n = e.document;
                e.change(i => {
                    ...
                    for (const t of o) !t.is("paragraph") && kg(t, e.schema) && i.rename(t, "paragraph")
                })
            }
        }
        ...
        class _g extends _d {
            ...
            init() {
                const t = this.editor,
                    e = t.model,
                    n = t.data;
                t.commands.add("paragraph", new wg(t)), e.schema.register("paragraph", {
                    inheritAllFrom: "$block"
                }), t.conversion.elementToElement({
                    model: "paragraph",
                    view: "p"
                }), t.conversion.for("upcast").elementToElement({
                    model: (t, e) => _g.paragraphLikeElements.has(t.name) ? t.isEmpty ? null : e.createElement("paragraph") : null,
                    converterPriority: "low"
                }), n.upcastDispatcher.on("element", (t, e, n) => {
                    n.consumable.test(e.viewItem, {
                        name: e.viewItem.name
                    }) && yg(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, vg(e.viewItem, e.modelCursor, n))
                }, {
                    priority: "low"
                }), n.upcastDispatcher.on("text", (t, e, n) => {
                    e.modelRange || yg(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, vg(e.viewItem, e.modelCursor, n))
                }, {
                    priority: "lowest"
        ...
        _g.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td"]);
        class xg extends Td {
            constructor(t, e) {
            ...
            refresh() {
                const t = Uh(this.editor.model.document.selection.getSelectedBlocks());
                this.value = !!t && this.modelElements.includes(t.name) && t.name, this.isEnabled = !!t && this.modelElements.some(e => Ag(t, e, this.editor.model.schema))
            }
            execute(t) {
                const e = this.editor.model,
                    n = e.document,
                    i = t.value;
                e.change(t => {
                    const o = Array.from(n.selection.getSelectedBlocks()).filter(t => Ag(t, i, e.schema));
        ...
        class Cg extends _d {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const i of e) i.model !== Tg && (t.model.schema.register(i.model, {
                    inheritAllFrom: "$block"
                }), t.conversion.elementToElement(i), n.push(i.model));
                this._addDefaultH1Conversion(t), t.commands.add("heading", new xg(t, n))
            }
            afterInit() {
                const t = this.editor,
                ...
                e && this.listenTo(e, "afterExecute", (e, i) => {
                    ...
                    n.some(t => o.is(t.model)) && !o.is(Tg) && 0 === o.childCount && i.writer.rename(o, Tg)
                })
            }
        ...
        class Sg extends _d {
            init() {
                ...
                t.ui.componentFactory.add("heading", e => {
                    ...
                    const d = hd(e);
                    return ud(d, s), d.buttonView.set({
                        isOn: !1,
                        withText: !0,
                        tooltip: o
                    }), d.extendTemplate({
        ...
        class Ig extends _d {
            ...
            init() {
                ...
                i.downcastDispatcher.on("insert:caption", Ng(t => t.createContainerElement("figcaption"), !1));
                const s = function (t, e) {
                    return n => {
                        const i = n.createEditableElement("figcaption");
                        return n.setCustomProperty("imageCaption", !0, i), dl({
                            view: t,
                            element: i,
                            text: e
                        }), du(i, n)
                ...
                o.downcastDispatcher.on("insert:caption", Ng(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
            ...
            _updateCaptionVisibility(t) {
                ...
                const s = Og(o.getFirstPosition().parent);
                if (s && (i = e.toViewElement(s)), i) return n ? n === i ? Dg(i, t) : (Rg(n, t), this._lastSelectedCaption = i, Dg(i, t)) : (this._lastSelectedCaption = i, Dg(i, t));
                if (n) {
                    const e = Rg(n, t);
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const t of n)
                    if ("insert" == t.type && "$text" != t.name) {
                        ...
                        if (n.is("image") && !Mg(n) && i.push(n), !n.is("image") && n.childCount)
                            for (const t of e.createRangeIn(n).getItems()) t.is("image") && !Mg(t) && i.push(t)
        ...
        var Vg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm2.5 3V12h11V7.5h-11zM4.061 6H15.94c.586 0 1.061.407 1.061.91v5.68c0 .503-.475.91-1.061.91H4.06c-.585 0-1.06-.407-1.06-.91V6.91C3 6.406 3.475 6 4.061 6zM2 16.5V15h16v1.5z"/></svg>',
            zg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M18 4.5V3H2v1.5h16zm0 3V6h-5.674v1.5H18zm0 3V9h-5.674v1.5H18zm0 3V12h-5.674v1.5H18zm-8.5-6V12h-6V7.5h6zm.818-1.5H2.682C2.305 6 2 6.407 2 6.91v5.68c0 .503.305.91.682.91h7.636c.377 0 .682-.407.682-.91V6.91c0-.503-.305-.91-.682-.91zM18 16.5V15H2v1.5h16z"/></svg>',
            Bg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm4.5 3V12h7V7.5h-7zM5.758 6h8.484c.419 0 .758.407.758.91v5.681c0 .502-.34.909-.758.909H5.758c-.419 0-.758-.407-.758-.91V6.91c0-.503.34-.91.758-.91zM2 16.5V15h16v1.5z"/></svg>',
            Fg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm0 3V6h5.674v1.5zm0 3V9h5.674v1.5zm0 3V12h5.674v1.5zm8.5-6V12h6V7.5h-6zM9.682 6h7.636c.377 0 .682.407.682.91v5.68c0 .503-.305.91-.682.91H9.682c-.377 0-.682-.407-.682-.91V6.91c0-.503.305-.91.682-.91zM2 16.5V15h16v1.5z"/></svg>';
        const Ug = {
                full: {
                    name: "full",
        ...
        function Wg(t) {
            if ("string" == typeof t) {
                const e = t;
                Ug[e] ? t = Object.assign({}, Ug[e]) : (console.warn(Object(Gn.a)("image-style-not-found: There is no such image style of given name."), {
                    name: e
                }), t = {
                    name: e
                })
        ...
        class Yg extends _d {
            ...
            init() {
                ...
                const o = qg(t.config.get("image.styles"));
                e.extend("image", {
                ...
                const r = function (t) {
                    return (e, n, i) => {
                        if (!i.consumable.consume(n.item, e.name)) return;
                        const o = jg(n.attributeNewValue, t),
                ...
                i.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function (t) {
                    ...
                    priority: "low"
                }), t.commands.add("imageStyle", new Lg(t, o))
            }
        }
        n(73);
        class $g extends _d {
        ...
        class Gg extends _d {
            ...
            register(t, {
                ...
                const r = this.editor,
                    s = r.t,
                    a = new gd(r.locale);
                if (a.ariaLabel = e || s("ax"), this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {
                    toolbarId: t
                });
            ...
            _showToolbar(t, e) {
                this._isToolbarVisible(t) ? Qg(this.editor, e) : this._isToolbarInBalloon(t) || (this._balloon.add({
                    view: t.view,
                    position: Kg(this.editor, e),
        ...
        class em extends _d {
            ...
            init() {
                const t = this.editor,
                    e = t.locale,
                    n = t.t,
                    i = "ltr" == e.uiLanguageDirection ? Xg : tm,
                    o = "ltr" == e.uiLanguageDirection ? tm : Xg;
        ...
        class im extends Ll {
            ...
            _createUrlInput() {
                const t = this.locale.t,
                    e = new Ef(this.locale, If);
                return e.label = t("bh"), e.inputView.placeholder = "https://example.com", e
            }
            _createButton(t, e, n, i) {
                const o = new id(this.locale);
                return o.set({
        ...
        var om = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.077 15l.991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184zm4.919 10.562l-1.414 1.414a.75.75 0 1 1-1.06-1.06l1.414-1.415-1.415-1.414a.75.75 0 0 1 1.061-1.06l1.414 1.414 1.414-1.415a.75.75 0 0 1 1.061 1.061l-1.414 1.414 1.414 1.415a.75.75 0 0 1-1.06 1.06l-1.415-1.414z"/></svg>',
            rm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7.3 17.37l-.061.088a1.518 1.518 0 0 1-.934.535l-4.178.663-.806-4.153a1.495 1.495 0 0 1 .187-1.058l.056-.086L8.77 2.639c.958-1.351 2.803-1.076 4.296-.03 1.497 1.047 2.387 2.693 1.433 4.055L7.3 17.37zM9.14 4.728l-5.545 8.346 3.277 2.294 5.544-8.346L9.14 4.728zM6.07 16.512l-3.276-2.295.53 2.73 2.746-.435zM9.994 3.506L13.271 5.8c.316-.452-.16-1.333-1.065-1.966-.905-.634-1.895-.78-2.212-.328zM8 18.5L9.375 17H19v1.5H8z"/></svg>';
        n(77);
        class sm extends Ll {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new al, this.keystrokes = new Zc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("bb"), om, "unlink"), this.editButtonView = this._createButton(e("bc"), rm, "edit"), this.set("href"), this._focusables = new pl, this._focusCycler = new Wl({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {
            ...
            _createPreviewButton() {
                ...
                return t.set({
                    ...
                    attributes: {
                        ...
                        href: e.to("href", t => t && Ju(t)),
                        target: "_blank"
                    }
                }), t.bind("label").to(this, "href", t => t || n("be")), t.bind("isEnabled").to(this, "href", t => !!t), t.template.tag = "a", t.template.eventListeners = {}, t
            }
        }
        ...
        class lm extends _d {
            ...
            init() {
                const t = this.editor;
                t.editing.view.addObserver(nm), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(Wf), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }
            destroy() {
            ...
            _createFormView() {
                const t = this.editor,
                    ...
                    n = new im(t.locale, e.manualDecorators);
            ...
            _createToolbarLinkButton() {
                const t = this.editor,
                    e = t.commands.get("link"),
                    n = t.t;
                t.keystrokes.set(cm, (t, n) => {
                    n(), e.isEnabled && this._showUI(!0)
                }), t.ui.componentFactory.add("link", t => {
                    const i = new id(t);
                    return i.isEnabled = !0, i.label = n("as"), i.icon = am, i.keystroke = cm, i.tooltip = !0, i.isToggleable = !0, i.bind("isEnabled").to(e, "isEnabled"), i.bind("isOn").to(e, "value", t => !!t), this.listenTo(i, "execute", () => this._showUI(!0)), i
                })
            }
            ...
            _getSelectedLinkElement() {
                const t = this.editor.editing.view,
                    e = t.document.selection;
                if (e.isCollapsed) return dm(e.getFirstPosition()); {
        ...
        class hm extends Td {
            ...
            execute() {
                const t = this.editor.model,
                    e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e => fm(e, t.schema)),
                    i = !0 === this.value;
                t.change(t => {
                    if (i) {
        ...
        function pm(t, e, n, i) {
            ...
            if (a = wm(a), s.insert(a, o), l && "listItem" == l.name) {
                ...
                for (const t of n)
                    if (t.item.is("li")) {
                        ...
                        bm(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), n.position = i
                    }
            } else {
            ...
            bm(s, o, o.nextSibling), bm(s, o.previousSibling, o)
        }
        ...
        function Am(t, e, n) {
            const i = n.mapper.toViewElement(e.item).parent,
                o = n.writer;
            bm(o, i, i.nextSibling), bm(o, i.previousSibling, i);
                ...
                if (o.length > 0) {
                    for (let e = 0; e < o.length; e++) {
                        ...
                        if (t = i.insert(t, o[e]).end, e > 0) {
                            const e = bm(i, n, n.nextSibling);
                            e && e.parent == n && t.offset--
                        }
                    }
                    bm(i, t.nodeBefore, t.nodeAfter)
                }
            }
        }
                ...
                const a = function (t, e, n) {
                    ...
                    for (const s of e)
                        if ("ul" == s.name || "ol" == s.name) r = n.convertItem(s, r).modelCursor;
                            ...
                            c && (t = e.modelCursor.parent.is("listItem") ? e.modelCursor.parent : Nm(e.modelCursor), r = i.createPositionAfter(t))
                        } return r
        ...
        function Om(t, e, n, i, o, r) {
            ...
            d = wm(d);
            for (const t of [...i.getChildren()]) Rm(t) && (d = c.move(c.createRangeOn(t), d).end, bm(c, t, t.nextSibling), bm(c, t.previousSibling, t))
        }
        ...
        class Dm extends _d {
            ...
            init() {
                ...
                t.model.document.registerPostFixer(e => (function (t, e) {
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", Lm), e.mapper.registerViewToModelLength("li", Lm), n.mapper.on("modelToViewPosition", Em(n.view)), n.mapper.on("viewToModelPosition", function (t) {
                    return (e, n) => {
                ...
                }(t.model)), e.mapper.on("modelToViewPosition", Em(n.view)), n.downcastDispatcher.on("insert", Tm, {
                    priority: "high"
                }), n.downcastDispatcher.on("insert:listItem", ym(t.model)), e.downcastDispatcher.on("insert", Tm, {
                    priority: "high"
                }), e.downcastDispatcher.on("insert:listItem", ym(t.model)), n.downcastDispatcher.on("attribute:listType:listItem", xm, {
                    priority: "high"
                }), n.downcastDispatcher.on("attribute:listType:listItem", Am, {
                    priority: "low"
                    ...
                    return (e, n, i) => {
                        ...
                        const s = o.parent,
                            a = s.previousSibling,
                            c = r.createRangeOn(s);
                        r.remove(c), a && a.nextSibling && bm(r, a, a.nextSibling), Om(n.attributeOldValue + 1, n.range.start, c.start, o, i, t), pm(n.item, o, i, t);
                    ...
                    return (e, n, i) => {
                        ...
                        const s = o.parent,
                            ...
                            c = r.createRangeOn(s),
                            l = r.remove(c);
                        a && a.nextSibling && bm(r, a, a.nextSibling), Om(i.mapper.toModelElement(o).getAttribute("listIndent") + 1, n.position, c.start, o, i, t);
                        for (const t of r.createRangeIn(l).getItems()) i.mapper.unbindViewElement(t);
                        e.stop()
                    }
                }(t.model)), n.downcastDispatcher.on("remove", Cm, {
                    priority: "low"
                }), e.upcastDispatcher.on("element:ul", Sm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:ol", Sm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Mm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Pm), t.model.on("insertContent", Im, {
                    priority: "high"
                }), t.commands.add("numberedList", new hm(t, "numbered")), t.commands.add("bulletedList", new hm(t, "bulleted")), t.commands.add("indentList", new gm(t, "forward")), t.commands.add("outdentList", new gm(t, "backward"));
        ...
        function Lm(t) {
            ...
            for (const n of t.getChildren())
                if ("ul" == n.name || "ol" == n.name)
                    for (const t of n.getChildren()) e += Lm(t);
            return e
        }
        var jm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM3.5 3v5H2V3.7H1v-1h2.5V3zM.343 17.857l2.59-3.257H2.92a.6.6 0 1 0-1.04 0H.302a2 2 0 1 1 3.995 0h-.001c-.048.405-.16.734-.333.988-.175.254-.59.692-1.244 1.312H4.3v1h-4l.043-.043zM7 14.75a.75.75 0 0 1 .75-.75h9.5a.75.75 0 1 1 0 1.5h-9.5a.75.75 0 0 1-.75-.75z"/></svg>',
            Vm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0C1 4.784 1.777 4 2.75 4c.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75C1.784 7.5 1 6.723 1 5.75zm6 9c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0c0-.966.777-1.75 1.75-1.75.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75-.966 0-1.75-.777-1.75-1.75z"/></svg>';
        class zm extends _d {
            init() {
                const t = this.editor.t;
                _m(this.editor, "numberedList", t("o"), jm), _m(this.editor, "bulletedList", t("p"), Vm)
            }
        }
        ...
        function Fm(t, e, n, i) {
            ...
            return o.getFillerOffset = qm, t.insert(t.createPositionAt(o, 0), e.getMediaViewElement(t, n, i)), o
        }
        ...
        class Gm {
            ...
            _getMedia(t) {
                if (!t) return new Qm(this.locale);
                t = t.trim();
                for (const e of this.providerDefinitions) {
                    ...
                    for (const e of i) {
                        ...
                        if (i) return new Qm(this.locale, t, i, n)
                    }
                }
                return null
            }
        ...
        class Qm {
            ...
            _getPlaceholderHtml() {
                const t = new nd,
                    e = new ed;
                return t.text = this._t("Open media in new tab"), e.content = Ym, e.viewBox = $m, new wl({
                    tag: "div",
                    attributes: {
        ...
        class Km extends _d {
            ...
            constructor(t) {
                ...
                }), this.registry = new Gm(t.locale, t.config.get("mediaEmbed"))
            }
            init() {
                const t = this.editor,
                    e = t.model.schema,
                    ...
                    r = this.registry;
                t.commands.add("mediaEmbed", new Wm(t)), e.register("media", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["url"]
                    ...
                    view: (t, e) => {
                        ...
                        return function (t, e, n) {
                            return e.setCustomProperty("media", !0, t), cu(t, e, {
                                label: n
                            })
                        }(Fm(e, r, i, {
                ...
                }), i.for("editingDowncast").add(Bm(r, {
                    renderForEditingView: !0
                })), i.for("upcast").elementToElement({
                    view: {
                        name: "oembed",
        ...
        class Zm extends _d {
            ...
            init() {
                const t = this.editor,
                    e = t.model.document;
                this.listenTo(t.plugins.get(Ad), "inputTransformation", () => {
            ...
            _embedMediaBetweenPositions(t, e) {
                ...
                n.commands.get("mediaEmbed").isEnabled && (this._positionToInsert = Lc.fromPosition(t), this._timeoutId = tr.window.setTimeout(() => {
                    n.model.change(t => {
                        let e;
                        this._timeoutId = null, t.remove(o), "$graveyard" !== this._positionToInsert.root.rootName && (e = this._positionToInsert), Hm(n.model, s, e), this._positionToInsert.detach(), this._positionToInsert = null
                    })
                }, 100))
            }
        }
        ...
        class Xm extends Ll {
            ...
            _createUrlInput() {
                const t = this.locale.t,
                    e = new Ef(this.locale, If),
                    n = e.inputView;
                return this._urlInputViewInfoDefault = t("br"), this._urlInputViewInfoTip = t("bs"), e.label = t("bt"), e.infoText = this._urlInputViewInfoDefault, n.placeholder = "https://example.com", n.on("input", () => {
        ...
        class ep extends _d {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = t.plugins.get(Km).registry;
                this.form = new Xm(function (t, e) {
                    return [e => {
                        if (!e.url.length) return t("an")
                    }, n => {
                        if (!e.hasMedia(n.url)) return t("ao")
                    }]
        ...
        const dp = /<meta\s*name="?generator"?\s*content="?microsoft\s*word\s*\d+"?\/?>/i,
            hp = /xmlns:o="urn:schemas-microsoft-com/i;
        class up {
            isActive(t) {
                return dp.test(t) || hp.test(t)
            }
            execute(t) {
                const {
                    body: e,
                    stylesString: n
                } = ap(t.dataTransfer.getData("text/html"));
                np(e, n), cp(e, t.dataTransfer.getData("text/rtf")), t.content = e
            }
        }
                ...
                t.on("element:table", (t, e, n) => {
                    ...
                    if (l) {
                        if (n.writer.insert(c, l.position), n.consumable.consume(i, {
                            ...
                            n.writer.insert(t, n.writer.createPositionAt(c, "end")), mp(n.writer, n.writer.createPositionAt(t, "end"))
                        }
        ...
        function _p(t) {
            return !!t.getCustomProperty("table") && au(t)
        }

        function vp(t) {
            const e = t.getSelectedElement();
            return e && _p(e) ? e : null
        }

        function yp(t) {
            const e = fp("table", t.getFirstPosition());
            return e && _p(e.parent) ? e.parent : null
        }
        ...
        function xp(t = {}) {
            return e => e.on("insert:table", (e, n, i) => {
                ...
                i.writer.insert(i.writer.createPositionAt(s, 0), a), r && (c = function (t, e) {
                    return e.setCustomProperty("table", !0, t), cu(t, e, {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = Rp(Op(n, d), a, i), c = o.getChild(n), l = h.get(n) || Ip(c, n, s, i);
                    h.set(n, l), i.consumable.consume(r, "insert"), Ep(e, d, i.writer.createPositionAt(l, "end"), i, t)
                }
        ...
        function Ap(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                ...
                const r = o.parent,
                    ...
                    d = new Map;
                for (const e of c) {
                    const n = Rp(Op(a, l), s, i),
                        r = d.get(a) || Ip(o, a, n, i);
                    d.set(a, r), i.consumable.consume(e.cell, "insert"), Ep(e, l, i.writer.createPositionAt(r, "end"), i, t)
                }
            })
        }
            ...
            return e => e.on("insert:tableCell", (e, n, i) => {
                ...
                for (const e of c)
                    if (e.cell === o) {
                        ...
                        return void Ep(e, l, i.writer.createPositionAt(n, r.getChildIndex(o)), i, t)
                    }
            })
        }
        ...
        function Cp(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                const r = Vp(i.mapper.toViewElement(o)),
                ...
                if (a > s) {
                    ...
                    for (const n of t)
                        for (const t of n.getChildren()) Sp(t, "th", i, e);
                    Lp("tbody", r, i)
                } else {
                    jp(Array.from(o.getChildren()).filter(({
                        index: t
                    }) => c(t, a - 1, s)).reverse(), Rp("tbody", r, i), i, 0);
                    const t = new kp(o, {
                            startRow: a ? a - 1 : a,
                            endRow: s - 1
                        }),
        ...
        function Pp(t = {}) {
            ...
            return t => t.on("attribute:headingColumns:table", (t, n, i) => {
                ...
                const r = {
                    ...
                    a = n.attributeNewValue,
                    c = (s > a ? s : a) - 1;
                for (const t of new kp(o)) t.column > c || Mp(t, r, i, e)
            })
        }
        ...
        function Sp(t, e, n, i) {
            ...
            let s;
            if (i) {
                s = du(o.createEditableElement(e, r.getAttributes()), o), o.insert(o.createPositionAfter(r), s), o.move(o.createRangeIn(r), o.createPositionAt(s, 0)), o.remove(o.createRangeOn(r))
            } else s = o.rename(e, r);
        ...
        function Mp(t, e, n, i) {
            const {
                cell: o
            } = t, r = Np(t, e), s = n.mapper.toViewElement(o);
            s && s.name !== r && Sp(o, r, n, i)
        }

        function Ep(t, e, n, i, o) {
            const r = o && o.asWidget,
                s = Np(t, e),
                a = r ? du(i.writer.createEditableElement(s), i.writer) : i.writer.createContainerElement(s),
                c = t.cell,
                l = c.getChild(0),
        ...
        class Bp extends Td {
            ...
            refresh() {
                const t = fp("table", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }
            execute() {
                const t = this.editor,
                    ...
                    i = fp("tableCell", e.getFirstPosition()).parent,
                    o = i.parent,
                    r = o.getChildIndex(i),
        ...
        class Fp extends Td {
            ...
            execute() {
                const t = this.editor,
                    e = t.model.document.selection,
                    n = t.plugins.get("TableUtils"),
                    i = fp("tableCell", e.getFirstPosition()),
                    o = i.parent.parent,
                    {
                        column: r
                    } = n.getCellLocation(i),
        ...
        class Up extends Td {
            ...
            refresh() {
                const t = fp("tableCell", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }
            execute() {
                const t = fp("tableCell", this.editor.model.document.selection.getFirstPosition()),
        ...
        class Hp extends Td {
            ...
            execute() {
                const t = this.editor.model,
                    e = fp("tableCell", t.document.selection.getFirstPosition()),
                    n = this.value,
                    i = this.direction;
                t.change(t => {
        ...
        class Wp extends Td {
            ...
            execute() {
                const t = this.editor.model,
                    e = fp("tableCell", t.document.selection.getFirstPosition()).parent,
                    n = e.parent,
                    i = n.getChildIndex(e),
                    o = n.getAttribute("headingRows") || 0;
                t.change(t => {
                    o && i <= o && gp("headingRows", o - 1, n, t, 0);
                    const r = [...new kp(n, {
                            endRow: i
                        })],
                        s = new Map;
                    ...
                    for (const {
                        ...
                        if (s.has(i)) {
                            ...
                            t.move(t.createRangeOn(o), a), gp("rowspan", r, o, t), l = o
                        } else l = o;
                    t.remove(e)
                })
            }
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    for (const {
                            ...
                            column: n,
                            colspan: i
                        } of s) n <= a && i > 1 && n + i > a ? gp("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        class $p extends Td {
            ...
            execute(t = {}) {
                const e = this.editor.model,
                    n = fp("tableCell", e.document.selection.getFirstPosition()).parent,
                    i = n.parent,
                ...
                e.change(t => {
                    if (s) {
                        ...
                        for (const n of e) Gp(n, s, t)
                    }
                    gp("headingRows", s, i, t, 0)
                })
            }
            _isInHeading(t, e) {
        ...
        class Qp extends Td {
            ...
            execute(t = {}) {
                const e = this.editor.model,
                    n = e.document.selection,
                    i = this.editor.plugins.get("TableUtils"),
                    o = fp("tableCell", n.getFirstPosition()),
                    r = o.parent.parent,
                    {
                        column: s
                    } = i.getCellLocation(o);
        ...
        class Kp extends _d {
            ...
            insertColumns(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (0 === i || r === i) {
                        for (const n of t.getChildren()) Zp(o, e, e.createPositionAt(n, i ? "end" : 0));
                        return
                    }
                    const s = new kp(t, {
                        column: i,
            ...
            splitCellVertically(t, e = 2) {
                ...
                n.change(n => {
                    if (r > 1) {
                        ...
                        gp("colspan", s, t, n);
                        const a = {};
                        i > 1 && (a.colspan = i), o > 1 && (a.rowspan = o), Zp(r > e ? e - 1 : r - 1, n, n.createPositionAfter(t), a)
                    }
                    if (r < e) {
                        const s = e - r,
                            a = [...new kp(i)],
                    ...
                    if (s > 1) {
                        ...
                        for (const {
                            ...
                            if (e >= r + l && t === d && (e + r + l) % c == 0) {
                                Zp(1, n, n.createPositionAt(o.getChild(e), s), h)
                            }
                        }
                    }
                    if (s < e) {
        ...
        function tb(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                ...
                for (const e of n) {
                    let n;
                    "table" == e.name && "insert" == e.type && (n = e.position.nodeAfter), "tableRow" != e.name && "tableCell" != e.name || (n = fp("table", e.position)), ib(e) && (n = fp("table", e.range.start)), n && !o.has(n) && (i = eb(n, t) || i, i = nb(n, t) || i, o.add(n))
                }
                return i
            })(e, t))
        }
        ...
        function eb(t, e) {
            ...
            if (i.length) {
                n = !0;
                for (const t of i) gp("rowspan", t.rowspan, t.cell, e, 1)
            }
            return n
        }
        ...
        function nb(t, e) {
            ...
            if (!Object.values(i).every(t => t === o)) {
                ...
                for (const [r, s] of Object.entries(i)) {
                    const i = o - s;
                    if (i) {
                        for (let n = 0; n < i; n++) mp(e, e.createPositionAt(t.getChild(r), "end"));
                        n = !0
                    }
                }
            }
        ...
        function ob(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                const n = e.document.differ.getChanges();
                let i = !1;
                for (const e of n) "insert" == e.type && "table" == e.name && (i = rb(e.position.nodeAfter, t) || i), "insert" == e.type && "tableRow" == e.name && (i = sb(e.position.nodeAfter, t) || i), "insert" == e.type && "tableCell" == e.name && (i = ab(e.position.nodeAfter, t) || i), cb(e) && (i = ab(e.position.parent, t) || i);
                return i
            })(e, t))
        }
        ...
        function rb(t, e) {
            let n = !1;
            for (const i of t.getChildren()) n = sb(i, e) || n;
            return n
        }

        function sb(t, e) {
            let n = !1;
            for (const i of t.getChildren()) n = ab(i, e) || n;
            return n
        }
        ...
        function lb(t) {
            t.document.registerPostFixer(() => (function (t) {
                ...
                for (const t of e.getChanges()) {
                    ...
                    e.is("tableCell") && db(e, t.type) && n.add(e)
                }
                if (n.size) {
        ...
        class hb extends _d {
            ...
            init() {
                ...
                n.register("table", {
                ...
                }), i.for("upcast").add(pp()), i.for("editingDowncast").add(xp({
                    asWidget: !0
                })), i.for("dataDowncast").add(xp()), i.for("upcast").elementToElement({
                    model: "tableRow",
                    view: "tr"
                }), i.for("editingDowncast").add(Ap({
                    asWidget: !0
                })), i.for("dataDowncast").add(Ap()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                    const i = n.writer,
                        o = n.mapper,
                    ...
                    priority: "higher"
                })), i.for("upcast").add(bp("td")), i.for("upcast").add(bp("th")), i.for("editingDowncast").add(Tp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Tp()), i.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), i.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), i.for("editingDowncast").add(Pp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Pp()), i.for("editingDowncast").add(Cp({
                    asWidget: !0
                })), i.for("dataDowncast").add(Cp()), t.commands.add("insertTable", new zp(t)), t.commands.add("insertTableRowAbove", new Bp(t, {
                    order: "above"
                })), t.commands.add("insertTableRowBelow", new Bp(t, {
                    order: "below"
                })), t.commands.add("insertTableColumnLeft", new Fp(t, {
                    order: "left"
                })), t.commands.add("insertTableColumnRight", new Fp(t, {
                    order: "right"
                })), t.commands.add("removeTableRow", new Wp(t)), t.commands.add("removeTableColumn", new Yp(t)), t.commands.add("splitTableCellVertically", new Up(t, {
                    direction: "vertically"
                })), t.commands.add("splitTableCellHorizontally", new Up(t, {
                    direction: "horizontally"
                })), t.commands.add("mergeTableCellRight", new Hp(t, {
                    direction: "right"
                })), t.commands.add("mergeTableCellLeft", new Hp(t, {
                    direction: "left"
                })), t.commands.add("mergeTableCellDown", new Hp(t, {
                    direction: "down"
                })), t.commands.add("mergeTableCellUp", new Hp(t, {
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new Qp(t)), t.commands.add("setTableRowHeader", new $p(t)), tb(e), lb(e), ob(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
            ...
            _getTabHandler(t) {
                const e = this.editor;
                return (n, i) => {
                    const o = fp("tableCell", e.model.document.selection.getFirstPosition());
                    if (!o) return;
                    i();
                    const r = o.parent,
                        s = r.parent,
        ...
        var gb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 6v3h4V6H3zm0 4v3h4v-3H3zm0 4v3h4v-3H3zm5 3h4v-3H8v3zm5 0h4v-3h-4v3zm4-4v-3h-4v3h4zm0-4V6h-4v3h4zm1.5 8a1.5 1.5 0 0 1-1.5 1.5H3A1.5 1.5 0 0 1 1.5 17V4c.222-.863 1.068-1.5 2-1.5h13c.932 0 1.778.637 2 1.5v13zM12 13v-3H8v3h4zm0-4V6H8v3h4z"/></svg>',
            ...
            pb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v16h-1V2z" opacity=".6"/><path d="M1 6h18a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zm1 2v4h4V8H2zm6 0v4h4V8H8zm6 0v4h4V8h-4z"/></svg>',
            bb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v7h-1V2zm6 5v1H2V7h16zM8 12v1H2v-1h6z" opacity=".6"/><path d="M7 7h12a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1zm1 2v9h10V9H8z"/></svg>';
        class wb extends _d {
            init() {
                const t = this.editor,
                    e = this.editor.t,
                ...
                t.ui.componentFactory.add("insertTable", n => {
                    ...
                    return this._prepareDropdown(e("y"), mb, i, t)
                    ...
                    return this._prepareDropdown(e("ad"), pb, n, t)
                    ...
                    return this._prepareDropdown(e("ak"), bb, i, t)
                })
            }
            _prepareDropdown(t, e, n, i) {
                const o = this.editor,
                    ...
                    s = [],
                    a = new oo;
                for (const t of n) kb(t, o, s, a);
                return ud(r, a), r.buttonView.set({
                    label: t,
                    icon: e,
                    tooltip: !0
        ...
        function kb(t, e, n, i) {
            const o = t.model = new Pg(t.model),
                {
                    commandName: r,
                    bindIsOn: s
                } = t.model;
        ...
        class _b extends kd {}
        _b.builtinPlugins = [class extends _d {
            static get requires() {
                return [Ad, Id, Dd, Qd, ph]
            }
            static get pluginName() {
                return "Essentials"
            }
            ...
            _addListAutoformats() {
                const t = this.editor.commands;
                t.get("bulletedList") && new Ph(this.editor, /^[*-]\s$/, "bulletedList"), t.get("numberedList") && new Ph(this.editor, /^1[.|)]\s$/, "numberedList")
            }
            _addBasicStylesAutoformats() {
                const t = this.editor.commands;
                if (t.get("bold")) {
                    const t = Eh(this.editor, "bold");
                    new Sh(this.editor, /(\*\*)([^*]+)(\*\*)$/g, t), new Sh(this.editor, /(__)([^_]+)(__)$/g, t)
                }
                if (t.get("italic")) {
                    const t = Eh(this.editor, "italic");
                    new Sh(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, t), new Sh(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, t)
                }
                if (t.get("code")) {
                    const t = Eh(this.editor, "code");
                    new Sh(this.editor, /(`)([^`]+)(`)$/g, t)
                }
            }
            ...
            _addBlockQuoteAutoformats() {
                this.editor.commands.get("blockQuote") && new Ph(this.editor, /^>\s$/, "blockQuote")
            }
        }, class extends _d {
            static get requires() {
                return [Oh, Lh]
            ...
            init() {
                const t = this.editor,
                    e = [];
                e.push(new up), e.push(new rp), t.plugins.get("Clipboard").on("inputTransformation", (t, n) => {
