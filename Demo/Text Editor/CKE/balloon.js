...
! function (t) {
    t.en = Object.assign(t.en || {}, {
        ...
        j: "Full size image",
        k: "Side image",
        l: "Left aligned image",
        m: "Centered image",
        n: "Right aligned image",
        o: "Italic",
        p: "Bold",
        q: "Increase indent",
        r: "Decrease indent",
        ...
        az: "Heading 6",
        ba: "Widget toolbar",
        bb: "Upload in progress",
        bc: "Open in a new tab",
        bd: "Downloadable",
        be: "Unlink",
        bf: "Edit link",
        bg: "Open link in new tab",
        bh: "This link has no URL",
        bi: "Dropdown toolbar",
        bj: "Save",
        bk: "Cancel",
        bl: "Link URL",
        bm: "Paste the media URL in the input.",
        bn: "Tip: Paste the URL into the content to embed faster.",
        bo: "Media URL",
        ...
        bv: "Undo",
        bw: "Redo",
        bx: "Change image text alternative",
        by: "Could not obtain resized image URL.",
        bz: "Selecting resized image failed",
        ca: "Could not insert image at the current position.",
        cb: "Inserting image failed",
        cc: "Text alternative"
    })
    ...
    return function (t) {
        ...
        class o extends Error {
            ...
            static rethrowUnexpectedError(t, e) {
                ...
                throw new o("unexpected-error", e, {
                    originalError: {
                        message: t.message,
                        stack: t.stack,
                        name: t.name
        ...
        var pt = function (t, e) {
            var n = this.__data__;
            return this.size += this.has(t) ? 0 : 1, n[t] = at && void 0 === e ? mt : e, this
        };
        ...
        Et.prototype.clear = L, Et.prototype.delete = j, Et.prototype.get = V, Et.prototype.has = z, Et.prototype.set = St;
        var It = Et;
        var Nt = function (t, e) {
        ...
        var pe = function (t) {
            ...
            var e = ae(t),
                n = [];
            for (var i in t)("constructor" != i || !e && me.call(t, i)) && n.push(i);
            return n
        };
        var be = function (t) {
        ...
        var Fn = function t(e, n, i, o, r, s) {
                ...
                if (h) {
                    ...
                    if (u == zn || u == Ln || f && !r) {
                        if (a = l || f ? {} : An(e), !c) return l ? Se(e, we(a, e)) : Ce(e, fe(a, e))
                    } else {
                        if (!Bn[u]) return r ? e : {};
                        a = vn(e, u, c)
                    }
        ...
        class ki extends ui {
            ...
            _insertChild(t, e) {
                ...
                const i = function (t) {
                    ...
                    pi(t) || (t = [t]);
                    return Array.from(t).map(t => "string" == typeof t ? new fi(t) : t instanceof gi ? new fi(t.data) : t)
                }(e);
        ...
        var Pi = function (t, e, n) {
            return e = Ci(void 0 === e ? t.length - 1 : e, 0),
                function () {
            ...
            _next() {
                ...
                if (i instanceof fi) {
                    if (this.singleCharacters) return t = new Zi(i, 0), this.position = t, this._next(); {
                        ...
                        return i == this._boundaryEndParent ? (o = this.boundaries.end.offset, n = new gi(i, 0, o), t = Zi._createAfter(n)) : (n = new gi(i, 0, i.data.length), t.offset++), this.position = t, this._formatReturnValue("text", n, e, t, o)
                    }
                }
                if ("string" == typeof i) {
                    let i;
                ...
                if (i instanceof fi) {
                    if (this.singleCharacters) return t = new Zi(i, i.data.length), this.position = t, this._previous(); {
                        ...
                        if (i == this._boundaryStartParent) {
                            ...
                            o = (n = new gi(i, e, i.data.length - e)).data.length, t = Zi._createBefore(n)
                        } else n = new gi(i, 0, i.data.length), t.offset--;
        ...
        class no {
            ...
            _pushRange(t) {
                for (const e of this._ranges)
                    if (t.isIntersecting(e)) throw new Gn.b("view-selection-range-intersects: Trying to add a range that intersects with another range from selection.", this, {
                        addedRange: t,
                        intersectingRange: e
                    });
        ...
        function $o(t, e, n) {
            ...
            const i = t.length,
                o = e.length;
            if (i > 200 || o > 200 || i + o > 300) return $o.fastDiff(t, e, n, !0);
            let r, s;
            if (o < i) {
                const n = t;
        ...
        class Jo {
            ...
            render() {
                ...
                if (t) {
                    ...
                    Bo(e.parent) ? this._inlineFiller = e.parent : this._inlineFiller = Zo(n, e.parent, e.offset)
                    ...
                    for (const o of r)
                        if ("replace" === o) {
                            const o = e.equal + e.insert,
                                r = e.equal + e.delete,
                                s = t.getChild(o);
                            s && !s.is("uiElement") && this._updateElementMappings(s, n[r]), Qo(i[o]), e.equal++
                        } else e[o]++
                }
            }
            ...
            _updateChildren(t, e) {
                ...
                i && i.parent === t && Zo(n.ownerDocument, r, i.offset);
                const s = this._diffNodeLists(o, r);
                let a = 0;
                const c = new Set;
                for (const t of s) "insert" === t ? (Go(n, a, r[a]), a++) : "delete" === t ? (c.add(o[a]), Qo(o[a])) : (this._markDescendantTextToSync(this.domConverter.domToView(r[a])), a++);
            ...
            _findReplaceActions(t, e, n) {
                ...
                for (const a of t) "insert" === a ? r.push(n[s.equal + s.insert]) : "delete" === a ? o.push(e[s.equal + s.delete]) : ((i = i.concat($o(o, r, Xo).map(t => "equal" === t ? "replace" : t))).push("equal"), o = [], r = []), s[a]++;
                return i.concat($o(o, r, Xo).map(t => "equal" === t ? "replace" : t))
            }
            ...
            _updateDomSelection(t) {
                ...
                t.focus(), e.collapse(n.parent, n.offset), e.extend(i.parent, i.offset), go.isGecko && function (t, e) {
                    const n = t.parent;
        ...
        function Zo(t, e, n) {
            ...
            if (Do(o)) return o.data = zo + o.data, o; {
                ...
                return Array.isArray(e) ? i.splice(n, 0, o) : Go(e, n, o), o
            }
        }
        ...
        class or {
            ...
            isBlockFiller(t) {
                return "br" == this.blockFillerMode ? t.isEqualNode(ir) : function (t, e) {
            ...
            _processDataFromDomText(t) {
                let e = t.data;
                if (rr(t, this.preElements)) return Uo(t);
                e = e.replace(/[ \n\t\r]{1,}/g, " ");
        ...
        var cr = Li({}, ei, {
            ...
            stopListening(t, e, n) {
                ...
                ei.stopListening.call(this, t, e, n), t instanceof lr && t.detach(e)
            },
            _getProxyEmitter(t) {
                return function (t, e) {
            ...
            for (r.set(t, e), r.set(e, t); ++d < a;) {
                ...
                if (u) {
                    if (!br(e, function (t, e) {
                            if (!wr(u, e) && (f === t || o(f, t, n, i, r))) return u.push(e)
                        })) {
                        h = !1;
                        break
                    }
        ...
        var Gr = function (t, e, n, i, o, r) {
            ...
            if (u && !d) return r || (r = new It), s || ie(t) ? vr(t, e, n, i, o, r) : zr(t, e, c, n, i, o, r);
            if (!(n & Hr)) {
                var f = d && $r.call(t, "__wrapped__"),
                    g = h && $r.call(e, "__wrapped__");
                if (f || g) {
                    var m = f ? t.value() : t,
                        p = g ? e.value() : e;
                    return r || (r = new It), o(m, p, n, i, r)
                }
            }
            return !!u && (r || (r = new It), Ur(t, e, n, i, o, r))
        };
        var Qr = function t(e, n, i, o, r) {
            return e === n || (null == e || null == n || !w(e) && !w(n) ? e != e && n != n : Gr(e, n, i, o, t, r))
        };
        var Kr = function (t, e, n) {
            var i = (n = "function" == typeof n ? n : void 0) ? n(t, e) : void 0;
            return void 0 === i ? Qr(t, e, void 0, n) : !!i
        };
        class Jr extends hr {
            constructor(t) {
        ...
        class Xr extends hr {
            ...
            fire(t, e, n) {
                this.isEnabled && this.document.fire(t, new Zr(this.view, e, n))
            }
        }
        class ts extends Xr {
            constructor(t) {
        ...
        var es = function () {
            ...
            ns = "[object Symbol]";
        var is = function (t) {
                return "symbol" == typeof t || w(t) && m(t) == ns
            },
            os = NaN,
            rs = /^\s+|\s+$/g,
            ss = /^[-+]0x[0-9a-f]+$/i,
        ...
        var ds = function (t) {
                ...
                t = t.replace(rs, "");
                var n = as.test(t);
                return n || cs.test(t) ? ls(t.slice(2), n ? 2 : 8) : ss.test(t) ? os : +t
            },
        ...
        var gs = function (t, e, n) {
            ...
            return e = ds(e) || 0, B(n) && (d = !!n.leading, r = (h = "maxWait" in n) ? us(ds(n.maxWait) || 0, e) : r, u = "trailing" in n ? !!n.trailing : u), b.cancel = function () {
        ...
        class xs {
            constructor(t) {
                ...
                if (Object.defineProperty(this, "_source", {
                        ...
                        writable: !0,
                        enumerable: !1
                    }), Wn(t) || e) As(this, e ? xs.getDomRangeRects(t)[0] : t.getBoundingClientRect());
                else if (ar(t)) {
                    const {
                        innerWidth: e,
                        innerHeight: n
            ...
            excludeScrollbarsAndBorders() {
                const t = this._source;
                let e, n, i;
                if (ar(t)) e = t.innerWidth - t.document.documentElement.clientWidth, n = t.innerHeight - t.document.documentElement.clientHeight, i = t.getComputedStyle(t.document.documentElement).direction;
                else {
            ...
            static getDomRangeRects(t) {
                ...
                if (n.length)
                    for (const t of n) e.push(new xs(t));
                else {
                    let n = t.startContainer;
                    Do(n) && (n = n.parentNode);
                    const i = new xs(n.getBoundingClientRect());
        ...
        function Ps(t, e, n) {
            const i = e.clone().moveBy(0, n),
                ...
                r = new xs(t).excludeScrollbarsAndBorders();
            if (![o, i].every(t => r.contains(t))) {
                let {
                    scrollX: s,
                    scrollY: a
                } = t;
                Es(o, r) ? a -= r.top - e.top + n : Ss(i, r) && (a += e.bottom - r.bottom + n), Is(e, r) ? s -= r.left - e.left + n : Ns(e, r) && (s += e.right - r.right + n), t.scrollTo(s, a)
            }
        }
        ...
        function Ms(t, e) {
            const n = Os(t);
            let i, o;
            for (; t != n.document.body;) o = e(), (i = new xs(t).excludeScrollbarsAndBorders()).contains(o) || (Es(o, i) ? t.scrollTop -= i.top - o.top : Ss(o, i) && (t.scrollTop += o.bottom - i.bottom), Is(o, i) ? t.scrollLeft -= i.left - o.left : Ns(o, i) && (t.scrollLeft += o.right - i.right)), t = t.parentNode
        }
            ...
            if (n === e) return i; {
                ...
                for (; t != e;) {
                    const e = t.frameElement,
                        n = new xs(e).excludeScrollbarsAndBorders();
        ...
        class Fs {
            ...
            _insertNodes(t, e) {
                for (const t of e)
                    if (!(t instanceof Vs)) throw new Gn.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.", this);
        ...
        class Us extends Vs {
            constructor(t, e, n) {
                super(e), this.name = t, this._children = new Fs, n && this._insertChild(0, n)
            }
            get childCount() {
                return this._children.length
            }
            ...
            _clone(t = !1) {
                ...
                return new Us(this.name, this.getAttributes(), e)
            }
            _appendChild(t) {
            ...
            _insertChild(t, e) {
                const n = function (t) {
                    ...
                    pi(t) || (t = [t]);
                    return Array.from(t).map(t => "string" == typeof t ? new zs(t) : t instanceof Bs ? new zs(t.data, t.getAttributes()) : t)
                }(e);
            ...
            static fromJSON(t) {
                ...
                if (t.children) {
                    e = [];
                    for (const n of t.children) n.name ? e.push(Us.fromJSON(n)) : e.push(zs.fromJSON(n))
                }
                return new Us(t.name, t.attributes, e)
            }
        }
        class Hs {
            constructor(t = {}) {
            ...
            _next() {
                ...
                if (i instanceof Us) return this.shallow ? e.offset++ : (e.path.push(0), this._visitedParent = i), this.position = e, qs("elementStart", i, t, e, 1);
                if (i instanceof zs) {
                    let o;
                    ...
                    const r = e.offset - i.startOffset,
                        s = new Bs(i, r, o);
                    return e.offset += o, this.position = e, qs("text", s, t, e, o)
                }
                return e.path.pop(), e.offset++, this.position = e, this._visitedParent = n.parent, this.ignoreElementEnd ? this._next() : qs("elementEnd", n, t, e)
            }
            _previous() {
                const t = this.position,
                    e = this.position.clone(),
                ...
                if (i instanceof Us) return e.offset--, this.shallow ? (this.position = e, qs("elementStart", i, t, e, 1)) : (e.path.push(i.maxOffset), this.position = e, this._visitedParent = i, this.ignoreElementEnd ? this._previous() : qs("elementEnd", i, t, e));
                if (i instanceof zs) {
                    let o;
                    if (this.singleCharacters) o = 1;
                    else {
                ...
                return e.path.pop(), this.position = e, this._visitedParent = n.parent, qs("elementStart", n, t, e, 1)
            }
        }
        ...
        class Ys {
            constructor(t, e, n = "toNone") {
                ...
                if (!(e instanceof Array) || 0 === e.length) throw new Gn.b("model-position-path-incorrect-format: Position path must be an array with at least one item.", t, {
                    path: e
                });
            ...
            get parent() {
                ...
                for (let e = 0; e < this.path.length - 1; e++)
                    if (!(t = t.getChild(t.offsetToIndex(this.path[e])))) throw new Gn.b("model-position-path-incorrect: The position's path is incorrect.", this, {
                        position: this
                    });
                if (t.is("text")) throw new Gn.b("model-position-path-incorrect: The position's path is incorrect.", this, {
                    position: this
                });
                return t
            }
            ...
            _getTransformedByMergeOperation(t) {
                const e = t.movedRange;
                let n;
                return e.containsPosition(this) || e.start.isEqual(this) ? (n = this._getCombined(t.sourcePosition, t.targetPosition), t.sourcePosition.isBefore(t.targetPosition) && (n = n._getTransformedByDeletion(t.deletionPosition, 1))) : n = this.isEqual(t.deletionPosition) ? Ys._createAt(t.deletionPosition) : this._getTransformedByMove(t.deletionPosition, t.graveyardPosition, 1), n
            }
        ...
        class $s {
            constructor(t, e = null) {
                this.start = Ys._createAt(t), this.end = e ? Ys._createAt(e) : Ys._createAt(t), this.start.stickiness = this.isCollapsed ? "toNone" : "toNext", this.end.stickiness = this.isCollapsed ? "toNone" : "toPrevious"
            }*[Symbol.iterator]() {
                yield* new Hs({
                    boundaries: this,
                    ignoreElementEnd: !0
            ...
            getDifference(t) {
                const e = [];
                return this.isIntersecting(t) ? (this.containsPosition(t.start) && e.push(new $s(this.start, t.start)), this.containsPosition(t.end) && e.push(new $s(t.end, this.end))) : e.push(new $s(this.start, this.end)), e
            }
            getIntersection(t) {
                if (this.isIntersecting(t)) {
                    let e = this.start,
                        n = this.end;
                    return this.containsPosition(t.start) && (e = t.start), this.containsPosition(t.end) && (n = t.end), new $s(e, n)
                }
                return null
            }
            getMinimalFlatRanges() {
                ...
                for (; n.path.length > e + 1;) {
                    ...
                    0 !== e && t.push(new $s(n, n.getShiftedBy(e))), n.path = n.path.slice(0, -1), n.offset++, i = i.parent
                }
                for (; n.path.length <= this.end.path.length;) {
                    const e = this.end.path[n.path.length - 1],
                        i = e - n.offset;
                    0 !== i && t.push(new $s(n, n.getShiftedBy(i))), n.offset = e, n.path.push(0)
                }
                return t
            }
            getWalker(t = {}) {
                return t.boundaries = this, new Hs(t)
            }* getItems(t = {}) {
                t.boundaries = this, t.ignoreElementEnd = !0;
                const e = new Hs(t);
                for (const t of e) yield t.item
            ...
            getTransformedByOperations(t) {
                const e = [new $s(this.start, this.end)];
                for (const n of t)
            ...
            _getTransformedBySplitOperation(t) {
                ...
                return this.end.isEqual(t.insertionPosition) && (n = this.end.getShiftedBy(1)), e.root != n.root && (n = this.end.getShiftedBy(-1)), new $s(e, n)
            }
            _getTransformedByMergeOperation(t) {
                if (this.start.isEqual(t.targetPosition) && this.end.isEqual(t.deletionPosition)) return new $s(this.start);
                let e = this.start._getTransformedByMergeOperation(t),
                    n = this.end._getTransformedByMergeOperation(t);
                return e.root != n.root && (n = this.end.getShiftedBy(-1)), e.isAfter(n) ? (t.sourcePosition.isBefore(t.targetPosition) ? (e = Ys._createAt(n)).offset = 0 : (t.deletionPosition.isEqual(e) || (n = t.deletionPosition), e = t.targetPosition), new $s(e, n)) : new $s(e, n)
            }
            _getTransformedByInsertion(t, e, n = !1) {
                if (n && this.containsPosition(t)) return [new $s(this.start, t), new $s(t.getShiftedBy(e), this.end._getTransformedByInsertion(t, e))]; {
                    const n = new $s(this.start, this.end);
            ...
            _getTransformedByMove(t, e, n, i = !1) {
                ...
                const o = $s._createFromPositionAndShift(t, n),
                ...
                if (1 == a.length ? c = new $s(a[0].start._getTransformedByDeletion(t, n), a[0].end._getTransformedByDeletion(t, n)) : 2 == a.length && (c = new $s(this.start, this.end._getTransformedByDeletion(t, n))), s = c ? c._getTransformedByInsertion(r, n, null !== l || i) : [], l) {
                    const t = new $s(l.start._getCombined(o.start, r), l.end._getCombined(o.start, r));
            ...
            _getTransformedByDeletion(t, e) {
                ...
                return null == n && null == i ? null : (null == n && (n = t), null == i && (i = t), new $s(n, i))
            }
            static _createFromPositionAndShift(t, e) {
                const n = t,
                    i = t.getShiftedBy(e);
            ...
            static _createFromRanges(t) {
                ...
                if (n > 0)
                    for (let e = n - 1; t[e].end.isEqual(i.start); e++) i.start = Ys._createAt(t[e].start);
                for (let e = n + 1; e < t.length && t[e].start.isEqual(i.end); e++) i.end = Ys._createAt(t[e].end);
                return i
            }
            static fromJSON(t, e) {
        ...
        class Gs {
            constructor() {
                this._modelToViewMapping = new WeakMap, this._viewToModelMapping = new WeakMap, this._viewToModelLengthCallbacks = new Map, this._markerNameToElements = new Map, this._elementToMarkerNames = new Map, this._unboundMarkerNames = new Set, this.on("modelToViewPosition", (t, e) => {
                    ...
                    e.modelPosition = Ys._createAt(i, o)
                }, {
                    priority: "low"
                })
            }
            ...
            toModelRange(t) {
                return new $s(this.toModelPosition(t.start), this.toModelPosition(t.end))
            }
            toViewRange(t) {
        ...
        class Js {
            ...
            convertChanges(t, e, n) {
                ...
                for (const e of t.getChanges()) "insert" == e.type ? this.convertInsert($s._createFromPositionAndShift(e.position, e.length), n) : "remove" == e.type ? this.convertRemove(e.position, e.length, e.name, n) : this.convertAttribute(e.range, e.attributeKey, e.attributeOldValue, e.attributeNewValue, n);
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item,
                        n = {
                            item: t,
                            range: $s._createFromPositionAndShift(e.previousPosition, e.length)
                        };
            ...
            convertAttribute(t, e, n, i, o) {
                ...
                for (const o of t) {
                    const t = {
                        item: o.item,
                        range: $s._createFromPositionAndShift(o.previousPosition, o.length),
                        attributeKey: e,
                        attributeOldValue: n,
                        attributeNewValue: i
                    };
        ...
        class Xs {
            ...
            isEqual(t) {
                ...
                for (const t of this._ranges) yield new $s(t.start, t.end)
            }
            getFirstRange() {
                let t = null;
                for (const e of this._ranges) t && !e.start.isBefore(t.start) || (t = e);
                return t ? new $s(t.start, t.end) : null
            }
            getLastRange() {
                let t = null;
                for (const e of this._ranges) t && !e.end.isAfter(t.end) || (t = e);
            ...
            setTo(t, e, n) {
                ...
                else if (t instanceof Xs) this._setRanges(t.getRanges(), t.isBackward);
                else if (t && "function" == typeof t.getRanges) this._setRanges(t.getRanges(), t.isBackward);
                else if (t instanceof $s) this._setRanges([t], !!e && !!e.backward);
                else if (t instanceof Ys) this._setRanges([new $s(t)]);
                else if (t instanceof Vs) {
                    const i = !!n && !!n.backward;
                    let o;
                    if ("in" == e) o = $s._createIn(t);
                    else if ("on" == e) o = $s._createOn(t);
                    else {
            ...
            _setRanges(t, e = !1) {
                const n = (t = Array.from(t)).some(e => {
                    if (!(e instanceof $s)) throw new Gn.b("model-selection-set-ranges-not-range: Selection range set to an object that is not an instance of model.Range.", [this, t]);
            ...
            setFocus(t, e) {
                ...
                if ("same" == n.compareWith(this.focus)) return;
                const i = this.anchor;
                this._ranges.length && this._popRange(), "before" == n.compareWith(i) ? (this._pushRange(new $s(n, i)), this._lastRangeBackward = !0) : (this._pushRange(new $s(i, n)), this._lastRangeBackward = !1), this.fire("change:range", {
                    directChange: !0
                })
            }
            getAttribute(t) {
            ...
            getSelectedElement() {
                ...
                const t = this.getFirstRange(),
                    e = t.start.nodeAfter,
                    n = t.end.nodeBefore;
                return e instanceof Us && e == n ? e : null
            }
            is(t) {
                ...
                for (const e of this.getRanges()) {
                    ...
                    for (const n of e.getWalker()) {
                        const i = n.item;
                        "elementEnd" == n.type && ea(i, t, e) && (yield i)
                    }
                    const i = na(e.end, t);
                    i && !e.end.isTouching(Ys._createAt(i, 0)) && ia(i, e) && (yield i)
                }
            }
            ...
            _pushRange(t) {
                this._checkRange(t), this._ranges.push(new $s(t.start, t.end))
            }
            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++)
                    if (t.isIntersecting(this._ranges[e])) throw new Gn.b("model-selection-range-intersects: Trying to add a range that intersects with another range in the selection.", [this, t], {
                        addedRange: t,
        ...
        function na(t, e) {
            ...
            let o = !1;
            const r = i.find(t => !o && (!(o = n.isLimit(t)) && ta(t, e)));
        ...
        function ia(t, e) {
            ...
            return !n || !e.containsRange($s._createOn(n), !0)
        }
        ci(Xs, ei);
        class oa extends $s {
            constructor(t, e) {
        ...
        class aa extends Xs {
            constructor(t) {
                super(), this.markers = new oo({
                    idProperty: "name"
                }), this._model = t.model, this._document = t, this._attributePriority = new Map, this._fixGraveyardRangesData = [], this._hasChangedRange = !1, this._overriddenGravityRegister = new Set, this.listenTo(this._model, "applyOperation", (t, e) => {
                    const n = e[0];
                    ...
                    for (const t of this.getRanges())
                        if (!this._document._validateSelectionRange(t)) throw new Gn.b("document-selection-wrong-position: Range from document selection starts or ends at incorrect position.", this, {
                            range: t
                        })
            ...
            _updateAttributes(t) {
                const e = js(this._getSurroundingAttributes()),
                    n = js(this.getAttributes());
        ...
        function ca(t) {
            return t instanceof Bs || t instanceof zs ? t.getAttributes() : null
        }
        class la {
            constructor(t) {
                this._dispatchers = t
        ...
        class fa extends la {
            ...
            attributeToElement(t) {
                return this.add(function (t) {
                    ...
                    if (t.model.values)
                        for (const e of t.model.values) t.view[e] = ma(t.view[e], "attribute");
                    else t.view = ma(t.view, "attribute");
                    const n = pa(t);
                    return i => {
                        i.on(e, function (t) {
                            return (e, n, i) => {
                                ...
                                if (n.item instanceof Xs || n.item instanceof sa) s.wrap(a.getFirstRange(), r);
                                else {
                ...
                return this.add(function (t) {
                    return e => {
                        e.on("addMarker:" + t.model, function (t) {
                            return (e, n, i) => {
                                if (!n.item) return;
                                if (!(n.item instanceof Xs || n.item instanceof sa || n.item.is("textProxy"))) return;
                                const o = wa(t, n, i);
                                if (!o) return;
                                if (!i.consumable.consume(n.item, e.name)) return;
                                const r = ga(o),
                                    s = i.writer,
                                    a = s.document.selection;
                                if (n.item instanceof Xs || n.item instanceof sa) s.wrap(a.getFirstRange(), r, a);
                                else {
                            ...
                            return (e, n, i) => {
                                if (!n.item) return;
                                if (!(n.item instanceof Us)) return;
                                const o = wa(t, n, i);
                                if (!o) return;
                                ...
                                if (r && r.getCustomProperty("addHighlight")) {
                                    ...
                                    for (const t of $s._createIn(n.item)) i.consumable.consume(t.item, e.name);
        ...
        function _a(t) {
            const e = function (t) {
                    ...
                    return (n, i, o) => {
                        ...
                        i.modelRange = new $s(o.writer.createPositionBefore(s), o.writer.createPositionAfter(c[c.length - 1])), a.cursorParent ? i.modelCursor = o.writer.createPositionAt(a.cursorParent, 0) : i.modelCursor = i.modelRange.end
                    }
                }(t = ua(t)),
                n = va(t.view),
                i = n ? "element:" + n : "element";
        ...
        function xa(t, e) {
            ...
            return (i, o, r) => {
                ...
                null !== c && (! function (t, e) {
                    ...
                    if ("object" == typeof n && !va(n)) return !1;
        ...
        class Aa {
            constructor(t) {
                this.model = t, this.view = new Ls, this.mapper = new Gs, this.downcastDispatcher = new Js({
                    mapper: this.mapper
                });
        ...
        class Ta {
            ...
            get(t) {
                ...
                if (!e) {
                    ...
                    let n = t;
                    throw "function" == typeof t && (n = t.pluginName || t.name), new Gn.b(e, this._editor, {
                        plugin: n
                    })
                }
                return e
            ...
            init(t, e = []) {
                ...
                if (c) {
                    ...
                    return console.error(Object(Gn.a)(t), {
                        plugins: c
                    }), Promise.reject(new Gn.b(t, this._editor, {
                        plugins: c
                    }))
                }
                ...
                function l(t) {
                    if (!a.includes(t) && !n._plugins.has(t) && !o.has(t)) return function (t) {
                        ...
                        throw console.error(Object(Gn.a)("plugincollection-load: It was not possible to load the plugin."), {
                            plugin: t
                        }), e
                    })
                }
        ...
        class Oa {
            ...
            checkMerge(t, e = null) {
                if (t instanceof Ys) {
                    const e = t.nodeBefore,
                        n = t.nodeAfter;
                    if (!(e instanceof Us)) throw new Gn.b("schema-check-merge-no-element-before: The node before the merge position must be an element.", this);
                    if (!(n instanceof Us)) throw new Gn.b("schema-check-merge-no-element-after: The node after the merge position must be an element.", this);
            ...
            getLimitElement(t) {
                ...
                if (t instanceof Ys) e = t.parent;
                    ...
                    e = (t instanceof $s ? [t] : Array.from(t.getRanges())).reduce((t, e) => {
            ...
            getNearestSelectionRange(t, e = "both") {
                if (this.checkChild(t, "$text")) return new $s(t);
                let n, i;
                "both" != e && "backward" != e || (n = new Hs({
                    startPosition: t,
                    direction: "backward"
                })), "both" != e && "forward" != e || (i = new Hs({
                    startPosition: t
                }));
                for (const t of function* (t, e) {
                    ...
                    const e = t.walker == n ? "elementEnd" : "elementStart",
                        i = t.value;
                    if (i.type == e && this.isObject(i.item)) return $s._createOn(i.item);
                    if (this.checkChild(i.nextPosition, "$text")) return new $s(i.nextPosition)
                }
                return null
            }
            ...
            removeDisallowedAttributes(t, e) {
                for (const n of t)
                    if (n.is("text")) Wa(this, n, e);
                        ...
                        const t = $s._createIn(n).getPositions();
                        for (const n of t) {
            ...
            _checkContextMatch(t, e, n = e.length - 1) {
                ...
                for (const o of t.getItems({
                        shallow: !0
                    })) o.is("element") && (yield* this._getValidRangesForRange($s._createIn(o), e)), this.checkAttribute(o, e) || (n.isEqual(i) || (yield new $s(n, i)), n = Ys._createAfter(o)), i = Ys._createAfter(o);
                n.isEqual(i) || (yield new $s(n, i))
            }
        }
        ci(Oa, Fi);
        class Ra {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({
                    includeSelf: !0
                })), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(qa)
            }
            get length() {
                return this._items.length
            }
        ...
        function Da(t, e) {
            ...
            return function (t, e) {
                ...
                }(t, n), Ua(t, n, "allowIn"), Ua(t, n, "allowContentOf"), Ua(t, n, "allowWhere"), Ua(t, n, "allowAttributes"), Ua(t, n, "allowAttributesOf"), Ua(t, n, "inheritTypesFrom"),
                function (t, e) {
                    for (const n of t) {
        ...
        class Ya {
            ...
            convert(t, e, n = ["$root"]) {
                this.fire("viewCleanup", t), this._modelCursor = function (t, e) {
                    ...
                    for (const i of new Ra(t)) {
                        ...
                        n && e.append(o, n), n = Ys._createAt(o, 0)
                    }
                    return n
            ...
            _convertItem(t, e) {
                ...
                if (t.is("element") ? this.fire("element:" + t.name, n, this.conversionApi) : t.is("text") ? this.fire("text", n, this.conversionApi) : this.fire("documentFragment", n, this.conversionApi), n.modelRange && !(n.modelRange instanceof $s)) throw new Gn.b("view-conversion-dispatcher-incorrect-result: Incorrect conversion result was dropped.", this);
                return {
            ...
            _convertChildren(t, e) {
                ...
                for (const e of Array.from(t.getChildren())) {
                    ...
                    t.modelRange instanceof $s && (n.end = t.modelRange.end, i = t.modelCursor)
                }
                return {
                    modelRange: n,
                    modelCursor: i
        ...
        class $a {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new Gs, this.downcastDispatcher = new Js({
                    mapper: this.mapper
                    ...
                    if (n.schema.checkChild(e.modelCursor, "$text") && n.consumable.consume(e.viewItem)) {
                        ...
                        n.writer.insert(t, e.modelCursor), e.modelRange = $s._createFromPositionAndShift(e.modelCursor, t.offsetSize), e.modelCursor = e.modelRange.end
                    }
                }, {
                    priority: "lowest"
        ...
        class Ga {
            ...
            elementToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Qa(t)) this.for("upcast").elementToElement({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Qa(t)) this.for("upcast").elementToAttribute({
                    view: n,
                    model: e,
                    converterPriority: t.converterPriority
                })
            ...
            attributeToAttribute(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Qa(t)) this.for("upcast").attributeToAttribute({
                    view: n,
                    model: e
                })
            }
        ...
        class Xa {
            ...
            static fromJSON(t) {
                const e = [];
                for (const n of t) n.name ? e.push(Us.fromJSON(n)) : e.push(zs.fromJSON(n));
                return new Xa(e)
            }
            _appendChild(t) {
                this._insertChild(this.childCount, t)
        ...
        function tc(t, e) {
            const n = (e = ic(e)).reduce((t, e) => t + e.offsetSize, 0),
                i = t.parent;
            rc(t);
            const o = t.index;
            return i._insertChild(o, e), oc(i, o + e.length), oc(i, o), new $s(t, t.getShiftedBy(n))
        }
        ...
        function nc(t, e) {
            ...
            const n = ec(t);
            return tc(e = e._getTransformedByDeletion(t.start, t.end.offset - t.start.offset), n)
        }
        ...
        function ic(t) {
            ...
            for (let n = 0; n < t.length; n++)
                ...
                else if (t[n] instanceof Bs) e.push(new zs(t[n].data, t[n].getAttributes()));
            else if (t[n] instanceof Xa || t[n] instanceof Fs)
                for (const i of t[n]) e.push(i);
            else t[n] instanceof Vs && e.push(t[n]);
            for (let t = 1; t < e.length; t++) {
                const n = e[t],
                    i = e[t - 1];
                n instanceof zs && i instanceof zs && sc(n, i) && (e.splice(t - 1, 2, new zs(i.data + n.data, i.getAttributes())), t--)
            }
            return e
        }
        ...
        function oc(t, e) {
            const n = t.getChild(e - 1),
                i = t.getChild(e);
            if (n && i && n.is("text") && i.is("text") && sc(n, i)) {
        ...
        class cc extends Za {
            ...
            _validate() {
                ...
                for (const t of this.range.getItems({
                    ...
                    if (null !== this.oldValue && !ac(t.getAttribute(this.key), this.oldValue)) throw new Gn.b("attribute-operation-wrong-old-value: Changed node has different attribute value than operation's old attribute value.", this, {
                        item: t,
                        key: this.key,
                        value: this.oldValue
                    });
            ...
            _execute() {
                ac(this.oldValue, this.newValue) || function (t, e, n) {
                    rc(t.start), rc(t.end);
            ...
            static fromJSON(t, e) {
                return new cc($s.fromJSON(t.range, e), t.key, t.oldValue, t.newValue, t.baseVersion)
            }
        }
        class lc extends Za {
            constructor(t, e) {
            ...
            _execute() {
                ec($s._createFromPositionAndShift(this.sourcePosition, this.howMany))
            }
            static get className() {
        ...
        class dc extends Za {
            ...
            _execute() {
                nc($s._createFromPositionAndShift(this.sourcePosition, this.howMany), this.targetPosition)
            }
            toJSON() {
                const t = super.toJSON();
            ...
            static fromJSON(t, e) {
                const n = Ys.fromJSON(t.sourcePosition, e),
                    i = Ys.fromJSON(t.targetPosition, e);
                return new this(n, t.howMany, i, t.baseVersion)
            }
        }
        class hc extends Za {
            constructor(t, e, n) {
                super(n), this.position = t.clone(), this.position.stickiness = "toNone", this.nodes = new Fs(ic(e)), this.shouldReceiveAttributes = !1
            }
            get type() {
                return "insert"
            }
            ...
            static fromJSON(t, e) {
                const n = [];
                for (const e of t.nodes) e.name ? n.push(Us.fromJSON(e)) : n.push(zs.fromJSON(e));
                const i = new hc(Ys.fromJSON(t.position, e), n, t.baseVersion);
        ...
        class uc extends Za {
            ...
            static fromJSON(t, e) {
                return new uc(t.name, t.oldRange ? $s.fromJSON(t.oldRange, e) : null, t.newRange ? $s.fromJSON(t.newRange, e) : null, e.model.markers, t.affectsData, t.baseVersion)
            }
        }
        class fc extends Za {
            constructor(t, e, n, i) {
            ...
            _validate() {
                ...
                if (!(t instanceof Us)) throw new Gn.b("rename-operation-wrong-position: Given position is invalid or node after it is not an instance of Element.", this);
            ...
            static fromJSON(t, e) {
                return new fc(Ys.fromJSON(t.position, e), t.oldName, t.newName, t.baseVersion)
            }
        }
        class gc extends Za {
            constructor(t, e, n, i, o) {
        ...
        class mc extends Za {
            ...
            get movedRange() {
                ...
                return new $s(this.sourcePosition, t)
            }
            clone() {
            ...
            getReversed() {
                const t = this.targetPosition._getTransformedByMergeOperation(this),
                    ...
                    i = new pc(t, this.howMany, this.graveyardPosition, this.baseVersion + 1);
            ...
            _execute() {
                const t = this.sourcePosition.parent;
                nc($s._createIn(t), this.targetPosition), nc($s._createOn(t), this.graveyardPosition)
            }
            toJSON() {
                const t = super.toJSON();
            ...
            static fromJSON(t, e) {
                const n = Ys.fromJSON(t.sourcePosition, e),
                    i = Ys.fromJSON(t.targetPosition, e),
                    o = Ys.fromJSON(t.graveyardPosition, e);
                return new this(n, t.howMany, i, o, t.baseVersion)
            }
        }
        class pc extends Za {
            constructor(t, e, n, i) {
                super(i), this.splitPosition = t.clone(), this.splitPosition.stickiness = "toNext", this.howMany = e, this.insertionPosition = pc.getInsertionPosition(t), this.insertionPosition.stickiness = "toNone", this.graveyardPosition = n ? n.clone() : null, this.graveyardPosition && (this.graveyardPosition.stickiness = "toNext")
            }
            get type() {
                return "split"
            }
            ...
            get movedRange() {
                ...
                return new $s(this.splitPosition, t)
            }
            clone() {
            ...
            _execute() {
                const t = this.splitPosition.parent;
                if (this.graveyardPosition) nc($s._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
                else {
                    const e = t._clone();
                    tc(this.insertionPosition, e)
                }
                nc(new $s(Ys._createAt(t, this.splitPosition.offset), Ys._createAt(t, t.maxOffset)), this.moveTargetPosition)
            }
            toJSON() {
                const t = super.toJSON();
            ...
            static fromJSON(t, e) {
                const n = Ys.fromJSON(t.splitPosition, e),
                    i = Ys.fromJSON(t.insertionPosition, e),
                    o = t.graveyardPosition ? Ys.fromJSON(t.graveyardPosition, e) : null,
        ...
        class wc {
            ...
            insert(t, e, n = 0) {
                ...
                const i = Ys._createAt(e, n);
                if (t.parent) {
                    if (xc(t.root, i.root)) return void this.move($s._createOn(t), i);
                ...
                const o = i.root.document ? i.root.document.version : null,
                    r = new hc(i, t, o);
                if (t instanceof zs && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Xa)
                    for (const [e, n] of t.markers) {
                        const t = Ys._createAt(n.root, 0),
                            o = {
                                range: new $s(n.start._getCombined(t, i), n.end._getCombined(t, i)),
                                usingOperation: !0,
                                affectsData: !0
                            };
            ...
            insertText(t, e, n, i) {
                e instanceof Xa || e instanceof Us || e instanceof Ys ? this.insert(this.createText(t), e, n) : this.insert(this.createText(t, e), n, i)
            }
            insertElement(t, e, n, i) {
                e instanceof Xa || e instanceof Us || e instanceof Ys ? this.insert(this.createElement(t), e, n) : this.insert(this.createElement(t, e), n, i)
            }
            append(t, e) {
                this.insert(t, e, "end")
            }
            appendText(t, e, n) {
                e instanceof Xa || e instanceof Us ? this.insert(this.createText(t), e, "end") : this.insert(this.createText(t, e), n, "end")
            }
            appendElement(t, e, n) {
                e instanceof Xa || e instanceof Us ? this.insert(this.createElement(t), e, "end") : this.insert(this.createElement(t, e), n, "end")
            }
            setAttribute(t, e, n) {
                if (this._assertWriterUsedCorrectly(), n instanceof $s) {
                    const i = n.getMinimalFlatRanges();
                    for (const n of i) kc(this, t, e, n)
                } else _c(this, t, e, n)
            }
            setAttributes(t, e) {
                for (const [n, i] of js(t)) this.setAttribute(n, i, e)
            }
            removeAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), e instanceof $s) {
                    const n = e.getMinimalFlatRanges();
                    for (const e of n) kc(this, t, null, e)
            ...
            move(t, e, n) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof $s)) throw new Gn.b("writer-move-invalid-range: Invalid range to move.", this);
                if (!t.isFlat) throw new Gn.b("writer-move-range-not-flat: Range to move is not flat.", this);
                const i = Ys._createAt(e, n);
                if (i.isEqual(t.start)) return;
                if (this._addOperationForAffectedMarkers("move", t), !xc(t.root, i.root)) throw new Gn.b("writer-move-different-document: Range is going to be moved between different documents.", this);
                const o = t.root.document ? t.root.document.version : null,
                    r = new dc(t.start, t.end.offset - t.start.offset, i, o);
                this.batch.addOperation(r), this.model.applyOperation(r)
            }
            remove(t) {
                this._assertWriterUsedCorrectly();
                const e = (t instanceof $s ? t : $s._createOn(t)).getMinimalFlatRanges().reverse();
            ...
            merge(t) {
                ...
                const e = t.nodeBefore,
                    n = t.nodeAfter;
                if (this._addOperationForAffectedMarkers("merge", t), !(e instanceof Us)) throw new Gn.b("writer-merge-no-element-before: Node before merge position must be an element.", this);
                if (!(n instanceof Us)) throw new Gn.b("writer-merge-no-element-after: Node after merge position must be an element.", this);
            ...
            _mergeDetached(t) {
                const e = t.nodeBefore,
                    n = t.nodeAfter;
                this.move($s._createIn(n), Ys._createAt(e, "end")), this.remove(n)
            }
            _merge(t) {
            ...
            rename(t, e) {
                if (this._assertWriterUsedCorrectly(), !(t instanceof Us)) throw new Gn.b("writer-rename-not-element-instance: Trying to rename an object which is not an instance of Element.", this);
                const n = t.root.document ? t.root.document.version : null,
                    i = new fc(Ys._createBefore(t), t.name, e, n);
            ...
            wrap(t, e) {
                ...
                const i = new $s(t.start.getShiftedBy(1), t.end.getShiftedBy(1));
                this.move(i, Ys._createAt(n, 0))
            }
            unwrap(t) {
                ...
                this.move($s._createIn(t), this.createPositionAfter(t)), this.remove(t)
            }
            addMarker(t, e) {
                ...
                return n ? (vc(this, t, null, i, o), this.model.markers.get(t)) : this.model.markers._set(t, i, n, o)
            }
            updateMarker(t, e) {
                this._assertWriterUsedCorrectly();
                ...
                const a = i.getRange(),
                    c = e.range ? e.range : a;
                o && e.usingOperation !== i.managedUsingOperations ? e.usingOperation ? vc(this, n, null, c, s) : (vc(this, n, a, null, s), this.model.markers._set(n, c, void 0, s)) : i.managedUsingOperations ? vc(this, n, a, c, s) : this.model.markers._set(n, c, void 0, s)
            }
            removeMarker(t) {
                this._assertWriterUsedCorrectly();
                ...
                n.managedUsingOperations ? vc(this, e, n.getRange(), null, n.affectsData) : this.model.markers._remove(e)
            }
            setSelection(t, e, n) {
            ...
            setSelectionAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), "string" == typeof t) this._setSelectionAttribute(t, e);
                    ...
                    for (const [e, n] of js(t)) this._setSelectionAttribute(e, n)
            }
        ...
        function _c(t, e, n, i) {
            ...
            if (s != n) {
                if (i.root === i) {
                    ...
                    const o = (a = new $s(Ys._createBefore(i), t.createPositionAfter(i))).root.document ? r.version : null;
                    c = new cc(a, e, s, n, o)
                }
        ...
        function vc(t, e, n, i, o) {
            const r = t.model,
                s = r.document,
                a = new uc(e, n, i, r.markers, o, s.version);
        ...
        class Ac {
            ...
            bufferOperation(t) {
                switch (t.type) {
                    ...
                    case "rename": {
                        ...
                        const e = $s._createFromPositionAndShift(t.position, 1);
                        for (const t of this._markerCollection.getMarkersIntersectingRange(e)) {
                            const e = t.getRange();
                            this.bufferMarkerChange(t.name, e, e, t.affectsData)
                        }
                ...
                for (const t of this._changesInElement.keys()) {
                    ...
                    for (const n of r)
                        ...
                        const n = o[s].attributes,
                            r = i[a].attributes;
                        let c;
                        if ("$text" == o[s].name) c = new $s(Ys._createAt(t, s), Ys._createAt(t, s + 1));
                        else {
                            const e = t.offsetToIndex(s);
                            c = new $s(Ys._createAt(t, s), Ys._createAt(t.getChild(e), 0))
                        }
            ...
            _removeAllNestedChanges(t, e, n) {
                const i = new $s(Ys._createAt(t, e), Ys._createAt(t, e + n));
        ...
        class Nc {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Mc(this), this.selection = new sa(this), this.roots = new oo({
                    idProperty: "rootName"
                }), this.differ = new Ac(t.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", Ic), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
                    if (n.isDocumentOperation && n.baseVersion !== this.version) throw new Gn.b("model-document-applyOperation-wrong-version: Only operations with matching versions can be applied.", this, {
                        operation: n
                    })
                }, {
                    priority: "highest"
            ...
            _callPostFixers(t) {
                ...
                do {
                    for (const n of this._postFixers)
                        if (this.selection.refresh(), e = n(t)) break
                } while (e)
            }
        }
        ...
        class Rc {
            ...
            _set(t, e, n = !1, i = !1) {
                const o = t instanceof Dc ? t.name : t,
            ...
            _remove(t) {
                const e = t instanceof Dc ? t.name : t,
        ...
        class jc {
            ...
            getSelectionRange() {
                return this.nodeToSelect ? $s._createOn(this.nodeToSelect) : this.model.schema.getNearestSelectionRange(this.position)
            }
            getAffectedRange() {
                return this._affectedStart ? new $s(this._affectedStart, this._affectedEnd) : null
            }
            destroy() {
            ...
            _canMergeLeft(t, e) {
                const n = t.previousSibling;
                return e.isFirst && n instanceof Us && this.canMergeWith.has(n) && this.model.schema.checkMerge(n, t)
            }
            _canMergeRight(t, e) {
                const n = t.nextSibling;
                return e.isLast && n instanceof Us && this.canMergeWith.has(n) && this.model.schema.checkMerge(t, n)
            }
        ...
        function Vc(t, e, n = {}) {
            ...
            t.change(t => {
                ...
                function (t, e) {
                    ...
                    t.remove(t.createRangeIn(n)), zc(t, t.createPositionAt(n, 0), e)
                }(t, e);
                const r = i.start,
                    s = Lc.fromPosition(i.end, "toNext");
                if (i.start.isTouching(i.end) || t.remove(i), n.leaveUnmerged || (! function t(e, n, i) {
                    ...
                    n.doNotAutoparagraph && i ? Bc(t, e, i) : zc(t, r, e)
                }
                s.detach()
            })
        }
        ...
        function zc(t, e, n) {
            ...
            t.insert(i, e), Bc(t, n, t.createPositionAt(i, 0))
        }
            ...
            const i = t.schema,
                ...
                a = new Hs({
                    boundaries: function (t, e) {
                        const n = t.root,
                            i = Ys._createAt(n, e ? "end" : 0);
                        return e ? new $s(t, i) : new $s(i, t)
                    }(s, o),
                    singleCharacters: !0,
        ...
        function Hc(t, e) {
            if ("text" == e.type) return "word" === t.unit ? function (t, e) {
                ...
                if (n) {
                    ...
                    for (; Sc(i, o) || "character" == e && Ec(i, o);) t.next(), o = t.position.offset - n.startOffset
                }
                return t.position
        ...
        function Gc(t, e) {
            return t.isCollapsed ? function (t, e) {
                ...
                if (o.nodeAfter && e.isLimit(o.nodeAfter)) return new $s(o, Ys._createAfter(o.nodeAfter));
                return new $s(o)
            }(t, e) : function (t, e) {
                const n = t.start,
                    i = t.end,
                ...
                if (c || l) {
                    const t = n.nodeAfter && i.nodeBefore && n.nodeAfter.parent === i.nodeBefore.parent,
                        o = c && (!t || !Kc(n.nodeAfter, e)),
                        r = l && (!t || !Kc(i.nodeBefore, e));
                    let d = n,
                        h = i;
                    return o && (d = Ys._createBefore(Qc(s, e))), r && (h = Ys._createAfter(Qc(a, e))), new $s(d, h)
                }
                return null
            }(t, e)
        }
        ...
        class Jc {
            ...
            insertContent(t, e, n) {
                return function (t, e, n, i) {
                    return t.change(o => {
                        let r;
                        const s = (r = n ? n instanceof Xs || n instanceof sa ? n : o.createSelection(n, i) : t.document.selection).getFirstPosition();
                ...
                return function (t, e) {
                    return t.change(t => {
                        ...
                        if (a != i) {
                            ...
                            Yc(t.createRange(e.end, t.createPositionAt(n, "end")), t), Yc(o, t)
                        }
                        return n
                    })
                }(this, t)
            ...
            hasContent(t, e) {
                const n = t instanceof Us ? $s._createIn(t) : t;
            ...
            createRangeIn(t) {
                return $s._createIn(t)
            }
            createRangeOn(t) {
                return $s._createOn(t)
            }
            createSelection(t, e, n) {
                return new Xs(t, e, n)
            }
        ...
        class tl {
            constructor(t) {
                ...
                }), this.t = this.locale.t, this.set("state", "initializing"), this.once("ready", () => this.state = "ready", {
                    priority: "high"
                }), this.once("destroy", () => this.state = "destroyed", {
                    priority: "high"
                }), this.set("isReadOnly", !1), this.model = new Jc, this.data = new $a(this.model), this.editing = new Aa(this.model), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new Ga([this.editing.downcastDispatcher, this.data.downcastDispatcher], this.data.upcastDispatcher), this.conversion.addAlias("dataDowncast", this.data.downcastDispatcher), this.conversion.addAlias("editingDowncast", this.editing.downcastDispatcher), this.keystrokes = new Xc(this), this.keystrokes.listenTo(this.editing.view.document)
            }
            initPlugins() {
                const t = this.config,
                    e = t.get("plugins") || [],
        ...
        class nl {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new or({
        ...
        const rl = "http://www.w3.org/1999/xhtml";
        class sl {
            constructor(t) {
                Object.assign(this, ml(gl(t))), this._isRendered = !1, this._revertData = null
            }
            render() {
            ...
            revert(t) {
                ...
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) _l(n) ? yield n: vl(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            static extend(t, e) {
                ...
                ! function t(e, n) {
                    n.attributes && (e.attributes || (e.attributes = {}), wl(e.attributes, n.attributes));
                    n.eventListeners && (e.eventListeners || (e.eventListeners = {}), wl(e.eventListeners, n.eventListeners));
            ...
            _renderElement(t) {
                let e = t.node;
                return e || (e = t.node = document.createElementNS(this.ns || rl, this.tag)), this._renderAttributes(t), this._renderElementChildren(t), this._setUpListeners(t), e
            }
            _renderText(t) {
                let e = t.node;
                return e ? t.revertData.text = e.textContent : e = t.node = document.createTextNode(""), dl(this.text) ? this._bindToObservable({
                    schema: this.text,
                    updater: function (t) {
                        return {
                            set(e) {
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = B(n[0]) && n[0].ns ? n[0].ns : null, dl(n)) {
                        const a = o ? n[0].value : n;
                        s && xl(e) && a.unshift(i), this._bindToObservable({
                            schema: a,
                            updater: ul(r, e, o),
                            data: t
                        })
                    } else "style" == e && "string" != typeof n[0] ? this._renderStyleAttribute(n[0], t) : (s && i && xl(e) && n.unshift(i), kl(n = n.map(t => t && t.value || t).reduce((t, e) => t.concat(e), []).reduce(bl, "")) || r.setAttributeNS(o, e, n))
            }
            _renderStyleAttribute(t, e) {
                const n = e.node;
                for (const i in t) {
                    const o = t[i];
                    dl(o) ? this._bindToObservable({
                        schema: [o],
                        updater: fl(n, i),
                        data: e
                    }) : n.style[i] = o
            ...
            _renderElementChildren(t) {
                ...
                for (const r of this.children)
                    ...
                    } else if (_l(r)) i || (r.isRendered || r.render(), n.appendChild(r.element));
                else if (Ko(r)) n.appendChild(r);
                else if (i) {
                    const e = {
                        children: [],
                        bindings: [],
            ...
            _bindToObservable({
                ...
                hl(t, e, n);
                const o = t.filter(t => !kl(t)).filter(t => t.observable).map(i => i.activateAttributeListener(t, e, n));
                i && i.bindings.push(o)
            }
        ...
        class ll extends al {
            getValue(t) {
                return !kl(super.getValue(t)) && (this.valueIfTrue || !0)
            }
        }

        function dl(t) {
            return !!t && (t.value && (t = t.value), Array.isArray(t) ? t.some(dl) : t instanceof al)
        }
        ...
        function hl(t, e, {
            ...
            let i = function (t, e) {
                return t.map(t => t instanceof al ? t.getValue(e) : t)
            }(t, n);
            kl(i = 1 == t.length && t[0] instanceof ll ? i[0] : i.reduce(bl, "")) ? e.remove() : e.set(i)
        }
        ...
        function gl(t) {
            return qn(t, t => {
                if (t && (t instanceof al || vl(t) || _l(t) || yl(t))) return t
            })
        }
        ...
        function ml(t) {
            if ("string" == typeof t ? t = function (t) {
                ...
                const e = [];
                if (t.children)
                    if (yl(t.children)) e.push(t.children);
                    else
                        for (const n of t.children) vl(n) || _l(n) || Ko(n) ? e.push(n) : e.push(new sl(n));
                t.children = e
            }
            return t
        }
        ...
        class Al {
            ...
            get bindTemplate() {
                return this._bindTemplate ? this._bindTemplate : this._bindTemplate = sl.bind(this, this)
            }
            createCollection() {
                const t = new ol;
            ...
            setTemplate(t) {
                this.template = new sl(t)
            }
            extendTemplate(t) {
                sl.extend(this.template, t)
            }
            render() {
        ...
        function Tl({
            ...
            let c, l;
            if (i || o) {
                const t = i && new xs(i).getVisible(),
                    e = o && new xs(tr.window);
        ...
        class Il extends Al {
            ...
            _startPinning(t) {
                this.attachTo(t);
                const e = Nl(t.target),
                    n = t.limiter ? Nl(t.limiter) : El;
                this.listenTo(tr.document, "scroll", (i, o) => {
                    const r = o.target,
                        s = e && r.contains(e),
                        a = n && r.contains(n);
        ...
        function Nl(t) {
            return Wn(t) ? t : _s(t) ? t.commonAncestorContainer : "function" == typeof t ? Nl(t()) : null
        }

        function Ol(t, e) {
            return t.top - e.height - Il.arrowVerticalOffset
        }

        function Rl(t) {
            return t.bottom + Il.arrowVerticalOffset
        }
        Il.arrowHorizontalOffset = 25, Il.arrowVerticalOffset = 10, Il._getOptimalPosition = Tl, Il.defaultPositions = {
            northArrowSouth: (t, e) => ({
                top: Ol(t, e),
            ...
            northArrowSouthEast: (t, e) => ({
                top: Ol(t, e),
                left: t.left + t.width / 2 - e.width + Il.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northArrowSouthWest: (t, e) => ({
                top: Ol(t, e),
                left: t.left + t.width / 2 - Il.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            ...
            northWestArrowSouthWest: (t, e) => ({
                top: Ol(t, e),
                left: t.left - Il.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            northWestArrowSouthEast: (t, e) => ({
                top: Ol(t, e),
                left: t.left - e.width + Il.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            ...
            northEastArrowSouthEast: (t, e) => ({
                top: Ol(t, e),
                left: t.right - e.width + Il.arrowHorizontalOffset,
                name: "arrow_se"
            }),
            northEastArrowSouthWest: (t, e) => ({
                top: Ol(t, e),
                left: t.right - Il.arrowHorizontalOffset,
                name: "arrow_sw"
            }),
            southArrowNorth: (t, e) => ({
                top: Rl(t),
        ...
        ci(Vl, cr), ci(Vl, Fi);
        var zl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.463 5.187a.888.888 0 1 1 1.254 1.255L9.16 10l3.557 3.557a.888.888 0 1 1-1.254 1.255L7.26 10.61a.888.888 0 0 1 .16-1.382l4.043-4.042z" /></svg>\n',
            Bl = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8.537 14.813a.888.888 0 1 1-1.254-1.255L10.84 10 7.283 6.442a.888.888 0 1 1 1.254-1.255L12.74 9.39a.888.888 0 0 1-.16 1.382l-4.043 4.042z"/></svg>\n';
        n(24), n(26);
        const Fl = Ml("px");
        class Ul extends il {
            ...
            constructor(t) {
                ...
                }), this.set("visibleView", null), this.view = new Il(t.locale), t.ui.view.body.add(this.view), t.ui.focusTracker.add(this.view.element), this._viewToStack = new Map, this._idToStack = new Map, this.set("_numberOfStacks", 0), this.set("_singleViewMode", !1), this._rotatorView = this._createRotatorView(), this._fakePanelsView = this._createFakePanelsView()
            }
            hasView(t) {
            ...
            _createRotatorView() {
                const t = new Hl(this.editor.locale),
            ...
            _createFakePanelsView() {
                const t = new ql(this.editor.locale, this.view);
        ...
        class Hl extends Al {
            constructor(t) {
                ...
                const e = t.t,
                    n = this.bindTemplate;
                this.set("isNavigationVisible", !0), this.focusTracker = new Vl, this.buttonPrevView = this._createButtonView(e("br"), zl), this.buttonNextView = this._createButtonView(e("bs"), Bl), this.content = this.createCollection(), this.setTemplate({
                    tag: "div",
                    attributes: {
        ...
        class Jl extends Al {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.set("class"), this.set("panelPosition", "auto"), this.focusTracker = new Vl, this.keystrokes = new Zc, this.setTemplate({
                    tag: "div",
                    attributes: {
            ...
            render() {
                super.render(), this.listenTo(this.buttonView, "open", () => {
                    ...
                    this.isOpen && ("auto" === this.panelPosition ? this.panelView.position = Jl._getOptimalPosition({
        ...
        }, Jl._getOptimalPosition = Tl;
        var Zl = '<svg viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg"><path d="M.941 4.523a.75.75 0 1 1 1.06-1.06l3.006 3.005 3.005-3.005a.75.75 0 1 1 1.06 1.06l-3.549 3.55a.75.75 0 0 1-1.168-.136L.941 4.523z"/></svg>';
        class Xl extends jl {
            constructor(t) {
            ...
            _createArrowView() {
                const t = new Dl;
                return t.content = Zl, t.extendTemplate({
                    attributes: {
        ...
        class td extends Al {
            constructor() {
                super(), this.items = this.createCollection(), this.focusTracker = new Vl, this.keystrokes = new Zc, this._focusCycler = new Wl({
        ...
        function rd(t, e = Xl) {
            const n = new e(t),
                i = new Kl(t),
                o = new Jl(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof Xl ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"),
                function (t) {
                    (function (t) {
                        t.on("render", () => {
                            od({
                    ...
                    function (t) {
                        t.on("execute", e => {
                            e.source instanceof id || (t.isOpen = !1)
                        })
                    }(t),
                    function (t) {
        ...
        function sd(t, e) {
            const n = t.locale,
                i = t.listView = new td(n);
            i.items.bindTo(e).using(({
                type: t,
                model: e
            }) => {
                if ("separator" === t) return new nd(n);
                if ("button" === t || "switchbutton" === t) {
                    const i = new ed(n);
                    let o;
                    return (o = "button" === t ? new jl(n) : new id(n)).bind(...Object.keys(e)).to(e), o.delegate("execute").to(i), i.children.add(o), i
                }
            }), t.panelView.children.add(i), i.items.delegate("execute").to(t)
        }
        var ad = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><circle cx="9.5" cy="4.5" r="1.5"/><circle cx="9.5" cy="10.5" r="1.5"/><circle cx="9.5" cy="16.5" r="1.5"/></svg>\n';
        n(38);
        class cd extends Al {
            constructor(t, e) {
                super(t);
                const n = this.bindTemplate,
                    i = this.t;
                this.options = e || {}, this.set("ariaLabel", i("bt")), this.items = this.createCollection(), this.focusTracker = new Vl, this.keystrokes = new Zc, this.set("class"), this.itemsView = new ld(t), this.children = this.createCollection(), this.children.add(this.itemsView), this.focusables = this.createCollection(), this._focusCycler = new Wl({
                ...
                }), this._behavior = this.options.shouldGroupWhenFull ? new hd(this) : new dd(this)
            }
            render() {
                super.render();
                for (const t of this.items) this.focusTracker.add(t.element);
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new $l) : e.has(t) ? this.items.add(e.create(t)) : console.warn(Object(Gn.a)("toolbarview-item-unavailable: The requested toolbar item is unavailable."), {
                        name: t
                    })
                })
            }
        ...
        class hd {
            constructor(t) {
                this.viewChildren = t.children, this.viewFocusables = t.focusables, this.viewItemsView = t.itemsView, this.viewFocusTracker = t.focusTracker, this.viewLocale = t.locale, this.ungroupedItems = t.createCollection(), this.groupedItems = t.createCollection(), this.groupedItemsDropdown = this._createGroupedItemsDropdown(), this.resizeObserver = null, this.cachedPadding = null, t.itemsView.children.bindTo(this.ungroupedItems).using(t => t), this.ungroupedItems.on("add", this._updateFocusCycleableItems.bind(this)), this.ungroupedItems.on("remove", this._updateFocusCycleableItems.bind(this)), t.children.on("add", this._updateFocusCycleableItems.bind(this)), t.children.on("remove", this._updateFocusCycleableItems.bind(this)), t.items.on("add", (t, e, n) => {
                    n > this.ungroupedItems.length ? this.groupedItems.add(e, n - this.ungroupedItems.length) : this.ungroupedItems.add(e, n), this._updateGrouping()
            ...
            _groupLastItem() {
                this.groupedItems.length || (this.viewChildren.add(new $l), this.viewChildren.add(this.groupedItemsDropdown), this.viewFocusTracker.add(this.groupedItemsDropdown.element)), this.groupedItems.add(this.ungroupedItems.remove(this.ungroupedItems.last), 0)
            }
            _ungroupFirstItem() {
            ...
            _createGroupedItemsDropdown() {
                ...
                return n.class = "ck-toolbar__grouped-dropdown", n.panelPosition = "ltr" === t.uiLanguageDirection ? "sw" : "se",
                    function (t, e) {
                        const n = t.locale,
                            i = n.t,
                            o = t.toolbarView = new cd(n);
                        o.set("ariaLabel", i("bi")), t.extendTemplate({
                            attributes: {
        ...
        class ud extends il {
            ...
            constructor(t) {
                super(t), this.toolbarView = this._createToolbarView(), this.focusTracker = new Vl, t.ui.once("ready", () => {
                    this.focusTracker.add(t.ui.getEditableElement()), this.focusTracker.add(this.toolbarView.element)
                }), this._balloon = t.plugins.get(Ul), this._fireSelectionChangeDebounced = gs(() => this.fire("_selectionChangeDebounced"), 200), this.decorate("show")
            }
            init() {
                ...
                }), this.listenTo(t, "change:range", (e, n) => {
                    (n.directChange || t.isCollapsed) && this.hide(), this._fireSelectionChangeDebounced()
            ...
            _createToolbarView() {
                const t = new cd(this.editor.locale);
            ...
            show() {
                const t = this.editor;
                this._balloon.hasView(this.toolbarView) || t.model.document.selection.isCollapsed || Array.from(this.toolbarView.items).every(t => void 0 !== t.isEnabled && !t.isEnabled) || (this.listenTo(this.editor.ui, "update", () => {
                ...
                return {
                    target: () => {
                        const e = i ? n.getFirstRange() : n.getLastRange(),
                            o = xs.getDomRangeRects(t.domConverter.viewRangeToDom(e));
            ...
            destroy() {
                super.destroy(), this.stopListening(), this._fireSelectionChangeDebounced.cancel(), this.toolbarView.destroy(), this.focusTracker.destroy()
            }
        }
        class fd {
            constructor(t) {
            ...
            create(t) {
                ...
                return this._components.get(gd(t)).callback(this.editor.locale)
            }
            has(t) {
                return this._components.has(gd(t))
            }
        }
        ...
        class md {
            constructor(t) {
                this.editor = t, this.componentFactory = new fd(t), this.focusTracker = new Vl, this._editableElementsMap = new Map, this.listenTo(t.editing.view.document, "layoutChanged", () => this.update())
            }
            get element() {
                return null
            }
        ...
        function bd(t) {
            ...
            pd.has(r) || (pd.set(r, new Map), r.registerPostFixer(t => kd(r, t))), pd.get(r).set(n, {
                text: i,
                isDirectHost: o
            }), e.change(t => kd(r, t))
        }
        ...
        function kd(t, e) {
            const n = pd.get(t);
            let i = !1;
            for (const [t, o] of n) _d(e, t, o) && (i = !0);
            return i
        }
        ...
        class vd extends md {
            ...
            init() {
                ...
                const s = o.element;
                this.setEditableElement(o.name, s), this.focusTracker.add(s), o.bind("isFocused").to(this.focusTracker), i.attachDomRoot(s),
                    function ({
                        origin: t,
        ...
        class yd extends Al {
            ...
            _renderBodyCollection() {
                const t = this.locale,
                    e = this._bodyCollectionContainer = new sl({
                        tag: "div",
                        attributes: {
        ...
        class Ad extends xd {
            ...
            render() {
                ...
                t.change(n => {
                    ...
                    n.setAttribute("aria-label", e("bp", [this.name]), i)
                })
            }
        }
        class Td extends yd {
            constructor(t, e, n) {
                super(t), this.editable = new Ad(t, e, n)
            }
            render() {
        ...
        var Pd = {
            updateSourceElement() {
                ...
                Cd(this.sourceElement, this.data.get())
            }
        };
        class Md extends tl {
            constructor(t, e) {
                super(e), Wn(t) && (this.sourceElement = t, function (t) {
                    const e = t.sourceElement;
                    if (e) {
                        if (e.ckeditorInstance) throw new Gn.b("editor-source-element-already-used: The DOM element cannot be used to create multiple editor instances.", t);
                ...
                n.push(ud), this.config.set("plugins", n), this.config.define("balloonToolbar", this.config.get("toolbar")), this.data.processor = new nl, this.model.document.createRoot();
                const i = new Td(this.locale, this.editing.view, this.sourceElement);
                this.ui = new vd(this, i),
                    function (t) {
            ...
            destroy() {
                ...
                return this.ui.destroy(), super.destroy().then(() => {
                    this.sourceElement && Cd(this.sourceElement, t)
                })
            }
            static create(t, e = {}) {
        ...
        class Ed extends Xr {
            ...
            onDomEvent(t) {
                const e = {
                    dataTransfer: new Sd(t.clipboardData ? t.clipboardData : t.dataTransfer)
                };
        ...
        class Nd extends il {
            ...
            init() {
                ...
                this._htmlDataProcessor = new nl, n.addObserver(Ed), this.listenTo(i, "clipboardInput", e => {
                    t.isReadOnly && e.stop()
                }, {
                    priority: "highest"
                    ...
                    i.content.isEmpty || (i.dataTransfer.setData("text/html", this._htmlDataProcessor.toData(i.content)), i.dataTransfer.setData("text/plain", function t(e) {
                        ...
                        if (e.is("text") || e.is("textProxy")) n = e.data;
                            ...
                            for (const o of e.getChildren()) {
                                const e = t(o);
                                i && (i.is("containerElement") || o.is("containerElement")) && (Id.includes(i.name) || Id.includes(o.name) ? n += "\n" : n += "\n\n"), n += e, i = o
                            }
                        }
                        return n
        ...
        class Od {
            ...
            forceDisabled(t) {
                this._disableStack.add(t), 1 == this._disableStack.size && (this.on("set:isEnabled", Rd, {
                    priority: "highest"
                }), this.isEnabled = !1)
            }
            clearForceDisabled(t) {
                this._disableStack.delete(t), 0 == this._disableStack.size && (this.off("set:isEnabled", Rd), this.refresh())
            }
            execute() {}
            destroy() {
                this.stopListening()
            ...
            execute() {
                ...
                t.change(n => {
                    ! function (t, e, n, i) {
                        ...
                        if (o) {
                            const t = Dd(e.model.schema, n.getAttributes());
                            jd(e, r.start), e.setSelectionAttribute(t)
                        } else {
                            const i = !(r.start.isAtStart && r.end.isAtEnd),
                                o = s == a;
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), i && (o ? jd(e, n.focus) : e.setSelection(a, 0))
                        }
            ...
            constructor(t) {
                ...
                e.on("keydown", (t, n) => {
                    if (this.isEnabled && n.keyCode == bo.enter) {
                        ...
                        e.once("enter", t => i = t, {
                            priority: "highest"
                        }), e.fire("enter", new Zr(e, n.domEvent, {
                            isSoft: n.shiftKey
        ...
        class zd extends il {
            ...
            init() {
                const t = this.editor,
                    e = t.editing.view,
                    n = e.document;
                e.addObserver(Vd), t.commands.add("enter", new Ld(t)), this.listenTo(n, "enter", (n, i) => {
                ...
                t.change(n => {
                    ! function (t, e, n) {
                        const i = n.isCollapsed,
                            ...
                            a = r == s;
                        if (i) {
                            const i = Dd(t.schema, n.getAttributes());
                            Fd(e, o.end), e.removeSelectionAttribute(n.getAttributeKeys()), e.setSelectionAttribute(i)
                        } else {
                            const i = !(o.start.isAtStart && o.end.isAtEnd);
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), a ? Fd(e, n.focus) : i && e.setSelection(s, 0)
                        }
        ...
        function Ud(t, e) {
            return !t.is("rootElement") && (e.isLimit(t) || Ud(t.parent, e))
        }
        class Hd extends il {
            static get pluginName() {
                return "ShiftEnter"
            ...
            init() {
                ...
                }), i.addObserver(Vd), t.commands.add("shiftEnter", new Bd(t)), this.listenTo(o, "enter", (e, n) => {
        ...
        class Wd extends Od {
            constructor(t, e) {
                super(t), this._buffer = new qd(t.model, e), this._batches = new WeakSet
            }
            get buffer() {
                return this._buffer
            }
        ...
        function Yd(t) {
            ...
            go.isAndroid ? i.document.on("beforeinput", (t, e) => r(e), {
                priority: "lowest"
        ...
        const $d = [wo("arrowUp"), wo("arrowRight"), wo("arrowDown"), wo("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
        for (let t = 112; t <= 135; t++) $d.push(t);
        ...
        function Gd(t) {
            ...
            }($o(t.oldChildren, t.newChildren, Qd), t.newChildren);
        ...
        class Kd {
            ...
            handle(t, e) {
                if (function (t) {
                        ...
                        for (const e of t)
                            if ("children" === e.type && !Gd(e)) return !0;
                        return !1
        ...
        class Xd extends il {
            ...
            init() {
                const t = this.editor,
                    e = new Wd(t, t.config.get("typing.undoStep") || 20);
                t.commands.add("input", e), Yd(t),
                    function (t) {
        ...
        class th extends Od {
            constructor(t, e) {
                super(t), this.direction = e, this._buffer = new qd(t.model, t.config.get("typing.undoStep"))
            }
            get buffer() {
                return this._buffer
            }
        ...
        class eh extends hr {
            constructor(t) {
                ...
                function i(t, n, i) {
                    ...
                    }), e.fire("delete", new Zr(e, n, i)), o && o.stop.called && t.stop()
                }
                e.on("keyup", (t, e) => {
                ...
                }), go.isAndroid && e.on("beforeinput", (e, n) => {
        ...
        class nh extends il {
            ...
            init() {
                const t = this.editor,
                    e = t.editing.view,
                    n = e.document;
                if (e.addObserver(eh), t.commands.add("forwardDelete", new th(t, "forward")), t.commands.add("delete", new th(t, "backward")), this.listenTo(n, "delete", (n, i) => {
                        const o = {
                            unit: i.unit,
                            sequence: i.sequence
                        };
        ...
        class oh extends Za {
            ...
            clone() {
                return new oh(this.baseVersion)
            }
            getReversed() {
                return new oh(this.baseVersion + 1)
            }
            _execute() {}
            static get className() {
                return "NoOperation"
        ...
        function sh(t, e, n) {
            let i = rh.get(t);
            i || (i = new Map, rh.set(t, i)), i.set(e, n)
        }
        ...
        function lh(t, e, n) {
            t = t.slice(), e = e.slice();
            const i = new dh(n.document, n.useRelations, n.forceWeakRemove);
            ...
            for (; a < t.length;) {
                ...
                const s = e[o],
                    c = ch(n, s, i.getContext(n, s, !0)),
                    l = ch(s, n, i.getContext(s, n, !1));
            ...
            return hh(t, s.nextBaseVersionB), hh(e, s.nextBaseVersionA), {
                operationsA: t,
                operationsB: e,
                originalOperations: o
            }
            ...
            updateRelation(t, e) {
                switch (t.constructor) {
                    ...
                    case uc: {
                        ...
                        switch (e.constructor) {
                            case dc: {
                                const i = $s._createFromPositionAndShift(e.sourcePosition, e.howMany),
        ...
        function uh(t, e) {
            for (let n = 0; n < e; n++) t.push(new oh(0))
        }

        function fh(t, e, n) {
            const i = t.nodes.getNode(0).getAttribute(e);
            if (i == n) return null;
            const o = new $s(t.position, t.position.getShiftedBy(t.howMany));
            return new cc(o, e, i, n, 0)
        }
        ...
        function mh(t, e) {
            ...
            for (let i = 0; i < t.length; i++) {
                const o = t[i],
                    r = new dc(o.start, o.end.offset - o.start.offset, e, 0);
                n.push(r);
        ...
        sh(cc, cc, (t, e, n) => {
            if (t.key === e.key) {
                const i = t.range.getDifference(e.range).map(e => new cc(e, t.key, t.oldValue, t.newValue, 0)),
                    o = t.range.getIntersection(e.range);
                return o && n.aIsStrong && i.push(new cc(o, e.key, e.newValue, t.newValue, 0)), 0 == i.length ? [new oh(0)] : i
            }
            return [t]
        }), sh(cc, hc, (t, e) => {
            if (t.range.start.hasSameParentAs(e.position) && t.range.containsPosition(e.position)) {
                const n = t.range._getTransformedByInsertion(e.position, e.howMany, !e.shouldReceiveAttributes).map(e => new cc(e, t.key, t.oldValue, t.newValue, t.baseVersion));
                if (e.shouldReceiveAttributes) {
                    const i = fh(e, t.key, t.oldValue);
                    i && n.unshift(i)
                }
                return n
            }
            ...
            const n = [];
            t.range.start.hasSameParentAs(e.deletionPosition) && (t.range.containsPosition(e.deletionPosition) || t.range.start.isEqual(e.deletionPosition)) && n.push($s._createFromPositionAndShift(e.graveyardPosition, 1));
            const i = t.range._getTransformedByMergeOperation(e);
            return i.isCollapsed || n.push(i), n.map(e => new cc(e, t.key, t.oldValue, t.newValue, t.baseVersion))
        }), sh(cc, dc, (t, e) => {
            return function (t, e) {
                const n = $s._createFromPositionAndShift(e.sourcePosition, e.howMany);
                let i = null,
                    o = [];
            ...
            if (t.range.start.hasSameParentAs(e.splitPosition) && t.range.containsPosition(e.splitPosition)) {
                const n = t.clone();
                return n.range = new $s(e.moveTargetPosition.clone(), t.range.end._getCombined(e.splitPosition, e.moveTargetPosition)), t.range.end = e.splitPosition.clone(), t.range.end.stickiness = "toPrevious", [t, n]
            }
            ...
            if (t.shouldReceiveAttributes && t.position.hasSameParentAs(e.range.start) && e.range.containsPosition(t.position)) {
                const i = fh(t, e.key, e.newValue);
                i && n.push(i)
            }
            return n
        }), sh(hc, hc, (t, e, n) => t.position.isEqual(e.position) && n.aIsStrong ? [t] : (t.position = t.position._getTransformedByInsertOperation(e), [t])), sh(hc, dc, (t, e) => (t.position = t.position._getTransformedByMoveOperation(e), [t])), sh(hc, pc, (t, e) => (t.position = t.position._getTransformedBySplitOperation(e), [t])), sh(hc, mc, (t, e) => (t.position = t.position._getTransformedByMergeOperation(e), [t])), sh(uc, hc, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedByInsertOperation(e)[0]), t.newRange && (t.newRange = t.newRange._getTransformedByInsertOperation(e)[0]), [t])), sh(uc, uc, (t, e, n) => {
            if (t.name == e.name) {
                if (!n.aIsStrong) return [new oh(0)];
                t.oldRange = e.newRange ? e.newRange.clone() : null
            }
            return [t]
        }), sh(uc, mc, (t, e) => (t.oldRange && (t.oldRange = t.oldRange._getTransformedByMergeOperation(e)), t.newRange && (t.newRange = t.newRange._getTransformedByMergeOperation(e)), [t])), sh(uc, dc, (t, e, n) => {
            if (t.oldRange && (t.oldRange = $s._createFromRanges(t.oldRange._getTransformedByMoveOperation(e))), t.newRange) {
                if (n.abRelation) {
                    const i = $s._createFromRanges(t.newRange._getTransformedByMoveOperation(e));
                ...
                t.newRange = $s._createFromRanges(t.newRange._getTransformedByMoveOperation(e))
            }
            return [t]
        }), sh(uc, pc, (t, e, n) => {
            if (t.oldRange && (t.oldRange = t.oldRange._getTransformedBySplitOperation(e)), t.newRange) {
                if (n.abRelation) {
                    ...
                    return t.newRange.start.isEqual(e.splitPosition) && n.abRelation.wasStartBeforeMergedElement ? t.newRange.start = Ys._createAt(e.insertionPosition) : t.newRange.start.isEqual(e.splitPosition) && !n.abRelation.wasInLeftElement && (t.newRange.start = Ys._createAt(e.moveTargetPosition)), t.newRange.end.isEqual(e.splitPosition) && n.abRelation.wasInRightElement ? t.newRange.end = Ys._createAt(e.moveTargetPosition) : t.newRange.end.isEqual(e.splitPosition) && n.abRelation.wasEndBeforeMergedElement ? t.newRange.end = Ys._createAt(e.insertionPosition) : t.newRange.end = i.end, [t]
                }
                t.newRange = t.newRange._getTransformedBySplitOperation(e)
            }
            return [t]
        }), sh(mc, hc, (t, e) => (t.sourcePosition.hasSameParentAs(e.position) && (t.howMany += e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByInsertOperation(e), t.targetPosition = t.targetPosition._getTransformedByInsertOperation(e), [t])), sh(mc, mc, (t, e, n) => {
            ...
            const i = $s._createFromPositionAndShift(e.sourcePosition, e.howMany);
            return "remove" == e.type && !n.bWasUndone && !n.forceWeakRemove && t.deletionPosition.hasSameParentAs(e.sourcePosition) && i.containsPosition(t.sourcePosition) ? [new oh(0)] : (t.sourcePosition.hasSameParentAs(e.targetPosition) && (t.howMany += e.howMany), t.sourcePosition.hasSameParentAs(e.sourcePosition) && (t.howMany -= e.howMany), t.sourcePosition = t.sourcePosition._getTransformedByMoveOperation(e), t.targetPosition = t.targetPosition._getTransformedByMoveOperation(e), t.graveyardPosition.isEqual(e.targetPosition) || (t.graveyardPosition = t.graveyardPosition._getTransformedByMoveOperation(e)), [t])
        }), sh(mc, pc, (t, e, n) => {
            ...
            const n = $s._createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByInsertOperation(e, !1)[0];
            ...
            const i = $s._createFromPositionAndShift(t.sourcePosition, t.howMany),
                o = $s._createFromPositionAndShift(e.sourcePosition, e.howMany);
            let r, s = n.aIsStrong,
                a = !n.aIsStrong;
            if ("insertBefore" == n.abRelation || "insertAfter" == n.baRelation ? a = !0 : "insertAfter" != n.abRelation && "insertBefore" != n.baRelation || (a = !1), r = t.targetPosition.isEqual(e.targetPosition) && a ? t.targetPosition._getTransformedByDeletion(e.sourcePosition, e.howMany) : t.targetPosition._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), gh(t, e) && gh(e, t)) return [e.getReversed()];
            if (i.containsPosition(e.targetPosition) && i.containsRange(o, !0)) return i.start = i.start._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), i.end = i.end._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), mh([i], r);
            if (o.containsPosition(t.targetPosition) && o.containsRange(i, !0)) return i.start = i.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), i.end = i.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), mh([i], r);
            const c = li(t.sourcePosition.getParentPath(), e.sourcePosition.getParentPath());
            if ("prefix" == c || "extension" == c) return i.start = i.start._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), i.end = i.end._getTransformedByMove(e.sourcePosition, e.targetPosition, e.howMany), mh([i], r);
            ...
            return null !== h && s && (h.start = h.start._getCombined(e.sourcePosition, e.getMovedRangeStart()), h.end = h.end._getCombined(e.sourcePosition, e.getMovedRangeStart()), 0 === l.length ? l.push(h) : 1 == l.length ? o.start.isBefore(i.start) || o.start.isEqual(i.start) ? l.unshift(h) : l.push(h) : l.splice(1, 0, h)), 0 === l.length ? [new oh(t.baseVersion)] : mh(l, r)
        }), sh(dc, pc, (t, e, n) => {
            ...
            const o = $s._createFromPositionAndShift(t.sourcePosition, t.howMany);
            ...
            if (o.start.hasSameParentAs(e.splitPosition) && o.containsPosition(e.splitPosition)) {
                let t = new $s(e.splitPosition, o.end);
                return t = t._getTransformedBySplitOperation(e), mh([new $s(o.start, e.splitPosition), t], i)
            }
            ...
            if (e.graveyardPosition) {
                ...
                t.howMany > 1 && i && !n.aWasUndone && r.push($s._createFromPositionAndShift(e.insertionPosition, 1))
            }
            return mh(r, i)
        }), sh(dc, mc, (t, e, n) => {
            const i = $s._createFromPositionAndShift(t.sourcePosition, t.howMany);
            if (e.deletionPosition.hasSameParentAs(t.sourcePosition) && i.containsPosition(e.sourcePosition))
                if ("remove" != t.type || n.forceWeakRemove) {
                    if (1 == t.howMany) return n.bWasUndone ? (t.sourcePosition = e.graveyardPosition.clone(), t.targetPosition = t.targetPosition._getTransformedByMergeOperation(e), [t]) : [new oh(0)]
                } else if (!n.aWasUndone) {
                const n = [];
                let i = e.graveyardPosition.clone(),
                    o = e.targetPosition._getTransformedByMergeOperation(e);
                t.howMany > 1 && (n.push(new dc(t.sourcePosition, t.howMany - 1, t.targetPosition, 0)), i = i._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany - 1), o = o._getTransformedByMove(t.sourcePosition, t.targetPosition, t.howMany - 1));
            ...
            const o = $s._createFromPositionAndShift(t.sourcePosition, t.howMany)._getTransformedByMergeOperation(e);
        ...
        }), sh(fc, hc, (t, e) => (t.position = t.position._getTransformedByInsertOperation(e), [t])), sh(fc, mc, (t, e) => t.position.isEqual(e.deletionPosition) ? (t.position = e.graveyardPosition.clone(), t.position.stickiness = "toNext", [t]) : (t.position = t.position._getTransformedByMergeOperation(e), [t])), sh(fc, dc, (t, e) => (t.position = t.position._getTransformedByMoveOperation(e), [t])), sh(fc, fc, (t, e, n) => {
            ...
            if (t.root === e.root && t.key === e.key) {
                if (!n.aIsStrong || t.newValue === e.newValue) return [new oh(0)];
                t.oldValue = e.newValue
            }
            return [t]
        }), sh(pc, hc, (t, e) => (t.splitPosition.hasSameParentAs(e.position) && t.splitPosition.offset < e.position.offset && (t.howMany += e.howMany), t.splitPosition = t.splitPosition._getTransformedByInsertOperation(e), t.insertionPosition = pc.getInsertionPosition(t.splitPosition), [t])), sh(pc, mc, (t, e, n) => {
            if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
                const n = e.graveyardPosition.path.slice();
                n.push(0);
                const i = new Ys(e.graveyardPosition.root, n),
                    o = pc.getInsertionPosition(new Ys(e.graveyardPosition.root, n)),
                    r = new pc(i, 0, null, 0);
            ...
            if (t.graveyardPosition) {
                ...
                if (!n.bWasUndone && o) {
                    const n = t.splitPosition._getTransformedByMoveOperation(e),
                        ...
                        o = i.path.slice();
                    o.push(0);
                    const r = new Ys(i.root, o);
                    return [new dc(n, t.howMany, r, 0)]
                }
            ...
            if (t.splitPosition.hasSameParentAs(e.sourcePosition) && i.containsPosition(t.splitPosition)) {
                ...
                return t.howMany -= n, t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany), t.splitPosition = e.sourcePosition.clone(), t.insertionPosition = pc.getInsertionPosition(t.splitPosition), [t]
            }
            return !t.splitPosition.isEqual(e.targetPosition) || "insertAtSource" != n.baRelation && "splitBefore" != n.abRelation ? (e.sourcePosition.isEqual(e.targetPosition) || (t.splitPosition.hasSameParentAs(e.sourcePosition) && t.splitPosition.offset <= e.sourcePosition.offset && (t.howMany -= e.howMany), t.splitPosition.hasSameParentAs(e.targetPosition) && t.splitPosition.offset < e.targetPosition.offset && (t.howMany += e.howMany)), t.splitPosition.stickiness = "toNone", t.splitPosition = t.splitPosition._getTransformedByMoveOperation(e), t.splitPosition.stickiness = "toNext", t.graveyardPosition ? t.insertionPosition = t.insertionPosition._getTransformedByMoveOperation(e) : t.insertionPosition = pc.getInsertionPosition(t.splitPosition), [t]) : (t.howMany += e.howMany, t.splitPosition = t.splitPosition._getTransformedByDeletion(e.sourcePosition, e.howMany), t.insertionPosition = pc.getInsertionPosition(t.splitPosition), [t])
        }), sh(pc, pc, (t, e, n) => {
            if (t.splitPosition.isEqual(e.splitPosition)) {
                if (!t.graveyardPosition && !e.graveyardPosition) return [new oh(0)];
                if (t.graveyardPosition && e.graveyardPosition && t.graveyardPosition.isEqual(e.graveyardPosition)) return [new oh(0)];
            ...
            if (t.graveyardPosition && e.graveyardPosition && t.graveyardPosition.isEqual(e.graveyardPosition)) {
                ...
                if (o && !i || !(i && !o) && n.aIsStrong) {
                    const n = [];
                    return e.howMany && n.push(new dc(e.moveTargetPosition, e.howMany, e.splitPosition, 0)), t.howMany && n.push(new dc(t.splitPosition, t.howMany, t.moveTargetPosition, 0)), n
                }
                return [new oh(0)]
            }
            ...
            if (e.splitPosition.isEqual(t.insertionPosition) && "splitBefore" == n.baRelation) {
                ...
                n.push(0);
                const i = new Ys(e.insertionPosition.root, n);
                return [t, new dc(t.insertionPosition, 1, i, 0)]
            }
        ...
        class ph extends Od {
            ...
            _restoreSelection(t, e, n) {
                const i = this.editor.model,
                    ...
                    r = [];
                for (const e of t) {
                    const t = bh(e, n).find(t => t.start.root != o.graveyard);
                    t && r.push(t)
                }
                r.length && i.change(t => {
                    t.setSelection(r, {
        ...
        class _h extends il {
            ...
            init() {
                const t = this.editor;
                this._undoCommand = new wh(t), this._redoCommand = new kh(t), t.commands.add("undo", this._undoCommand), t.commands.add("redo", this._redoCommand), this.listenTo(t.model, "applyOperation", (t, e) => {
                    const n = e[0];
        ...
        var vh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5.042 9.367l2.189 1.837a.75.75 0 0 1-.965 1.149l-3.788-3.18a.747.747 0 0 1-.21-.284.75.75 0 0 1 .17-.945L6.23 4.762a.75.75 0 1 1 .964 1.15L4.863 7.866h8.917A.75.75 0 0 1 14 7.9a4 4 0 1 1-1.477 7.718l.344-1.489a2.5 2.5 0 1 0 1.094-4.73l.008-.032H5.042z"/></svg>',
            yh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M14.958 9.367l-2.189 1.837a.75.75 0 0 0 .965 1.149l3.788-3.18a.747.747 0 0 0 .21-.284.75.75 0 0 0-.17-.945L13.77 4.762a.75.75 0 1 0-.964 1.15l2.331 1.955H6.22A.75.75 0 0 0 6 7.9a4 4 0 1 0 1.477 7.718l-.344-1.489A2.5 2.5 0 1 1 6.039 9.4l-.008-.032h8.927z"/></svg>';
        class xh extends il {
            init() {
                const t = this.editor,
                    e = t.locale,
                    n = t.t,
                    i = "ltr" == e.uiLanguageDirection ? vh : yh,
                    o = "ltr" == e.uiLanguageDirection ? yh : vh;
                this._addButton("undo", n("bv"), "CTRL+Z", i), this._addButton("redo", n("bw"), "CTRL+Y", o)
            }
            _addButton(t, e, n, i) {
                const o = this.editor;
        ...
        class Ph extends il {
            ...
            createLoader(t) {
                ...
                const e = new Mh(Promise.resolve(t), this.createUploadAdapter);
        ...
        class Mh {
            constructor(t, e) {
                this.id = Jn(), this._filePromiseWrapper = this._createFilePromiseWrapper(t), this._adapter = e(this), this._reader = new Ch, this.set("status", "idle"), this.set("uploaded", 0), this.set("uploadTotal", null), this.bind("uploadedPercent").to(this, "uploaded", this, "uploadTotal", (t, e) => e ? t / e * 100 : 0), this.set("uploadResponse", null)
            }
            get file() {
        ...
        const Sh = "ckCsrfToken",
            Eh = 40,
            Ih = "abcdefghijklmnopqrstuvwxyz0123456789";
        ...
        function Nh() {
            ...
            return t && t.length == Eh || (t = function (t) {
                ...
                for (let t = 0; t < n.length; t++) {
                    const i = Ih.charAt(n[t] % Ih.length);
        ...
        class Oh extends il {
            ...
            init() {
                ...
                t && (this.editor.plugins.get(Ph).createUploadAdapter = (e => new Rh(e, t, this.editor.t)))
            }
        }
        class Rh {
            constructor(t, e, n) {
            ...
            _sendRequest(t) {
                ...
                e.append("upload", t), e.append("ckCsrfToken", Nh()), this.xhr.send(e)
            }
        }
        class Dh {
            static get pluginName() {
            ...
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? i = e : r = e, "string" == typeof n ? o = n : s = n, r = r || (t => {
                    ...
                    const l = o.focus,
                        ...
                        f = r(h),
                        g = jh(u.start, f.format, i),
                        m = jh(u.start, f.remove, i);
                    g.length && m.length && i.enqueueChange(t => {
                        if (!1 !== s(t, g))
                            for (const e of m.reverse()) t.remove(e)
                    })
                })
            }
        }
        ...
        class Fh extends il {
            ...
            init() {
                ...
                }), t.commands.add(Bh, new zh(t, Bh)), t.keystrokes.set("CTRL+B", Bh)
            }
        }
        var Uh = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.187 17H5.773c-.637 0-1.092-.138-1.364-.415-.273-.277-.409-.718-.409-1.323V4.738c0-.617.14-1.062.419-1.332.279-.27.73-.406 1.354-.406h4.68c.69 0 1.288.041 1.793.124.506.083.96.242 1.36.478.341.197.644.447.906.75a3.262 3.262 0 0 1 .808 2.162c0 1.401-.722 2.426-2.167 3.075C15.05 10.175 16 11.315 16 13.01a3.756 3.756 0 0 1-2.296 3.504 6.1 6.1 0 0 1-1.517.377c-.571.073-1.238.11-2 .11zm-.217-6.217H7v4.087h3.069c1.977 0 2.965-.69 2.965-2.072 0-.707-.256-1.22-.768-1.537-.512-.319-1.277-.478-2.296-.478zM7 5.13v3.619h2.606c.729 0 1.292-.067 1.69-.2a1.6 1.6 0 0 0 .91-.765c.165-.267.247-.566.247-.897 0-.707-.26-1.176-.778-1.409-.519-.232-1.31-.348-2.375-.348H7z"/></svg>';
        const Hh = "bold";
        class qh extends il {
            init() {
                const t = this.editor,
                    e = t.t;
                t.ui.componentFactory.add(Hh, n => {
                    const i = t.commands.get(Hh),
                        o = new jl(n);
                    return o.set({
                        label: e("p"),
                        icon: Uh,
                        ...
                        tooltip: !0,
                        isToggleable: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(Hh)), o
                })
            }
        }
        const Wh = "italic";
        class Yh extends il {
            ...
            init() {
                ...
                t.model.schema.extend("$text", {
                    allowAttributes: Wh
                }), t.model.schema.setAttributeProperties(Wh, {
                    isFormatting: !0,
                    copyOnEnter: !0
                }), t.conversion.attributeToElement({
                    model: Wh,
                ...
                }), t.commands.add(Wh, new zh(t, Wh)), t.keystrokes.set("CTRL+I", Wh)
            }
        }
        var $h = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.586 14.633l.021.004c-.036.335.095.655.393.962.082.083.173.15.274.201h1.474a.6.6 0 1 1 0 1.2H5.304a.6.6 0 0 1 0-1.2h1.15c.474-.07.809-.182 1.005-.334.157-.122.291-.32.404-.597l2.416-9.55a1.053 1.053 0 0 0-.281-.823 1.12 1.12 0 0 0-.442-.296H8.15a.6.6 0 0 1 0-1.2h6.443a.6.6 0 1 1 0 1.2h-1.195c-.376.056-.65.155-.823.296-.215.175-.423.439-.623.79l-2.366 9.347z"/></svg>';
        const Gh = "italic";
        class Qh extends il {
            init() {
                const t = this.editor,
                    e = t.t;
                t.ui.componentFactory.add(Gh, n => {
                    const i = t.commands.get(Gh),
                        o = new jl(n);
                    return o.set({
                        label: e("o"),
                        icon: $h,
                        ...
                        tooltip: !0,
                        isToggleable: !0
                    }), o.bind("isOn", "isEnabled").to(i, "value", "isEnabled"), this.listenTo(o, "execute", () => t.execute(Gh)), o
                })
            }
        }
        ...
        class Jh extends Od {
            ...
            execute(t = {}) {
                ...
                e.change(t => {
                    if (r) {
                        const e = o.filter(t => Zh(t) || tu(n, t));
                        this._applyQuote(t, e)
                    } else this._removeQuote(t, o.filter(Zh))
                })
            }
            _getValue() {
                const t = Kh(this.editor.model.document.selection.getSelectedBlocks());
                return !(!t || !Zh(t))
            }
            _checkEnabled() {
                ...
                const t = this.editor.model.document.selection,
                    ...
                    n = Kh(t.getSelectedBlocks());
                return !!n && tu(e, n)
            }
            _removeQuote(t, e) {
                Xh(t, e).reverse().forEach(e => {
        ...
        class eu extends il {
            ...
            init() {
                const t = this.editor,
                    e = t.model.schema;
                t.commands.add("blockQuote", new Jh(t)), e.register("blockQuote", {
                    allowWhere: "$block",
                    allowContentOf: "$root"
                }), e.addChildCheck((t, e) => {
        ...
        var nu = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 10.423a6.5 6.5 0 0 1 6.056-6.408l.038.67C6.448 5.423 5.354 7.663 5.22 10H9c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574zm8 0a6.5 6.5 0 0 1 6.056-6.408l.038.67c-2.646.739-3.74 2.979-3.873 5.315H17c.552 0 .5.432.5.986v4.511c0 .554-.448.503-1 .503h-5c-.552 0-.5-.449-.5-1.003v-4.574z"/></svg>';
        n(44);
        class iu extends il {
            init() {
                const t = this.editor,
        ...
        var ou = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.627 16.5zm5.873-.196zm0-7.001V8h-13v8.5h4.341c.191.54.457 1.044.785 1.5H2a1.5 1.5 0 0 1-1.5-1.5v-13A1.5 1.5 0 0 1 2 2h4.5a1.5 1.5 0 0 1 1.06.44L9.122 4H16a1.5 1.5 0 0 1 1.5 1.5v1A1.5 1.5 0 0 1 19 8v2.531a6.027 6.027 0 0 0-1.5-1.228zM16 6.5v-1H8.5l-2-2H2v13h1V8a1.5 1.5 0 0 1 1.5-1.5H16z"/><path d="M14.5 19.5a5 5 0 1 1 0-10 5 5 0 0 1 0 10zM15 14v-2h-1v2h-2v1h2v2h1v-2h2v-1h-2z"/></svg>';
        class ru extends il {
            static get pluginName() {
                return "CKFinderUI"
            }
        ...
        class cu {
            ...
            add(t, e) {
                ...
                const o = n[0];
                i === o || lu(i, o) || this.fire("change:top", {
                    oldDescriptor: i,
                    newDescriptor: o,
                    writer: e
                })
        ...
        function lu(t, e) {
            return t && e && t.priority == e.priority && hu(t.classes) == hu(e.classes)
        }

        function du(t, e) {
            return t.priority > e.priority || !(t.priority < e.priority) && hu(t.classes) > hu(e.classes)
        }
        ...
        ci(cu, ei);
        var uu = '<svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M4 0v1H1v3H0V.5A.5.5 0 0 1 .5 0H4zm8 0h3.5a.5.5 0 0 1 .5.5V4h-1V1h-3V0zM4 16H.5a.5.5 0 0 1-.5-.5V12h1v3h3v1zm8 0v-1h3v-3h1v3.5a.5.5 0 0 1-.5.5H12z"/><path fill-opacity=".256" d="M1 1h14v14H1z"/><g class="ck-icon__selected-indicator"><path d="M7 0h2v1H7V0zM0 7h1v2H0V7zm15 0h1v2h-1V7zm-8 8h2v1H7v-1z"/><path fill-opacity=".254" d="M1 1h14v14H1z"/></g></svg>';
        const fu = "ck-widget",
            gu = "ck-widget_selected";
        ...
        function pu(t, e, n = {}) {
            return go.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(fu, t), e.setCustomProperty("widget", !0, t), t.getFillerOffset = _u, n.label && function (t, e, n) {
                    ...
                    const n = e.createUIElement("div", {
                        ...
                        const e = this.toDomElement(t),
                            n = new Dl;
                        return n.set("content", uu), n.render(), e.appendChild(n.element), e
                    });
        ...
        function wu(t, e) {
            return e.addClass(["ck-editor__editable", "ck-editor__nested-editable"], t), go.isEdge || (e.setAttribute("contenteditable", t.isReadOnly ? "false" : "true", t), t.on("change:isReadOnly", (n, i, o) => {
        ...
        function vu(t) {
            ...
            return e && function (t) {
                return !!t.getCustomProperty("image") && mu(t)
            }(e) ? e : null
        }
        ...
        class Cu extends il {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = t.t,
                    i = t.conversion;
                t.editing.view.addObserver(su), e.register("image", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    ...
                    view: (t, e) => (function (t, e, n) {
                        return e.setCustomProperty("image", !0, t), pu(t, e, {
                            label: function () {
                ...
                }), i.for("downcast").add(au("src")).add(au("alt")).add(function () {
                    return e => {
        ...
        function Mu(t, e, n) {
            return n.createRange(Su(t, e, !0, n), Su(t, e, !1, n))
        }
                ...
                n.change(e => {
                    if (i.isCollapsed) {
                        ...
                        if (i.hasAttribute("linkHref")) {
                            const a = Mu(s, i.getAttribute("linkHref"), n);
        ...
        class Iu extends Od {
            ...
            execute() {
                ...
                e.change(t => {
                    const o = n.isCollapsed ? [Mu(n.getFirstPosition(), n.getAttribute("linkHref"), e)] : n.getRanges();
                    for (const e of o)
        ...
        var Ou = function (t, e, n) {
                var i = t.length;
                return n = void 0 === n ? i : n, !e && n >= i ? t : Nu(t, e, n)
            },
            Ru = RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");
        var Du = function (t) {
            return Ru.test(t)
        };
        var Lu = function (t) {
            ...
            Uu = "[\\ud800-\\udbff][\\udc00-\\udfff]",
            Hu = "(?:" + Vu + "|" + zu + ")" + "?",
            qu = "[\\ufe0e\\ufe0f]?" + Hu + ("(?:\\u200d(?:" + [Bu, Fu, Uu].join("|") + ")[\\ufe0e\\ufe0f]?" + Hu + ")*"),
            Wu = "(?:" + [Bu + Vu + "?", Vu, Fu, Uu, ju].join("|") + ")",
            Yu = RegExp(zu + "(?=" + zu + ")|" + Wu + qu, "g");
        var $u = function (t) {
            return t.match(Yu) || []
        };
        var Gu = function (t) {
            return Du(t) ? $u(t) : Lu(t)
        };
        var Qu = function (t, e) {
            ...
            Ku = 1 / 0,
            Ju = o ? o.prototype : void 0,
            Zu = Ju ? Ju.toString : void 0;
        var Xu = function t(e) {
            if ("string" == typeof e) return e;
            if (Wt(e)) return Qu(e, t) + "";
            if (is(e)) return Zu ? Zu.call(e) : "";
            var n = e + "";
            return "0" == n && 1 / e == -Ku ? "-0" : n
        };
        var tf = function (t) {
            return null == t ? "" : Xu(t)
        };
        var ef = function (t) {
            return function (e) {
                e = tf(e);
                var n = Du(e) ? Gu(e) : void 0,
                    i = n ? n[0] : e.charAt(0),
                    o = n ? Ou(n, 1).join("") : e.slice(1);
                return i[t]() + o
            }
        }("toUpperCase");
        const nf = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
            of = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
        ...
        class lf {
            constructor(t, e, n) {
                this.model = t, this.attribute = n, this._modelSelection = t.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, e.listenTo(this._modelSelection, "change:range", (t, e) => {
                    this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!e.directChange && df(this._modelSelection.getFirstPosition(), n) || this._restoreGravity())
                })
            }
            handleForwardMovement(t, e) {
                const n = this.attribute;
                if (!(this._isGravityOverridden || t.isAtStart && this._hasSelectionAttribute)) return ff(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._removeSelectionAttribute(), !0) : hf(t, n) ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : uf(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : void 0
            }
            handleBackwardMovement(t, e) {
                const n = this.attribute;
                return this._isGravityOverridden ? ff(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._restoreGravity(), this._removeSelectionAttribute(), !0) : (this._preventCaretMovement(e), this._restoreGravity(), t.isAtStart && this._removeSelectionAttribute(), !0) : ff(t, n) && !this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtEnd && uf(t, n) ? this._hasSelectionAttribute ? void(gf(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity())) : (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtStart ? this._hasSelectionAttribute ? (this._removeSelectionAttribute(), this._preventCaretMovement(e), !0) : void 0 : void(gf(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
            }
        ...
        function gf(t, e) {
            return df(t.getShiftedBy(-1), e)
        }
        n(46);
        const mf = "ck-link_selected",
            pf = "automatic",
            bf = "manual",
            wf = /^(https?:)?\/\//;
        class kf extends il {
            ...
            init() {
                ...
                }), t.commands.add("link", new Eu(t)), t.commands.add("unlink", new Iu(t));
                const n = function (t, e) {
                    const n = {
                        "Open in a new tab": t("bc"),
                        Downloadable: t("bd")
                    };
                ...
                this._enableAutomaticDecorators(n.filter(t => t.mode === pf)), this._enableManualDecorators(n.filter(t => t.mode === bf)),
                    function ({
                        view: t,
                        model: e,
                        emitter: n,
            ...
            _enableManualDecorators(t) {
                ...
                t.forEach(t => {
                    ...
                    }), n.add(new cf(t)), e.conversion.for("downcast").attributeToElement({
                        model: t.id,
                        view: (e, i) => {
                            if (e) {
            ...
            _setupLinkHighlight() {
                ...
                e.document.registerPostFixer(e => {
                    ...
                    let o = !1;
                    if (i.hasAttribute("linkHref")) {
                        const r = Mu(i.getFirstPosition(), i.getAttribute("linkHref"), t.model),
                            s = t.editing.mapper.toViewRange(r);
                        for (const t of s.getItems()) t.is("a") && !t.hasClass(mf) && (e.addClass(mf, t), n.add(t), o = !0)
                    }
                    return o
                }), t.conversion.for("editingDowncast").add(t => {
                    function i() {
                        e.change(t => {
                            for (const e of n.values()) t.removeClass(mf, e), n.delete(e)
                        })
                    }
                    t.on("insert", i, {
                        priority: "highest"
            ...
            _sendRequest() {
                ...
                return t.append("file", this.file), new Promise((n, i) => {
                    e.addEventListener("load", () => {
                        const t = e.status,
                            o = e.response;
                        return t < 200 || t > 299 ? o.message ? i(new Gn.b("fileuploader-uploading-data-failed: Uploading file failed.", this, {
                            message: o.message
                        })) : i(o.error) : n(o)
        ...
        class Pf {
            constructor(t, e = Cf) {
                ...
                })(t), this._options = Object.assign({}, Cf, e)
            }
            init() {
            ...
            static create(t, e = Cf) {
                return new Pf(t, e).init()
            }
        }
        ci(Pf, Fi);
        var Mf = Pf;
        class Sf extends il {
            ...
            init() {
                ...
                if (this.tokenUrl) return this.token = new Sf.Token(this.tokenUrl), this.token.init();
                this.token = null
            }
        }
        Sf.Token = Mf;
        class Ef extends il {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = e.token,
                    i = e.uploadUrl;
                n && (this._uploadGateway = new Ef._UploadGateway(n, i), t.plugins.get(Ph).createUploadAdapter = (t => new If(this._uploadGateway, t)))
            }
        }
        class If {
            constructor(t, e) {
        ...
        class Rf extends il {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    for (const t of o.getRanges())
                        for (const e of t) {
                            const t = e.item;
                            mu(t) && !Df(t, s) && (i.addClass(gu, t), this._previouslySelected.add(t), s = t, t == r && i.setSelection(o.getRanges(), {
                                fake: !0,
                                label: bu(r)
                            }))
                        }
                    ...
                    priority: "low"
                }), t.addObserver(Nf), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
            ...
            _onMousedown(t, e) {
                ...
                if (!mu(r) && !(r = r.findAncestor(mu))) return;
            ...
            _onKeydown(t, e) {
                const n = e.keyCode,
                    ...
                    o = n == bo.arrowdown || n == bo[i ? "arrowright" : "arrowleft"];
                let r = !1;
                ! function (t) {
                    return t == bo.arrowright || t == bo.arrowleft || t == bo.arrowup || t == bo.arrowdown
                }(n) ? ! function (t) {
                    return wo(t) == Of
                }(e) ? n === bo.enter && (r = this._handleEnterKey(e.shiftKey)): r = this._selectAllNestedEditableContent() || this._selectAllContent(): r = this._handleArrowKeys(o), r && (e.preventDefault(), t.stop())
            }
            _handleDelete(t) {
            ...
            _clearPreviouslySelectedWidgets(t) {
                for (const e of this._previouslySelected) t.removeClass(gu, e);
        ...
        class Lf extends Od {
            refresh() {
                ...
                this.isEnabled = yu(t), yu(t) && t.hasAttribute("alt") ? this.value = t.getAttribute("alt") : this.value = !1
            }
            execute(t) {
                const e = this.editor.model,
                    n = e.document.selection.getSelectedElement();
        ...
        class jf extends il {
            ...
            init() {
                this.editor.commands.add("imageTextAlternative", new Lf(this.editor))
            }
        }
        n(50);
        class Vf extends Al {
        ...
        class qf extends Al {
            constructor(t) {
                ...
                this.focusTracker = new Vl, this.keystrokes = new Zc, this.labeledInput = this._createLabeledInputView(), this.saveButtonView = this._createButton(e("bj"), Uf, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(e("bk"), Hf, "ck-button-cancel", "cancel"), this._focusables = new ol, this._focusCycler = new Wl({
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), Ff({
                    view: this
        ...
        class $f extends il {
            ...
            _createForm() {
                ...
                this._balloon = this.editor.plugins.get("ContextualBalloon"), this._form = new qf(t.locale), this._form.render(), this.listenTo(this._form, "submit", () => {
        ...
        class Kf extends Al {
            constructor(t) {
                super(t), this.buttonView = new jl(t), this._fileInputView = new Jf(t), this._fileInputView.bind("acceptedType").to(this), this._fileInputView.bind("allowMultipleFiles").to(this), this._fileInputView.delegate("done").to(this), this.setTemplate({
                    tag: "span",
                    attributes: {
        ...
        var Zf = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M6.91 10.54c.26-.23.64-.21.88.03l3.36 3.14 2.23-2.06a.64.64 0 0 1 .87 0l2.52 2.97V4.5H3.2v10.12l3.71-4.08zm10.27-7.51c.6 0 1.09.47 1.09 1.05v11.84c0 .59-.49 1.06-1.09 1.06H2.79c-.6 0-1.09-.47-1.09-1.06V4.08c0-.58.49-1.05 1.1-1.05h14.38zm-5.22 5.56a1.96 1.96 0 1 1 3.4-1.96 1.96 1.96 0 0 1-3.4 1.96z"/></svg>';
        ...
        var ng = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 250"><rect rx="4"/></svg>';
        n(60), n(62), n(64);
        class ig extends il {
            constructor(t) {
                super(t), this.placeholder = "data:image/svg+xml;utf8," + encodeURIComponent(ng)
            }
            init() {
            ...
            uploadStatusChange(t, e, n) {
                ...
                if ("uploading" == a) {
                    ...
                    return og(l, d), void(t ? (sg(l, d), function (t, e, n, i) {
                        const o = function (t) {
                ...
                "complete" == a && s.loaders.get(r) && !go.isEdge && function (t, e, n) {
        ...
        function rg(t, e, n) {
            ...
            i.getAttribute("src") !== t && n.setAttribute("src", t, i), ag(e, "placeholder") || n.insert(n.createPositionAfter(i), function (t) {
                const e = t.createUIElement("div", {
        ...
        function sg(t, e) {
            t.hasClass("ck-image-upload-placeholder") && e.removeClass("ck-image-upload-placeholder", t), cg(t, e, "placeholder")
        }
        ...
        class ug extends il {
            ...
            init() {
                const t = this.editor,
                    ...
                    i = t.conversion,
                    o = t.plugins.get(Ph),
                    r = Xf(t.config.get("image.upload.types"));
                n.extend("image", {
                    allowAttributes: ["uploadId", "uploadStatus"]
                }), t.commands.add("imageUpload", new dg(t)), i.for("upcast").attributeToAttribute({
                    view: {
                        name: "img",
                        key: "uploadId"
                    },
                ...
                }), this.listenTo(t.plugins.get(Nd), "inputTransformation", (e, n) => {
        ...
        class mg extends Od {
            refresh() {
                const t = this.editor.model,
                    e = Kh(t.document.selection.getSelectedBlocks());
                this.value = !!e && e.is("paragraph"), this.isEnabled = !!e && pg(e, t.schema)
            }
            execute(t = {}) {
                const e = this.editor.model,
                    n = e.document;
                e.change(i => {
                    ...
                    for (const t of o) !t.is("paragraph") && pg(t, e.schema) && i.rename(t, "paragraph")
                })
            }
        }
        ...
        class bg extends il {
            ...
            init() {
                const t = this.editor,
                    e = t.model,
                    n = t.data;
                t.commands.add("paragraph", new mg(t)), e.schema.register("paragraph", {
                    inheritAllFrom: "$block"
                }), t.conversion.elementToElement({
                    model: "paragraph",
                    view: "p"
                }), t.conversion.for("upcast").elementToElement({
                    model: (t, e) => bg.paragraphLikeElements.has(t.name) ? t.isEmpty ? null : e.createElement("paragraph") : null,
                    converterPriority: "low"
                }), n.upcastDispatcher.on("element", (t, e, n) => {
                    n.consumable.test(e.viewItem, {
                        name: e.viewItem.name
                    }) && kg(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, wg(e.viewItem, e.modelCursor, n))
                }, {
                    priority: "low"
                }), n.upcastDispatcher.on("text", (t, e, n) => {
                    e.modelRange || kg(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, wg(e.viewItem, e.modelCursor, n))
                }, {
                    priority: "lowest"
        ...
        bg.paragraphLikeElements = new Set(["blockquote", "dd", "div", "dt", "h1", "h2", "h3", "h4", "h5", "h6", "li", "p", "td"]);
        class _g extends Od {
            constructor(t, e) {
            ...
            refresh() {
                const t = Kh(this.editor.model.document.selection.getSelectedBlocks());
                this.value = !!t && this.modelElements.includes(t.name) && t.name, this.isEnabled = !!t && this.modelElements.some(e => vg(t, e, this.editor.model.schema))
            }
            execute(t) {
                const e = this.editor.model,
                    n = e.document,
                    i = t.value;
                e.change(t => {
                    const o = Array.from(n.selection.getSelectedBlocks()).filter(t => vg(t, i, e.schema));
        ...
        class xg extends il {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const i of e) i.model !== yg && (t.model.schema.register(i.model, {
                    inheritAllFrom: "$block"
                }), t.conversion.elementToElement(i), n.push(i.model));
                this._addDefaultH1Conversion(t), t.commands.add("heading", new _g(t, n))
            }
            afterInit() {
                const t = this.editor,
                ...
                e && this.listenTo(e, "afterExecute", (e, i) => {
                    ...
                    n.some(t => o.is(t.model)) && !o.is(yg) && 0 === o.childCount && i.writer.rename(o, yg)
                })
            }
        ...
        class Mg extends il {
            ...
            init() {
                ...
                i.downcastDispatcher.on("insert:caption", Sg(t => t.createContainerElement("figcaption"), !1));
                const s = function (t, e) {
                    return n => {
                        const i = n.createEditableElement("figcaption");
                        return n.setCustomProperty("imageCaption", !0, i), bd({
                            view: t,
                            element: i,
                            text: e
                        }), wu(i, n)
                ...
                o.downcastDispatcher.on("insert:caption", Sg(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
            ...
            _updateCaptionVisibility(t) {
                ...
                const s = Eg(o.getFirstPosition().parent);
                if (s && (i = e.toViewElement(s)), i) return n ? n === i ? Ng(i, t) : (Ig(n, t), this._lastSelectedCaption = i, Ng(i, t)) : (this._lastSelectedCaption = i, Ng(i, t));
                if (n) {
                    const e = Ig(n, t);
            ...
            _insertMissingModelCaptionElement(t) {
                ...
                for (const t of n)
                    if ("insert" == t.type && "$text" != t.name) {
                        ...
                        if (n.is("image") && !Cg(n) && i.push(n), !n.is("image") && n.childCount)
                            for (const t of e.createRangeIn(n).getItems()) t.is("image") && !Cg(t) && i.push(t)
        ...
        var Dg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm2.5 3V12h11V7.5h-11zM4.061 6H15.94c.586 0 1.061.407 1.061.91v5.68c0 .503-.475.91-1.061.91H4.06c-.585 0-1.06-.407-1.06-.91V6.91C3 6.406 3.475 6 4.061 6zM2 16.5V15h16v1.5z"/></svg>',
            Lg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414"><path d="M18 4.5V3H2v1.5h16zm0 3V6h-5.674v1.5H18zm0 3V9h-5.674v1.5H18zm0 3V12h-5.674v1.5H18zm-8.5-6V12h-6V7.5h6zm.818-1.5H2.682C2.305 6 2 6.407 2 6.91v5.68c0 .503.305.91.682.91h7.636c.377 0 .682-.407.682-.91V6.91c0-.503-.305-.91-.682-.91zM18 16.5V15H2v1.5h16z"/></svg>',
            jg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm4.5 3V12h7V7.5h-7zM5.758 6h8.484c.419 0 .758.407.758.91v5.681c0 .502-.34.909-.758.909H5.758c-.419 0-.758-.407-.758-.91V6.91c0-.503.34-.91.758-.91zM2 16.5V15h16v1.5z"/></svg>',
            Vg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5V3h16v1.5zm0 3V6h5.674v1.5zm0 3V9h5.674v1.5zm0 3V12h5.674v1.5zm8.5-6V12h6V7.5h-6zM9.682 6h7.636c.377 0 .682.407.682.91v5.68c0 .503-.305.91-.682.91H9.682c-.377 0-.682-.407-.682-.91V6.91c0-.503.305-.91.682-.91zM2 16.5V15h16v1.5z"/></svg>';
        const zg = {
                full: {
                    name: "full",
        ...
        function Ug(t) {
            if ("string" == typeof t) {
                const e = t;
                zg[e] ? t = Object.assign({}, zg[e]) : (console.warn(Object(Gn.a)("image-style-not-found: There is no such image style of given name."), {
                    name: e
                }), t = {
                    name: e
                })
            ...
            return "string" == typeof t.icon && Bg[t.icon] && (t.icon = Bg[t.icon]), t
        }
        class Hg extends il {
            static get pluginName() {
            ...
            init() {
                ...
                const o = Fg(t.config.get("image.styles"));
                e.extend("image", {
                ...
                const r = function (t) {
                    return (e, n, i) => {
                        if (!i.consumable.consume(n.item, e.name)) return;
                        const o = Rg(n.attributeNewValue, t),
                            r = Rg(n.attributeOldValue, t),
                ...
                i.downcastDispatcher.on("attribute:imageStyle:image", r), n.downcastDispatcher.on("attribute:imageStyle:image", r), n.upcastDispatcher.on("element:figure", function (t) {
                    ...
                    priority: "low"
                }), t.commands.add("imageStyle", new Og(t, o))
            }
        }
        n(69);
        class qg extends il {
            ...
            get localizedDefaultStylesTitles() {
                ...
                return {
                    "Full size image": t("j"),
                    "Side image": t("k"),
                    "Left aligned image": t("l"),
                    "Centered image": t("m"),
                    "Right aligned image": t("n")
                }
            }
            init() {
                const t = function (t, e) {
                    ...
                    return t
                }(Fg(this.editor.config.get("image.styles")), this.localizedDefaultStylesTitles);
        ...
        class Wg extends il {
            ...
            register(t, {
                ...
                const r = this.editor,
                    s = r.t,
                    a = new cd(r.locale);
                if (a.ariaLabel = e || s("ba"), this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {
                    toolbarId: t
                });
            ...
            _showToolbar(t, e) {
                this._isToolbarVisible(t) ? Yg(this.editor, e) : this._isToolbarInBalloon(t) || (this._balloon.add({
                    view: t.view,
                    position: $g(this.editor, e),
        ...
        class Qg extends il {
            ...
            init() {
                const t = this.editor;
                t.commands.add("indent", new Gg(t)), t.commands.add("outdent", new Gg(t))
            }
        }
        var Kg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm5 6c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM2.75 16.5h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 1 0 0 1.5z"/><path d="M1.632 6.95L5.02 9.358a.4.4 0 0 1-.013.661l-3.39 2.207A.4.4 0 0 1 1 11.892V7.275a.4.4 0 0 1 .632-.326z"/></svg>\n',
        ...
        class Zg extends il {
            ...
            init() {
                const t = this.editor,
                    e = t.locale,
                    n = t.t,
                    i = "ltr" == e.uiLanguageDirection ? Kg : Jg,
                    o = "ltr" == e.uiLanguageDirection ? Jg : Kg;
                this._defineButton("indent", n("q"), i), this._defineButton("outdent", n("r"), o)
            }
            _defineButton(t, e, n) {
                const i = this.editor;
        ...
        class tm extends Al {
            constructor(t, e = []) {
                super(t);
                const n = t.t;
                this.focusTracker = new Vl, this.keystrokes = new Zc, this.urlInputView = this._createUrlInput(), this.saveButtonView = this._createButton(n("bj"), Uf, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(n("bk"), Hf, "ck-button-cancel", "cancel"), this._manualDecoratorSwitches = this._createManualDecoratorSwitches(e), this.children = this._createFormChildren(e), this._focusables = new ol, this._focusCycler = new Wl({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {
            ...
            _createUrlInput() {
                const t = this.locale.t,
                    e = new zf(this.locale, Bf);
                return e.label = t("bl"), e.inputView.placeholder = "https://example.com", e
            }
            _createButton(t, e, n, i) {
                const o = new jl(this.locale);
                return o.set({
        ...
        var em = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.077 15l.991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184zm4.919 10.562l-1.414 1.414a.75.75 0 1 1-1.06-1.06l1.414-1.415-1.415-1.414a.75.75 0 0 1 1.061-1.06l1.414 1.414 1.414-1.415a.75.75 0 0 1 1.061 1.061l-1.414 1.414 1.414 1.415a.75.75 0 0 1-1.06 1.06l-1.415-1.414z"/></svg>',
            nm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7.3 17.37l-.061.088a1.518 1.518 0 0 1-.934.535l-4.178.663-.806-4.153a1.495 1.495 0 0 1 .187-1.058l.056-.086L8.77 2.639c.958-1.351 2.803-1.076 4.296-.03 1.497 1.047 2.387 2.693 1.433 4.055L7.3 17.37zM9.14 4.728l-5.545 8.346 3.277 2.294 5.544-8.346L9.14 4.728zM6.07 16.512l-3.276-2.295.53 2.73 2.746-.435zM9.994 3.506L13.271 5.8c.316-.452-.16-1.333-1.065-1.966-.905-.634-1.895-.78-2.212-.328zM8 18.5L9.375 17H19v1.5H8z"/></svg>';
        n(73);
        class im extends Al {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new Vl, this.keystrokes = new Zc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("be"), em, "unlink"), this.editButtonView = this._createButton(e("bf"), nm, "edit"), this.set("href"), this._focusables = new ol, this._focusCycler = new Wl({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {
            ...
            _createPreviewButton() {
                ...
                return t.set({
                    ...
                    attributes: {
                        ...
                        href: e.to("href", t => t && sf(t)),
                        target: "_blank"
                    }
                }), t.bind("label").to(this, "href", t => t || n("bh")), t.bind("isEnabled").to(this, "href", t => !!t), t.template.tag = "a", t.template.eventListeners = {}, t
            }
        }
        ...
        class sm extends il {
            ...
            init() {
                const t = this.editor;
                t.editing.view.addObserver(Xg), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(Ul), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
            }
            destroy() {
            ...
            _createFormView() {
                const t = this.editor,
                    ...
                    n = new tm(t.locale, e.manualDecorators);
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(rm, (t, n) => {
                    ...
                    const i = new jl(t);
                    return i.isEnabled = !0, i.label = n("as"), i.icon = om, i.keystroke = rm, i.tooltip = !0, i.isToggleable = !0, i.bind("isEnabled").to(e, "isEnabled"), i.bind("isOn").to(e, "value", t => !!t), this.listenTo(i, "execute", () => this._showUI(!0)), i
                })
            }
            ...
            _getSelectedLinkElement() {
                const t = this.editor.editing.view,
                    e = t.document.selection;
                if (e.isCollapsed) return am(e.getFirstPosition()); {
        ...
        class cm extends Od {
            ...
            execute() {
                const t = this.editor.model,
                    e = t.document,
                    n = Array.from(e.selection.getSelectedBlocks()).filter(e => dm(e, t.schema)),
                    i = !0 === this.value;
                t.change(t => {
                    if (i) {
        ...
        function fm(t, e, n, i) {
            ...
            if (a = mm(a), s.insert(a, o), l && "listItem" == l.name) {
                ...
                for (const t of n)
                    if (t.item.is("li")) {
                        ...
                        gm(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), n.position = i
                    }
            } else {
            ...
            gm(s, o, o.nextSibling), gm(s, o.previousSibling, o)
        }
        ...
        function vm(t, e, n) {
            const i = n.mapper.toViewElement(e.item).parent,
                o = n.writer;
            gm(o, i, i.nextSibling), gm(o, i.previousSibling, i);
                ...
                if (o.length > 0) {
                    for (let e = 0; e < o.length; e++) {
                        ...
                        if (t = i.insert(t, o[e]).end, e > 0) {
                            const e = gm(i, n, n.nextSibling);
                            e && e.parent == n && t.offset--
                        }
                    }
                    gm(i, t.nodeBefore, t.nodeAfter)
                }
            }
        }
                ...
                const a = function (t, e, n) {
                    ...
                    for (const s of e)
                        if ("ul" == s.name || "ol" == s.name) r = n.convertItem(s, r).modelCursor;
                            ...
                            c && (t = e.modelCursor.parent.is("listItem") ? e.modelCursor.parent : Sm(e.modelCursor), r = i.createPositionAfter(t))
                        } return r
        ...
        function Cm(t, e, n) {
            if (n.consumable.test(e.viewItem, {
                ...
                let n = !1,
                    i = !0;
                for (const e of t) n && !Im(e) && e._remove(), e.is("text") ? (i && (e._data = e.data.replace(/^\s+/, "")), e.nextSibling && !Im(e.nextSibling) || (e._data = e.data.replace(/\s+$/, ""))) : Im(e) && (n = !0), i = !1
            }
        }
        ...
        function Em(t, e, n, i, o, r) {
            ...
            d = mm(d);
            for (const t of [...i.getChildren()]) Im(t) && (d = c.move(c.createRangeOn(t), d).end, gm(c, t, t.nextSibling), gm(c, t.previousSibling, t))
        }
        ...
        class Nm extends il {
            ...
            init() {
                ...
                t.model.document.registerPostFixer(e => (function (t, e) {
                    ...
                    } else "remove" == i.type && "listItem" == i.name ? r(i.position) : "attribute" == i.type && "listIndent" == i.attributeKey ? r(i.range.start) : "attribute" == i.type && "listType" == i.attributeKey && r(i.range.start);
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", Om), e.mapper.registerViewToModelLength("li", Om), n.mapper.on("modelToViewPosition", Pm(n.view)), n.mapper.on("viewToModelPosition", function (t) {
                    return (e, n) => {
                        ...
                        if ("ul" == o.name || "ol" == o.name) {
                            ...
                            let a = 1,
                                c = i.nodeBefore;
                            for (; c && Im(c);) a += r.getModelLength(c), c = c.previousSibling;
                            n.modelPosition = t.createPositionBefore(s).getShiftedBy(a), e.stop()
                        }
                    }
                }(t.model)), e.mapper.on("modelToViewPosition", Pm(n.view)), n.downcastDispatcher.on("insert", ym, {
                    priority: "high"
                }), n.downcastDispatcher.on("insert:listItem", km(t.model)), e.downcastDispatcher.on("insert", ym, {
                    priority: "high"
                }), e.downcastDispatcher.on("insert:listItem", km(t.model)), n.downcastDispatcher.on("attribute:listType:listItem", _m, {
                    priority: "high"
                }), n.downcastDispatcher.on("attribute:listType:listItem", vm, {
                    priority: "low"
                }), n.downcastDispatcher.on("attribute:listIndent:listItem", function (t) {
                    return (e, n, i) => {
                        ...
                        const s = o.parent,
                            a = s.previousSibling,
                            c = r.createRangeOn(s);
                        r.remove(c), a && a.nextSibling && gm(r, a, a.nextSibling), Em(n.attributeOldValue + 1, n.range.start, c.start, o, i, t), fm(n.item, o, i, t);
                    ...
                    return (e, n, i) => {
                        ...
                        const s = o.parent,
                            ...
                            c = r.createRangeOn(s),
                            l = r.remove(c);
                        a && a.nextSibling && gm(r, a, a.nextSibling), Em(i.mapper.toModelElement(o).getAttribute("listIndent") + 1, n.position, c.start, o, i, t);
                        for (const t of r.createRangeIn(l).getItems()) i.mapper.unbindViewElement(t);
                        e.stop()
                    }
                }(t.model)), n.downcastDispatcher.on("remove", xm, {
                    priority: "low"
                }), e.upcastDispatcher.on("element:ul", Tm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:ol", Tm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Cm, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Am), t.model.on("insertContent", Mm, {
                    priority: "high"
                }), t.commands.add("numberedList", new cm(t, "numbered")), t.commands.add("bulletedList", new cm(t, "bulleted")), t.commands.add("indentList", new hm(t, "forward")), t.commands.add("outdentList", new hm(t, "backward"));
        ...
        function Om(t) {
            ...
            for (const n of t.getChildren())
                if ("ul" == n.name || "ol" == n.name)
                    for (const t of n.getChildren()) e += Om(t);
            return e
        }
        var Rm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM3.5 3v5H2V3.7H1v-1h2.5V3zM.343 17.857l2.59-3.257H2.92a.6.6 0 1 0-1.04 0H.302a2 2 0 1 1 3.995 0h-.001c-.048.405-.16.734-.333.988-.175.254-.59.692-1.244 1.312H4.3v1h-4l.043-.043zM7 14.75a.75.75 0 0 1 .75-.75h9.5a.75.75 0 1 1 0 1.5h-9.5a.75.75 0 0 1-.75-.75z"/></svg>',
            Dm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0C1 4.784 1.777 4 2.75 4c.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75C1.784 7.5 1 6.723 1 5.75zm6 9c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0c0-.966.777-1.75 1.75-1.75.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75-.966 0-1.75-.777-1.75-1.75z"/></svg>';
        class Lm extends il {
            init() {
                const t = this.editor.t;
                bm(this.editor, "numberedList", t("s"), Rm), bm(this.editor, "bulletedList", t("t"), Dm)
            }
        }
        ...
        function Vm(t, e, n, i) {
            ...
            return o.getFillerOffset = Fm, t.insert(t.createPositionAt(o, 0), e.getMediaViewElement(t, n, i)), o
        }
        ...
        class Wm {
            constructor(t, e) {
                const n = e.providers,
                    ...
                    r = n.concat(i).filter(t => {
                        const e = t.name;
                        return e ? !o.has(e) : (console.warn(Object(Gn.a)("media-embed-no-provider-name: The configured media provider has no name and cannot be used."), {
                            provider: t
                        }), !1)
                    });
            ...
            _getMedia(t) {
                if (!t) return new Ym(this.locale);
                t = t.trim();
                for (const e of this.providerDefinitions) {
                    ...
                    for (const e of i) {
                        ...
                        if (i) return new Ym(this.locale, t, i, n)
                    }
                }
                return null
            }
        ...
        class Ym {
            ...
            _getPlaceholderHtml() {
                const t = new Ll,
                    e = new Dl;
                return t.text = this._t("Open media in new tab"), e.content = Hm, e.viewBox = qm, new sl({
                    tag: "div",
                    attributes: {
        ...
        class $m extends il {
            ...
            constructor(t) {
                ...
                }), this.registry = new Wm(t.locale, t.config.get("mediaEmbed"))
            }
            init() {
                const t = this.editor,
                    e = t.model.schema,
                    ...
                    r = this.registry;
                t.commands.add("mediaEmbed", new Um(t)), e.register("media", {
                    isObject: !0,
                    isBlock: !0,
                    allowWhere: "$block",
                    allowAttributes: ["url"]
                    ...
                    view: (t, e) => {
                        ...
                        return function (t, e, n) {
                            return e.setCustomProperty("media", !0, t), pu(t, e, {
                                label: n
                            })
                        }(Vm(e, r, i, {
                ...
                }), i.for("editingDowncast").add(jm(r, {
                    renderForEditingView: !0
                })), i.for("upcast").elementToElement({
                    view: {
                        name: "oembed",
        ...
        class Qm extends il {
            ...
            init() {
                const t = this.editor,
                    e = t.model.document;
                this.listenTo(t.plugins.get(Nd), "inputTransformation", () => {
                    const t = e.selection.getFirstRange(),
                        n = Lc.fromPosition(t.start);
                    n.stickiness = "toPrevious";
                    const i = Lc.fromPosition(t.end);
            ...
            _embedMediaBetweenPositions(t, e) {
                ...
                if (!(s = s.trim()).match(Gm)) return;
                if (!i.hasMedia(s)) return;
                n.commands.get("mediaEmbed").isEnabled && (this._positionToInsert = Lc.fromPosition(t), this._timeoutId = tr.window.setTimeout(() => {
                    n.model.change(t => {
                        let e;
                        this._timeoutId = null, t.remove(o), "$graveyard" !== this._positionToInsert.root.rootName && (e = this._positionToInsert), Bm(n.model, s, e), this._positionToInsert.detach(), this._positionToInsert = null
                    })
                }, 100))
            }
        }
        ...
        class Km extends Al {
            ...
            _createUrlInput() {
                const t = this.locale.t,
                    e = new zf(this.locale, Bf),
                    n = e.inputView;
                return this._urlInputViewInfoDefault = t("bm"), this._urlInputViewInfoTip = t("bn"), e.label = t("bo"), e.infoText = this._urlInputViewInfoDefault, n.placeholder = "https://example.com", n.on("input", () => {
        ...
        class Zm extends il {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = t.plugins.get($m).registry;
                this.form = new Km(function (t, e) {
                    return [e => {
                        if (!e.url.length) return t("aq")
                    }, n => {
                        if (!e.hasMedia(n.url)) return t("ar")
                    }]
        ...
        const ep = /id=("|')docs-internal-guid-[-0-9a-f]+("|')/i;
        class np {
            isActive(t) {
                return ep.test(t)
            }
        ...
        function rp(t, e) {
            ...
            i.length && function (t, e, n) {
                if (t.length === e.length)
                    for (let i = 0; i < t.length; i++) {
                        const o = `data:${e[i].type};base64,${sp(e[i].hex)}`;
        ...
        const ap = /<meta\s*name="?generator"?\s*content="?microsoft\s*word\s*\d+"?\/?>/i,
            cp = /xmlns:o="urn:schemas-microsoft-com/i;
        class lp {
            isActive(t) {
                return ap.test(t) || cp.test(t)
            }
            execute(t) {
                const {
                    body: e,
                    stylesString: n
                } = op(t.dataTransfer.getData("text/html"));
                Xm(e, n), rp(e, t.dataTransfer.getData("text/rtf")), t.content = e
            }
        }
                ...
                t.on("element:table", (t, e, n) => {
                    ...
                    if (l) {
                        if (n.writer.insert(c, l.position), n.consumable.consume(i, {
                            ...
                            n.writer.insert(t, n.writer.createPositionAt(c, "end")), up(n.writer, n.writer.createPositionAt(t, "end"))
                        }
        ...
        class pp {
            ...
            next() {
                ...
                let e, n, i;
                if (this._isSpanned(this._row, this._column)) e = this._getSpanned(this._row, this._column), n = !this.includeSpanned || this._shouldSkipRow() || this._shouldSkipColumn(), i = this._formatOutValue(e, this._column, !0);
                else {
            ...
            _recordSpans(t, e, n, i, o) {
                ...
                for (let r = t + 1; r < t + n; r++)
                    for (let t = e; t <= e + i - 1; t++) this._markSpannedCell(r, t, o)
            }
        ...
        function bp(t) {
            return !!t.getCustomProperty("table") && mu(t)
        }

        function wp(t) {
            const e = t.getSelectedElement();
            return e && bp(e) ? e : null
        }

        function kp(t) {
            const e = dp("table", t.getFirstPosition());
            return e && bp(e.parent) ? e.parent : null
        }
        ...
        function _p(t = {}) {
            return e => e.on("insert:table", (e, n, i) => {
                ...
                i.writer.insert(i.writer.createPositionAt(s, 0), a), r && (c = function (t, e) {
                    return e.setCustomProperty("table", !0, t), pu(t, e, {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = Ip(Ep(n, d), a, i), c = o.getChild(n), l = h.get(n) || Mp(c, n, s, i);
                    h.set(n, l), i.consumable.consume(r, "insert"), Pp(e, d, i.writer.createPositionAt(l, "end"), i, t)
                }
        ...
        function vp(t = {}) {
            return e => e.on("insert:tableRow", (e, n, i) => {
                ...
                const r = o.parent,
                    ...
                    d = new Map;
                for (const e of c) {
                    const n = Ip(Ep(a, l), s, i),
                        r = d.get(a) || Mp(o, a, n, i);
                    d.set(a, r), i.consumable.consume(e.cell, "insert"), Pp(e, l, i.writer.createPositionAt(r, "end"), i, t)
                }
            })
        }
            ...
            return e => e.on("insert:tableCell", (e, n, i) => {
                ...
                for (const e of c)
                    if (e.cell === o) {
                        ...
                        return void Pp(e, l, i.writer.createPositionAt(n, r.getChildIndex(o)), i, t)
                    }
            })
        }
        ...
        function xp(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                const r = Dp(i.mapper.toViewElement(o)),
                ...
                if (a > s) {
                    ...
                    Rp(t, Ip("thead", r, i), i, "end");
                    for (const n of t)
                        for (const t of n.getChildren()) Tp(t, "th", i, e);
                    Op("tbody", r, i)
                } else {
                    Rp(Array.from(o.getChildren()).filter(({
                        index: t
                    }) => c(t, a - 1, s)).reverse(), Ip("tbody", r, i), i, 0);
                    const t = new pp(o, {
                            startRow: a ? a - 1 : a,
                            endRow: s - 1
                        }),
        ...
        function Ap(t = {}) {
            ...
            return t => t.on("attribute:headingColumns:table", (t, n, i) => {
                ...
                const r = {
                    ...
                    a = n.attributeNewValue,
                    c = (s > a ? s : a) - 1;
                for (const t of new pp(o)) t.column > c || Cp(t, r, i, e)
            })
        }
        ...
        function Tp(t, e, n, i) {
            ...
            let s;
            if (i) {
                s = wu(o.createEditableElement(e, r.getAttributes()), o), o.insert(o.createPositionAfter(r), s), o.move(o.createRangeIn(r), o.createPositionAt(s, 0)), o.remove(o.createRangeOn(r))
            } else s = o.rename(e, r);
        ...
        function Cp(t, e, n, i) {
            const {
                cell: o
            } = t, r = Sp(t, e), s = n.mapper.toViewElement(o);
            s && s.name !== r && Tp(o, r, n, i)
        }
        ...
        class jp extends Od {
            ...
            refresh() {
                const t = dp("table", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }
            execute() {
                const t = this.editor,
                    ...
                    i = dp("tableCell", e.getFirstPosition()).parent,
                    o = i.parent,
                    r = o.getChildIndex(i),
        ...
        class Vp extends Od {
            ...
            execute() {
                const t = this.editor,
                    e = t.model.document.selection,
                    n = t.plugins.get("TableUtils"),
                    i = dp("tableCell", e.getFirstPosition()),
                    o = i.parent.parent,
                    {
                        column: r
                    } = n.getCellLocation(i),
        ...
        class zp extends Od {
            ...
            refresh() {
                const t = dp("tableCell", this.editor.model.document.selection.getFirstPosition());
                this.isEnabled = !!t
            }
            execute() {
                const t = dp("tableCell", this.editor.model.document.selection.getFirstPosition()),
        ...
        class Bp extends Od {
            ...
            execute() {
                const t = this.editor.model,
                    e = dp("tableCell", t.document.selection.getFirstPosition()),
                    n = this.value,
                    i = this.direction;
                t.change(t => {
                    const o = "right" == i || "down" == i,
                        ...
                        a = s.parent;
                    ! function (t, e, n) {
                        Fp(t) || (Fp(e) && n.remove(n.createRangeIn(e)), n.move(n.createRangeIn(t), n.createPositionAt(e, "end")));
                        n.remove(t)
                    }(s, r, t);
        ...
        class Up extends Od {
            ...
            execute() {
                const t = this.editor.model,
                    e = dp("tableCell", t.document.selection.getFirstPosition()).parent,
                    n = e.parent,
                    i = n.getChildIndex(e),
                    o = n.getAttribute("headingRows") || 0;
                t.change(t => {
                    o && i <= o && hp("headingRows", o - 1, n, t, 0);
                    const r = [...new pp(n, {
                            endRow: i
                        })],
                        s = new Map;
                    ...
                    for (const {
                        ...
                        if (s.has(i)) {
                            ...
                            t.move(t.createRangeOn(o), a), hp("rowspan", r, o, t), l = o
                        } else l = o;
                    t.remove(e)
                })
            }
            ...
            execute() {
                ...
                t.change(t => {
                    ...
                    for (const {
                            ...
                            column: n,
                            colspan: i
                        } of s) n <= a && i > 1 && n + i > a ? hp("colspan", i - 1, e, t) : n === a && t.remove(e)
                })
            }
        }
        class qp extends Od {
            ...
            execute(t = {}) {
                const e = this.editor.model,
                    n = dp("tableCell", e.document.selection.getFirstPosition()).parent,
                    i = n.parent,
                ...
                e.change(t => {
                    if (s) {
                        ...
                        for (const n of e) Wp(n, s, t)
                    }
                    hp("headingRows", s, i, t, 0)
                })
            }
            _isInHeading(t, e) {
        ...
        class Yp extends Od {
            ...
            execute(t = {}) {
                const e = this.editor.model,
                    n = e.document.selection,
                    i = this.editor.plugins.get("TableUtils"),
                    o = dp("tableCell", n.getFirstPosition()),
                    r = o.parent.parent,
                    {
                        column: s
                    } = i.getCellLocation(o);
        ...
        class $p extends il {
            ...
            insertRows(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (n > i && e.setAttribute("headingRows", n + o, t), 0 === i || i === t.childCount) return void Gp(e, t, i, o, this.getColumns(t));
                    const r = new pp(t, {
                        endRow: i
                    });
                    let s = 0;
            ...
            insertColumns(t, e = {}) {
                ...
                n.change(e => {
                    ...
                    if (0 === i || r === i) {
                        for (const n of t.getChildren()) Qp(o, e, e.createPositionAt(n, i ? "end" : 0));
                        return
                    }
                    const s = new pp(t, {
                        column: i,
            ...
            splitCellVertically(t, e = 2) {
                ...
                n.change(n => {
                    if (r > 1) {
                        ...
                        hp("colspan", s, t, n);
                        const a = {};
                        i > 1 && (a.colspan = i), o > 1 && (a.rowspan = o), Qp(r > e ? e - 1 : r - 1, n, n.createPositionAfter(t), a)
                    }
                    if (r < e) {
                        const s = e - r,
                            a = [...new pp(i)],
                        ...
                        const d = {};
                        o > 1 && (d.rowspan = o), Qp(s, n, n.createPositionAfter(t), d);
                        const h = i.getAttribute("headingColumns") || 0;
                        h > c && hp("headingColumns", h + s, i, n)
                    }
                })
            }
                    ...
                    if (s > 1) {
                        ...
                        for (const {
                            ...
                            if (e >= r + l && t === d && (e + r + l) % c == 0) {
                                Qp(1, n, n.createPositionAt(o.getChild(e), s), h)
                            }
                        }
                    }
                    if (s < e) {
                        ...
                        a > 1 && (l.colspan = a), Gp(n, o, r + 1, i, 1, l);
                        const d = o.getAttribute("headingRows") || 0;
                        d > r && hp("headingRows", d + i, o, n)
                    }
                })
            }
            getColumns(t) {
        ...
        function Gp(t, e, n, i, o, r = {}) {
            for (let s = 0; s < i; s++) {
                const i = t.createElement("tableRow");
                t.insert(i, e, n), Qp(o, t, t.createPositionAt(i, "end"), r)
            }
        }

        function Qp(t, e, n, i = {}) {
            for (let o = 0; o < t; o++) up(e, n, i)
        }
        ...
        function Jp(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                ...
                for (const e of n) {
                    let n;
                    "table" == e.name && "insert" == e.type && (n = e.position.nodeAfter), "tableRow" != e.name && "tableCell" != e.name || (n = dp("table", e.position)), tb(e) && (n = dp("table", e.range.start)), n && !o.has(n) && (i = Zp(n, t) || i, i = Xp(n, t) || i, o.add(n))
                }
                return i
            })(e, t))
        }
        ...
        function Zp(t, e) {
            ...
            if (i.length) {
                n = !0;
                for (const t of i) hp("rowspan", t.rowspan, t.cell, e, 1)
            }
            return n
        }
        ...
        function Xp(t, e) {
            ...
            if (!Object.values(i).every(t => t === o)) {
                ...
                for (const [r, s] of Object.entries(i)) {
                    const i = o - s;
                    if (i) {
                        for (let n = 0; n < i; n++) up(e, e.createPositionAt(t.getChild(r), "end"));
                        n = !0
                    }
                }
            }
        ...
        function eb(t) {
            t.document.registerPostFixer(e => (function (t, e) {
                const n = e.document.differ.getChanges();
                let i = !1;
                for (const e of n) "insert" == e.type && "table" == e.name && (i = nb(e.position.nodeAfter, t) || i), "insert" == e.type && "tableRow" == e.name && (i = ib(e.position.nodeAfter, t) || i), "insert" == e.type && "tableCell" == e.name && (i = ob(e.position.nodeAfter, t) || i), rb(e) && (i = ob(e.position.parent, t) || i);
                return i
            })(e, t))
        }
        ...
        function nb(t, e) {
            let n = !1;
            for (const i of t.getChildren()) n = ib(i, e) || n;
            return n
        }

        function ib(t, e) {
            let n = !1;
            for (const i of t.getChildren()) n = ob(i, e) || n;
            return n
        }
        ...
        function sb(t) {
            t.document.registerPostFixer(() => (function (t) {
                ...
                for (const t of e.getChanges()) {
                    ...
                    e.is("tableCell") && ab(e, t.type) && n.add(e)
                }
                if (n.size) {
        ...
        class cb extends il {
            ...
            init() {
                ...
                n.register("table", {
                ...
                }), i.for("upcast").add(fp()), i.for("editingDowncast").add(_p({
                    asWidget: !0
                })), i.for("dataDowncast").add(_p()), i.for("upcast").elementToElement({
                    model: "tableRow",
                    view: "tr"
                }), i.for("editingDowncast").add(vp({
                    asWidget: !0
                })), i.for("dataDowncast").add(vp()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                    const i = n.writer,
                        o = n.mapper,
                    ...
                    priority: "higher"
                })), i.for("upcast").add(gp("td")), i.for("upcast").add(gp("th")), i.for("editingDowncast").add(yp({
                    asWidget: !0
                })), i.for("dataDowncast").add(yp()), i.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), i.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), i.for("editingDowncast").add(Ap({
                    asWidget: !0
                })), i.for("dataDowncast").add(Ap()), i.for("editingDowncast").add(xp({
                    asWidget: !0
                })), i.for("dataDowncast").add(xp()), t.commands.add("insertTable", new Lp(t)), t.commands.add("insertTableRowAbove", new jp(t, {
                    order: "above"
                })), t.commands.add("insertTableRowBelow", new jp(t, {
                    order: "below"
                })), t.commands.add("insertTableColumnLeft", new Vp(t, {
                    order: "left"
                })), t.commands.add("insertTableColumnRight", new Vp(t, {
                    order: "right"
                })), t.commands.add("removeTableRow", new Up(t)), t.commands.add("removeTableColumn", new Hp(t)), t.commands.add("splitTableCellVertically", new zp(t, {
                    direction: "vertically"
                })), t.commands.add("splitTableCellHorizontally", new zp(t, {
                    direction: "horizontally"
                })), t.commands.add("mergeTableCellRight", new Bp(t, {
                    direction: "right"
                })), t.commands.add("mergeTableCellLeft", new Bp(t, {
                    direction: "left"
                })), t.commands.add("mergeTableCellDown", new Bp(t, {
                    direction: "down"
                })), t.commands.add("mergeTableCellUp", new Bp(t, {
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new Yp(t)), t.commands.add("setTableRowHeader", new qp(t)), Jp(e), sb(e), eb(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
            ...
            _getTabHandler(t) {
                const e = this.editor;
                return (n, i) => {
                    const o = dp("tableCell", e.model.document.selection.getFirstPosition());
                    if (!o) return;
                    i();
                    const r = o.parent,
                        s = r.parent,
        ...
        var hb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 6v3h4V6H3zm0 4v3h4v-3H3zm0 4v3h4v-3H3zm5 3h4v-3H8v3zm5 0h4v-3h-4v3zm4-4v-3h-4v3h4zm0-4V6h-4v3h4zm1.5 8a1.5 1.5 0 0 1-1.5 1.5H3A1.5 1.5 0 0 1 1.5 17V4c.222-.863 1.068-1.5 2-1.5h13c.932 0 1.778.637 2 1.5v13zM12 13v-3H8v3h4zm0-4V6H8v3h4z"/></svg>',
            ub = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M18 7v1H2V7h16zm0 5v1H2v-1h16z" opacity=".6"/><path d="M14 1v18a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1zm-2 1H8v4h4V2zm0 6H8v4h4V8zm0 6H8v4h4v-4z"/></svg>',
            fb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v16h-1V2z" opacity=".6"/><path d="M1 6h18a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1zm1 2v4h4V8H2zm6 0v4h4V8H8zm6 0v4h4V8h-4z"/></svg>',
            gb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.5 1h15A1.5 1.5 0 0 1 19 2.5v15a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 1 17.5v-15A1.5 1.5 0 0 1 2.5 1zM2 2v16h16V2H2z" opacity=".6"/><path d="M7 2h1v16H7V2zm5 0h1v7h-1V2zm6 5v1H2V7h16zM8 12v1H2v-1h6z" opacity=".6"/><path d="M7 7h12a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1zm1 2v9h10V9H8z"/></svg>';
        class mb extends il {
            init() {
                const t = this.editor,
                    e = this.editor.t,
                ...
                t.ui.componentFactory.add("insertTable", n => {
                    ...
                    return this._prepareDropdown(e("aa"), ub, i, t)
                    ...
                    return this._prepareDropdown(e("af"), fb, n, t)
                    ...
                    return this._prepareDropdown(e("am"), gb, i, t)
                })
            }
            _prepareDropdown(t, e, n, i) {
                const o = this.editor,
                    ...
                    s = [],
                    a = new oo;
                for (const t of n) pb(t, o, s, a);
                return sd(r, a), r.buttonView.set({
                    label: t,
                    icon: e,
                    tooltip: !0
        ...
        function pb(t, e, n, i) {
            const o = t.model = new Ag(t.model),
                {
                    commandName: r,
                    bindIsOn: s
                } = t.model;
        ...
        class bb extends Md {}
        bb.builtinPlugins = [class extends il {
            static get requires() {
                return [Nd, zd, Hd, ih, Ah]
            }
            static get pluginName() {
                return "Essentials"
            }
            ...
            _addListAutoformats() {
                const t = this.editor.commands;
                t.get("bulletedList") && new Dh(this.editor, /^[*-]\s$/, "bulletedList"), t.get("numberedList") && new Dh(this.editor, /^1[.|)]\s$/, "numberedList")
            }
            _addBasicStylesAutoformats() {
                const t = this.editor.commands;
                if (t.get("bold")) {
                    const t = Vh(this.editor, "bold");
                    new Lh(this.editor, /(\*\*)([^*]+)(\*\*)$/g, t), new Lh(this.editor, /(__)([^_]+)(__)$/g, t)
                }
                if (t.get("italic")) {
                    const t = Vh(this.editor, "italic");
                    new Lh(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, t), new Lh(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, t)
                }
                if (t.get("code")) {
                    const t = Vh(this.editor, "code");
                    new Lh(this.editor, /(`)([^`]+)(`)$/g, t)
                }
            }
            ...
            _addBlockQuoteAutoformats() {
                this.editor.commands.get("blockQuote") && new Dh(this.editor, /^>\s$/, "blockQuote")
            }
        }, class extends il {
            static get requires() {
                return [Fh, qh]
            ...
            afterInit() {
                const t = this.editor,
                    e = t.t;
                t.plugins.get(Wg).register("image", {
                    ariaLabel: e("a"),
            ...
            init() {
                const t = this.editor,
                    e = [];
                e.push(new lp), e.push(new np), t.plugins.get("Clipboard").on("inputTransformation", (t, n) => {
